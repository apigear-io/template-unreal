...
DEFINE_LOG_CATEGORY(LogCounterCommonJavaConverter_JNI);

bool FCounterCommonJavaConverter::CheckJniErrorOccurred(const TCHAR* Msg)
{
	...
	if (env->ExceptionCheck())
	{
		...
		env->ExceptionClear();
		UE_LOG(LogCounterCommonJavaConverter_JNI, Error, TEXT("%s"), Msg);
		return true;
	}
	return false;
}
