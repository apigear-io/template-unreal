...
DECLARE_LOG_CATEGORY_EXTERN(LogCounterCommonJavaConverter_JNI, Log, All);

class FCounterCommonJavaConverter
{
public:
...
private:
	...
	FCounterCommonJavaConverter() = delete;
};

template<>
struct FCounterCommonJavaConverter::JniArrayTraits<bool>
{
...
template<>
struct FCounterCommonJavaConverter::JniArrayTraits<int32>
{
...
template<>
struct FCounterCommonJavaConverter::JniArrayTraits<int64>
{
...
template<>
struct FCounterCommonJavaConverter::JniArrayTraits<float>
{
...
template<>
struct FCounterCommonJavaConverter::JniArrayTraits<double>
{
...
FCounterCommonJavaConverter::TryFillArray(
    JNIEnv* Env, TArray<PrimitiveType>& OutPrimitiveArray, jarray InJniArray, const FString& InPropertyName)
{
	...
	{
		UE_LOG(LogCounterCommonJavaConverter_JNI, Warning, TEXT("%s is null"), *InPropertyName);
		return false;
	}
