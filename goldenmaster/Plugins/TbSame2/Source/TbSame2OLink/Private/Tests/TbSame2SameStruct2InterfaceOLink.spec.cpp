...
void UTbSame2SameStruct2InterfaceOLinkSpec::Define()
{
	LatentBeforeEach([this](const FDoneDelegate& TestDone)
		...
		auto service = ImplFixture->GetGameInstance()->GetSubsystem<UTbSame2SameStruct2InterfaceImplementation>();
	...
	LatentIt("Operation.Func2Async", EAsyncExecution::ThreadPool, [this](const FDoneDelegate& TestDone)
		{
		// Test async operation through OLink (client -> network -> server -> network -> client callback)
		TFuture<FTbSame2Struct1> Future = ImplFixture->GetImplementation()->Func2Async(FTbSame2Struct1(), FTbSame2Struct2());
