...
namespace Tests
{
FTbSame2SameEnum1InterfaceMQTTFixture::FTbSame2SameEnum1InterfaceMQTTFixture()
{
	testImplementation = GetGameInstance()->GetSubsystem<UTbSame2SameEnum1InterfaceMQTTClient>();
	...
	auto service = GetGameInstance()->GetSubsystem<UTbSame2SameEnum1InterfaceImplementation>();
...
TScriptInterface<ITbSame2SameEnum1InterfaceInterface> FTbSame2SameEnum1InterfaceMQTTFixture::GetImplementation()
{
	return testImplementation;
}

UApiGearMQTTHost* FTbSame2SameEnum1InterfaceMQTTFixture::GetHost()
{
	return Host.Get();
}

UTbSame2SameEnum1InterfaceMQTTAdapter* FTbSame2SameEnum1InterfaceMQTTFixture::GetAdapter()
{
	return GetGameInstance()->GetSubsystem<UTbSame2SameEnum1InterfaceMQTTAdapter>();
}

UGameInstance* FTbSame2SameEnum1InterfaceMQTTFixture::GetGameInstance()
{
...
void FTbSame2SameEnum1InterfaceMQTTFixture::CleanUp()
{
	if (Host.IsValid())
	{
		Host->Stop();
