...
namespace Tests
{
FTbSame2SameStruct1InterfaceMQTTFixture::FTbSame2SameStruct1InterfaceMQTTFixture()
{
	testImplementation = GetGameInstance()->GetSubsystem<UTbSame2SameStruct1InterfaceMQTTClient>();
	...
	auto service = GetGameInstance()->GetSubsystem<UTbSame2SameStruct1InterfaceImplementation>();
...
TScriptInterface<ITbSame2SameStruct1InterfaceInterface> FTbSame2SameStruct1InterfaceMQTTFixture::GetImplementation()
{
	return testImplementation;
}

UApiGearMQTTHost* FTbSame2SameStruct1InterfaceMQTTFixture::GetHost()
{
	return Host.Get();
}

UTbSame2SameStruct1InterfaceMQTTAdapter* FTbSame2SameStruct1InterfaceMQTTFixture::GetAdapter()
{
	return GetGameInstance()->GetSubsystem<UTbSame2SameStruct1InterfaceMQTTAdapter>();
}

UGameInstance* FTbSame2SameStruct1InterfaceMQTTFixture::GetGameInstance()
{
...
void FTbSame2SameStruct1InterfaceMQTTFixture::CleanUp()
{
	if (Host.IsValid())
	{
		Host->Stop();
