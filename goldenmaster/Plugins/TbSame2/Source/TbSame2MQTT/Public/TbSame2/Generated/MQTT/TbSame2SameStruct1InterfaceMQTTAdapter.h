...
#include "TbSame2SameStruct1InterfaceMQTTAdapter.generated.h"

class UApiGearMQTTHost;

DECLARE_LOG_CATEGORY_EXTERN(LogTbSame2SameStruct1InterfaceMQTTAdapter, Log, All);
...
class TBSAME2MQTT_API UTbSame2SameStruct1InterfaceMQTTAdapter : public UGameInstanceSubsystem, public ITbSame2SameStruct1InterfaceSubscriberInterface
{
	GENERATED_BODY()
public:
	explicit UTbSame2SameStruct1InterfaceMQTTAdapter();
	virtual ~UTbSame2SameStruct1InterfaceMQTTAdapter() = default;
