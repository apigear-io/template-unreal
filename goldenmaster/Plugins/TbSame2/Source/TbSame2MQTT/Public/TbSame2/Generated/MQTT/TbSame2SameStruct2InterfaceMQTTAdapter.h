...
#include "TbSame2SameStruct2InterfaceMQTTAdapter.generated.h"

class UApiGearMQTTHost;

DECLARE_LOG_CATEGORY_EXTERN(LogTbSame2SameStruct2InterfaceMQTTAdapter, Log, All);
...
class TBSAME2MQTT_API UTbSame2SameStruct2InterfaceMQTTAdapter : public UGameInstanceSubsystem, public ITbSame2SameStruct2InterfaceSubscriberInterface
{
	GENERATED_BODY()
public:
	explicit UTbSame2SameStruct2InterfaceMQTTAdapter();
	virtual ~UTbSame2SameStruct2InterfaceMQTTAdapter() = default;
