...
#include "Misc/Guid.h"
#include "TbSame2SameStruct1InterfaceMQTTClient.generated.h"

class TbSame2SameStruct1InterfacePropertiesData;
DECLARE_LOG_CATEGORY_EXTERN(LogTbSame2SameStruct1InterfaceMQTTClient, Log, All);

UCLASS(NotBlueprintable, BlueprintType)
class TBSAME2MQTT_API UTbSame2SameStruct1InterfaceMQTTClient : public UAbstractTbSame2SameStruct1Interface
{
	GENERATED_BODY()
public:
	explicit UTbSame2SameStruct1InterfaceMQTTClient();

	// only needed in 4.25 to use TUniquePtr<TbSame2SameStruct1InterfacePropertiesData>
	UTbSame2SameStruct1InterfaceMQTTClient(FVTableHelper& Helper);
	virtual ~UTbSame2SameStruct1InterfaceMQTTClient();
...
private:
	...
	/// @param InMsg contains the param of the type FTbSame2Struct1
