...
void UTbSame2SameStruct2InterfaceOLinkSpec::Prop1PropertyChangeLocalCheckRemoteCb(const FTbSame2Struct2& InProp1)
{
	FTbSame2Struct2 TestValue = FTbSame2Struct2();
	// use different test value
	TestValue = createTestFTbSame2Struct2();
...
void UTbSame2SameStruct2InterfaceOLinkSpec::Prop1PropertyChangeLocalChangeRemoteCb(const FTbSame2Struct2& InProp1)
{
...
void UTbSame2SameStruct2InterfaceOLinkSpec::Prop2PropertyChangeLocalCheckRemoteCb(const FTbSame2Struct2& InProp2)
{
	FTbSame2Struct2 TestValue = FTbSame2Struct2();
	// use different test value
	TestValue = createTestFTbSame2Struct2();
...
void UTbSame2SameStruct2InterfaceOLinkSpec::Prop2PropertyChangeLocalChangeRemoteCb(const FTbSame2Struct2& InProp2)
{
	// this function must be called twice before we can successfully pass this test.
	// first call it should have the test value of the parameter
	// second call it should have the default value of the parameter again
