...
void UTbSame2SameStruct1InterfaceMsgBusClient::OnConnectionInit(const FTbSame2SameStruct1InterfaceInitMessage& InMessage, const TSharedRef<IMessageContext, ESPMode::ThreadSafe>& Context)
{
	...
	{
		UE_LOG(LogTbSame2SameStruct1InterfaceMsgBusClient, Warning,
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("ApiGear.TbSame2.SameStruct1Interface.MsgBus.SetProp1");
	if (!_IsConnected())
	{
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("ApiGear.TbSame2.SameStruct1Interface.MsgBus.Func1");
	if (!_IsConnected())
	{
		UE_LOG(LogTbSame2SameStruct1InterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("ApiGear.TbSame2.SameStruct1Interface.MsgBus.SignalSig1");
	if (ServiceAddress != Context->GetSender())
	{
...
TSharedPtr<TPromise<ResultType>> UTbSame2SameStruct1InterfaceMsgBusClient::StorePromise(const FGuid& Id)
{
...
void UTbSame2SameStruct1InterfaceMsgBusClient::CancelAllPromises()
{
...
template TSharedPtr<TPromise<FTbSame2Struct1>> UTbSame2SameStruct1InterfaceMsgBusClient::StorePromise<FTbSame2Struct1>(const FGuid& Id);
