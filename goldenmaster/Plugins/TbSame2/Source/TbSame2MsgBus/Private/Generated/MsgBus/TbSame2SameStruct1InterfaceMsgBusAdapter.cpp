...
void UTbSame2SameStruct1InterfaceMsgBusAdapter::_StopListening()
{
	...
	if (TbSame2SameStruct1InterfaceMsgBusEndpoint.IsValid() && ConnectedClients.Num() > 0)
	{
...
void UTbSame2SameStruct1InterfaceMsgBusAdapter::HandleClientConnectionRequest(const TSharedRef<IMessageContext, ESPMode::ThreadSafe>& Context)
{
	...
	if (!BackendService)
	{
		UE_LOG(LogTbSame2SameStruct1InterfaceMsgBusAdapter, Error, TEXT("No backend service set for TbSame2SameStruct1Interface - cannot send init to client"));
		return;
	}
...
void UTbSame2SameStruct1InterfaceMsgBusAdapter::OnFunc1Request(const FTbSame2SameStruct1InterfaceFunc1RequestMessage& InMessage, const TSharedRef<IMessageContext, ESPMode::ThreadSafe>& Context)
{
	if (!BackendService)
	{
		UE_LOG(LogTbSame2SameStruct1InterfaceMsgBusAdapter, Error, TEXT("No backend service set for TbSame2SameStruct1Interface - cannot handle Func1 request"));
		return;
	}
...
void UTbSame2SameStruct1InterfaceMsgBusAdapter::OnSig1Signal(const FTbSame2Struct1& InParam1)
{
	TArray<FMessageAddress> ConnectedClients;
	{
		FScopeLock Lock(&ConnectedClientsTimestampsCS);
...
void UTbSame2SameStruct1InterfaceMsgBusAdapter::OnSetProp1Request(const FTbSame2SameStruct1InterfaceSetProp1RequestMessage& InMessage, const TSharedRef<IMessageContext, ESPMode::ThreadSafe>& /*Context*/)
{
	if (!BackendService)
	{
		UE_LOG(LogTbSame2SameStruct1InterfaceMsgBusAdapter, Error, TEXT("No backend service set for TbSame2SameStruct1Interface - cannot handle SetProp1 request"));
		return;
	}
