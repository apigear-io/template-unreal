...
class TBSAME2MSGBUS_API UTbSame2SameStruct1InterfaceMsgBusAdapter : public UGameInstanceSubsystem, public ITbSame2SameStruct1InterfaceSubscriberInterface
{
	GENERATED_BODY()
public:
