...
DECLARE_LOG_CATEGORY_EXTERN(LogTbSame2SameStruct2InterfaceMsgBusAdapter, Log, All);
...
class TBSAME2MSGBUS_API UTbSame2SameStruct2InterfaceMsgBusAdapter : public UGameInstanceSubsystem, public ITbSame2SameStruct2InterfaceSubscriberInterface
{
	GENERATED_BODY()
public:
...
private:
	...
	void OnDiscoveryMessage(const FTbSame2SameStruct2InterfaceDiscoveryMessage& InMessage, const TSharedRef<IMessageContext, ESPMode::ThreadSafe>& Context);
	...
	void OnServiceAnnouncementMessage(const FTbSame2SameStruct2InterfaceServiceAnnouncementReplyMessage& InMessage, const TSharedRef<IMessageContext, ESPMode::ThreadSafe>& Context);
