...
void UTbSame2SameEnum2InterfaceLoggingDecorator::OnSig1Signal(ETbSame2Enum1 InParam1)
{
	if (!BackendService)
	{
		return;
...
void UTbSame2SameEnum2InterfaceLoggingDecorator::OnSig2Signal(ETbSame2Enum1 InParam1, ETbSame2Enum2 InParam2)
{
	if (!BackendService)
	{
		return;
...
ETbSame2Enum1 UTbSame2SameEnum2InterfaceLoggingDecorator::GetProp1() const
{
	if (!BackendService)
	{
		UE_LOG(LogTbSame2SameEnum2InterfaceLoggingDecorator, Error, TEXT("BackendService not set"));
