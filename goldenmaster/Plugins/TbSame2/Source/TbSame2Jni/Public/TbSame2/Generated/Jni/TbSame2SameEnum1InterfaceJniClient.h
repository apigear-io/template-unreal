...
// A helper class that exposes part of UTbSame2SameEnum1InterfaceJniClient to use for native JNI calls.
...
class TBSAME2JNI_API IUTbSame2SameEnum1InterfaceJniClientJniAccessor
{
public:
...
class TBSAME2JNI_API UTbSame2SameEnum1InterfaceJniClient : public UAbstractTbSame2SameEnum1Interface, public IUTbSame2SameEnum1InterfaceJniClientJniAccessor
{
	GENERATED_BODY()
public:
