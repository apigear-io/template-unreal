...
#if PLATFORM_ANDROID && USE_ANDROID_JNI
		UTbSame2SameStruct2InterfacePublisher* TbSame2SameStruct2InterfacePublisher = ImplFixture->GetClient()->_GetPublisher();
		TbSame2SameStruct2InterfacePublisher->OnProp1Changed.AddLambda([this, TestDone, count = 0](const FTbSame2Struct2& InProp1) mutable
#else
		UTbSame2SameStruct2InterfacePublisher* TbSame2SameStruct2InterfacePublisher = ImplFixture->GetLocalImplementation()->_GetPublisher();
		TbSame2SameStruct2InterfacePublisher->OnProp1Changed.AddLambda([this, TestDone, StartValue, count = 0](const FTbSame2Struct2& InProp1) mutable
#endif
			{
...
#if PLATFORM_ANDROID && USE_ANDROID_JNI
		UTbSame2SameStruct2InterfacePublisher* TbSame2SameStruct2InterfacePublisher = ImplFixture->GetClient()->_GetPublisher();
		TbSame2SameStruct2InterfacePublisher->OnProp2Changed.AddLambda([this, TestDone, count = 0](const FTbSame2Struct2& InProp2) mutable
#else
		UTbSame2SameStruct2InterfacePublisher* TbSame2SameStruct2InterfacePublisher = ImplFixture->GetLocalImplementation()->_GetPublisher();
		TbSame2SameStruct2InterfacePublisher->OnProp2Changed.AddLambda([this, TestDone, StartValue, count = 0](const FTbSame2Struct2& InProp2) mutable
#endif
			{
			// this function must be called twice before we can successfully pass this test.
			// first call it should have the test value of the parameter
