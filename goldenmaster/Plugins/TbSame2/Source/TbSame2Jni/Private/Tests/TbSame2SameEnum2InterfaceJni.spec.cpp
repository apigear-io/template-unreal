...
#if PLATFORM_ANDROID && USE_ANDROID_JNI
		UTbSame2SameEnum2InterfacePublisher* TbSame2SameEnum2InterfacePublisher = ImplFixture->GetClient()->_GetPublisher();
		TbSame2SameEnum2InterfacePublisher->OnProp1Changed.AddLambda([this, TestDone, count = 0](ETbSame2Enum1 InProp1) mutable
#else
		UTbSame2SameEnum2InterfacePublisher* TbSame2SameEnum2InterfacePublisher = ImplFixture->GetLocalImplementation()->_GetPublisher();
		TbSame2SameEnum2InterfacePublisher->OnProp1Changed.AddLambda([this, TestDone, StartValue, count = 0](ETbSame2Enum1 InProp1) mutable
#endif
			{
...
#if PLATFORM_ANDROID && USE_ANDROID_JNI
		UTbSame2SameEnum2InterfacePublisher* TbSame2SameEnum2InterfacePublisher = ImplFixture->GetClient()->_GetPublisher();
		TbSame2SameEnum2InterfacePublisher->OnProp2Changed.AddLambda([this, TestDone, count = 0](ETbSame2Enum2 InProp2) mutable
#else
		UTbSame2SameEnum2InterfacePublisher* TbSame2SameEnum2InterfacePublisher = ImplFixture->GetLocalImplementation()->_GetPublisher();
		TbSame2SameEnum2InterfacePublisher->OnProp2Changed.AddLambda([this, TestDone, StartValue, count = 0](ETbSame2Enum2 InProp2) mutable
#endif
			{
			// this function must be called twice before we can successfully pass this test.
			// first call it should have the test value of the parameter
