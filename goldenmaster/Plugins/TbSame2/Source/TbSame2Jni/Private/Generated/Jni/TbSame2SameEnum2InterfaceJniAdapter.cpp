...
namespace
{
std::atomic<ITbSame2SameEnum2InterfaceJniAdapterAccessor*> gUTbSame2SameEnum2InterfaceJniAdapterHandle{nullptr};
}
...
void UTbSame2SameEnum2InterfaceJniAdapterCache::init()
{
	...
	static const TCHAR* errorMsgCls = TEXT("failed to get java tbSame2/tbSame2jniservice/SameEnum2InterfaceJniService. Bailing...");
	...
	static const TCHAR* errorMsgReadyMethod = TEXT("failed to get java nativeServiceReady, (Z)V for tbSame2/tbSame2jniservice/SameEnum2InterfaceJniService. Bailing...");
	...
	static const TCHAR* errorMsgProp1Changed = TEXT("failed to get java onProp1Changed, (LtbSame2/tbSame2_api/Enum1;)V for tbSame2/tbSame2jniservice/SameEnum2InterfaceJniService. Bailing...");
	...
	static const TCHAR* errorMsgProp2Changed = TEXT("failed to get java onProp2Changed, (LtbSame2/tbSame2_api/Enum2;)V for tbSame2/tbSame2jniservice/SameEnum2InterfaceJniService. Bailing...");
	...
	static const TCHAR* errorMsgSig1Signal = TEXT("failed to get java onSig1, (LtbSame2/tbSame2_api/Enum1;)V for tbSame2/tbSame2jniservice/SameEnum2InterfaceJniService. Bailing...");
	...
	static const TCHAR* errorMsgSig2Signal = TEXT("failed to get java onSig2, (LtbSame2/tbSame2_api/Enum1;LtbSame2/tbSame2_api/Enum2;)V for tbSame2/tbSame2jniservice/SameEnum2InterfaceJniService. Bailing...");
...
void UTbSame2SameEnum2InterfaceJniAdapter::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	gUTbSame2SameEnum2InterfaceJniAdapterHandle.store(this, std::memory_order_release);
#if PLATFORM_ANDROID
#if USE_ANDROID_JNI
	UTbSame2SameEnum2InterfaceJniAdapterCache::init();
	if (!UTbSame2SameEnum2InterfaceJniAdapterCache::Get())
	{
		UE_LOG(LogTbSame2SameEnum2Interface_JNI, Error, TEXT("Failed to initialize UTbSame2SameEnum2InterfaceJniAdapterCache. Bailing..."));
		return;
	}
...
void UTbSame2SameEnum2InterfaceJniAdapter::Deinitialize()
{
	...
	gUTbSame2SameEnum2InterfaceJniAdapterHandle.store(nullptr, std::memory_order_release);
#if PLATFORM_ANDROID
#if USE_ANDROID_JNI
	...
	UTbSame2SameEnum2InterfaceJniAdapterCache::clear();
#endif
#endif
	Super::Deinitialize();
}
...
TScriptInterface<ITbSame2SameEnum2InterfaceInterface> UTbSame2SameEnum2InterfaceJniAdapter::getBackendServiceForJNI() const
{
	FScopeLock Lock(&BackendServiceCS);
	return BackendService;
}
...
{
	TWeakObjectPtr<UTbSame2SameEnum2InterfaceJniAdapter> WeakThis(this);
	if (isConnected)
	{
...
JNI_METHOD jobject Java_tbSame2_tbSame2jniservice_SameEnum2InterfaceJniService_nativeFunc1(JNIEnv* Env, jclass Clazz, jobject param1)
{
	...
	if (!jniAccessor)
	{
		UE_LOG(LogTbSame2SameEnum2Interface_JNI, Warning, TEXT("Java_tbSame2_tbSame2jniservice_SameEnum2InterfaceJniService_nativeFunc1, UTbSame2SameEnum2InterfaceJniAdapter not valid to use, probably too early or too late."));
		return nullptr;
	}
	...
	if (service != nullptr)
	{
		auto optResult = FTbSame2ThreadingHelper::EvalInGameThread(
			...
			if (!jniAccessor)
			{
				UE_LOG(LogTbSame2SameEnum2Interface_JNI, Warning, TEXT("Java_tbSame2_tbSame2jniservice_SameEnum2InterfaceJniService_nativeFunc1 (in GameThread), UTbSame2SameEnum2InterfaceJniAdapter not valid to use, probably too early or too late."));
		...
		if (!optResult.IsSet())
		{
			UE_LOG(LogTbSame2SameEnum2Interface_JNI, Warning, TEXT("Java_tbSame2_tbSame2jniservice_SameEnum2InterfaceJniService_nativeFunc1, couldn't get result."));
			return nullptr;
		}
...
JNI_METHOD jobject Java_tbSame2_tbSame2jniservice_SameEnum2InterfaceJniService_nativeFunc2(JNIEnv* Env, jclass Clazz, jobject param1, jobject param2)
{
	...
	if (!jniAccessor)
	{
		UE_LOG(LogTbSame2SameEnum2Interface_JNI, Warning, TEXT("Java_tbSame2_tbSame2jniservice_SameEnum2InterfaceJniService_nativeFunc2, UTbSame2SameEnum2InterfaceJniAdapter not valid to use, probably too early or too late."));
		return nullptr;
	}
	...
	if (service != nullptr)
	{
		auto optResult = FTbSame2ThreadingHelper::EvalInGameThread(
			...
			if (!jniAccessor)
			{
				UE_LOG(LogTbSame2SameEnum2Interface_JNI, Warning, TEXT("Java_tbSame2_tbSame2jniservice_SameEnum2InterfaceJniService_nativeFunc2 (in GameThread), UTbSame2SameEnum2InterfaceJniAdapter not valid to use, probably too early or too late."));
				return TOptional<ETbSame2Enum1>();
			}
		...
		if (!optResult.IsSet())
		{
			UE_LOG(LogTbSame2SameEnum2Interface_JNI, Warning, TEXT("Java_tbSame2_tbSame2jniservice_SameEnum2InterfaceJniService_nativeFunc2, couldn't get result."));
			return nullptr;
		}
		auto result = optResult.GetValue();
		jobject jresult = TbSame2DataJavaConverter::makeJavaEnum1(Env, result);
...
JNI_METHOD void Java_tbSame2_tbSame2jniservice_SameEnum2InterfaceJniService_nativeSetProp1(JNIEnv* Env, jclass Clazz, jobject prop1)
{
	...
	if (!jniAccessor)
	{
		UE_LOG(LogTbSame2SameEnum2Interface_JNI, Warning, TEXT("Java_tbSame2_tbSame2jniservice_SameEnum2InterfaceJniService_nativeSetProp1, UTbSame2SameEnum2InterfaceJniAdapter not valid to use, probably too early or too late."));
		return;
	}
...
JNI_METHOD jobject Java_tbSame2_tbSame2jniservice_SameEnum2InterfaceJniService_nativeGetProp1(JNIEnv* Env, jclass Clazz)
{
	...
	if (!jniAccessor)
	{
		UE_LOG(LogTbSame2SameEnum2Interface_JNI, Warning, TEXT("Java_tbSame2_tbSame2jniservice_SameEnum2InterfaceJniService_nativeGetProp1, UTbSame2SameEnum2InterfaceJniAdapter not valid to use, probably too early or too late."));
		return nullptr;
	}
...
JNI_METHOD void Java_tbSame2_tbSame2jniservice_SameEnum2InterfaceJniService_nativeSetProp2(JNIEnv* Env, jclass Clazz, jobject prop2)
{
	...
	if (!jniAccessor)
	{
		UE_LOG(LogTbSame2SameEnum2Interface_JNI, Warning, TEXT("Java_tbSame2_tbSame2jniservice_SameEnum2InterfaceJniService_nativeSetProp2, UTbSame2SameEnum2InterfaceJniAdapter not valid to use, probably too early or too late."));
		return;
	}
...
JNI_METHOD jobject Java_tbSame2_tbSame2jniservice_SameEnum2InterfaceJniService_nativeGetProp2(JNIEnv* Env, jclass Clazz)
{
	...
	if (!jniAccessor)
	{
		UE_LOG(LogTbSame2SameEnum2Interface_JNI, Warning, TEXT("Java_tbSame2_tbSame2jniservice_SameEnum2InterfaceJniService_nativeGetProp2, UTbSame2SameEnum2InterfaceJniAdapter not valid to use, probably too early or too late."));
		return nullptr;
	}
