...
void TbSame2JniCache::init()
{
	...
	javaStructField1field1FieldId = env->GetFieldID(TbSame2JniCache::javaStructField1, "field1", "I");
	javaStructField2field2FieldId = env->GetFieldID(TbSame2JniCache::javaStructField2, "field2", "I");
	javaStructField3field3FieldId = env->GetFieldID(TbSame2JniCache::javaStructField3, "field3", "I");
	...
	javaClassSameStruct1InterfaceSig1SignalMethodID = env->GetMethodID(TbSame2JniCache::javaClassSameStruct1Interface, "onSig1", "(LtbSame2/tbSame2_api/Struct1;)V");
	javaClassSameStruct1InterfaceFunc1MethodID = env->GetMethodID(TbSame2JniCache::javaClassSameStruct1Interface, "func1Async", "(Ljava/lang/String;LtbSame2/tbSame2_api/Struct1;)V");
	...
	javaClassSameStruct2InterfaceSig1SignalMethodID = env->GetMethodID(TbSame2JniCache::javaClassSameStruct2Interface, "onSig1", "(LtbSame2/tbSame2_api/Struct1;)V");
	javaClassSameStruct2InterfaceSig2SignalMethodID = env->GetMethodID(TbSame2JniCache::javaClassSameStruct2Interface, "onSig2", "(LtbSame2/tbSame2_api/Struct1;LtbSame2/tbSame2_api/Struct2;)V");
	javaClassSameStruct2InterfaceFunc1MethodID = env->GetMethodID(TbSame2JniCache::javaClassSameStruct2Interface, "func1Async", "(Ljava/lang/String;LtbSame2/tbSame2_api/Struct1;)V");
	javaClassSameStruct2InterfaceFunc2MethodID = env->GetMethodID(TbSame2JniCache::javaClassSameStruct2Interface, "func2Async", "(Ljava/lang/String;LtbSame2/tbSame2_api/Struct1;LtbSame2/tbSame2_api/Struct2;)V");
	...
	javaClassSameEnum1InterfaceSig1SignalMethodID = env->GetMethodID(TbSame2JniCache::javaClassSameEnum1Interface, "onSig1", "(LtbSame2/tbSame2_api/Enum1;)V");
	javaClassSameEnum1InterfaceFunc1MethodID = env->GetMethodID(TbSame2JniCache::javaClassSameEnum1Interface, "func1Async", "(Ljava/lang/String;LtbSame2/tbSame2_api/Enum1;)V");
	...
	javaClassSameEnum2InterfaceSig1SignalMethodID = env->GetMethodID(TbSame2JniCache::javaClassSameEnum2Interface, "onSig1", "(LtbSame2/tbSame2_api/Enum1;)V");
	javaClassSameEnum2InterfaceSig2SignalMethodID = env->GetMethodID(TbSame2JniCache::javaClassSameEnum2Interface, "onSig2", "(LtbSame2/tbSame2_api/Enum1;LtbSame2/tbSame2_api/Enum2;)V");
	javaClassSameEnum2InterfaceFunc1MethodID = env->GetMethodID(TbSame2JniCache::javaClassSameEnum2Interface, "func1Async", "(Ljava/lang/String;LtbSame2/tbSame2_api/Enum1;)V");
	javaClassSameEnum2InterfaceFunc2MethodID = env->GetMethodID(TbSame2JniCache::javaClassSameEnum2Interface, "func2Async", "(Ljava/lang/String;LtbSame2/tbSame2_api/Enum1;LtbSame2/tbSame2_api/Enum2;)V");
