...
TSharedPtr<FTbSame2DataJavaConverterCacheData, ESPMode::ThreadSafe> TbSame2DataJavaConverter::ensureInitialized()
{
	...
	{
		UE_LOG(LogTbSame2DataJavaConverter_JNI, Warning, TEXT("TbSame2DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgSameStruct1Interface))
	{
		UE_LOG(LogTbSame2DataJavaConverter_JNI, Warning, TEXT("TbSame2DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgSameStruct2Interface))
	{
		UE_LOG(LogTbSame2DataJavaConverter_JNI, Warning, TEXT("TbSame2DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgSameEnum1Interface))
	{
		UE_LOG(LogTbSame2DataJavaConverter_JNI, Warning, TEXT("TbSame2DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgSameEnum2Interface))
	{
		UE_LOG(LogTbSame2DataJavaConverter_JNI, Warning, TEXT("TbSame2DataJavaConverter initialization failed"));
		return nullptr;
	}
