...
namespace {
    ...
    TFunction<void(bool)> gUTbSame2SameEnum2InterfaceJniClientnotifyIsReady = [](bool value) { (void)value; UE_LOG(LogTbSame2SameEnum2InterfaceClient_JNI, Warning, TEXT("notifyIsReady used but not set ")); };
    TFunction<void(ETbSame2Enum1)> gUTbSame2SameEnum2InterfaceJniClientOnProp1ChangedEmpty = [](ETbSame2Enum1 value) { (void)value; UE_LOG(LogTbSame2SameEnum2InterfaceClient_JNI, Warning, TEXT("onProp1Changed used but not set ")); };
    ...
    TFunction<void(ETbSame2Enum2)> gUTbSame2SameEnum2InterfaceJniClientOnProp2ChangedEmpty = [](ETbSame2Enum2 value) { (void)value; UE_LOG(LogTbSame2SameEnum2InterfaceClient_JNI, Warning, TEXT("onProp2Changed used but not set ")); };
...
void UTbSame2SameEnum2InterfaceJniClient::Initialize(FSubsystemCollectionBase& Collection)
{
    ...
    m_javaJniClientClass = FAndroidApplication::FindJavaClassGlobalRef("tbSame2/tbSame2jniclient/SameEnum2InterfaceJniClient");
...
void UTbSame2SameEnum2InterfaceJniClient::Deinitialize()
{
    ...
    gUTbSame2SameEnum2InterfaceJniClientnotifyIsReady = [](bool value){(void)value; UE_LOG(LogTbSame2SameEnum2InterfaceClient_JNI, Warning, TEXT("notifyIsReady used but not set "));};
...
void UTbSame2SameEnum2InterfaceJniClient::SetProp2(ETbSame2Enum2 InProp2)
{
    ...
    if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
    {
        ...
        static jmethodID MethodID = Env->GetMethodID(m_javaJniClientClass, "setProp2", "(LtbSame2/tbSame2_api/Enum2;)V");
        if (MethodID == nullptr)
        {
...
ETbSame2Enum1 UTbSame2SameEnum2InterfaceJniClient::Func2(ETbSame2Enum1 InParam1, ETbSame2Enum2 InParam2)
{
    ...
    JNIEnv* Env = FAndroidApplication::GetJavaEnv();
    static jmethodID MethodID = Env->GetMethodID(m_javaJniClientClass, "func2Async", "(Ljava/lang/String;LtbSame2/tbSame2_api/Enum1;LtbSame2/tbSame2_api/Enum2;)V");
    if (MethodID != nullptr)
    {
        auto id = gUTbSame2SameEnum2InterfaceJniClientmethodHelper.StorePromise(Promise);
        auto idString = FJavaHelper::ToJavaString(Env, id.ToString(EGuidFormats::Digits));
...
JNI_METHOD void Java_tbSame2_tbSame2jniclient_SameEnum2InterfaceJniClient_nativeOnProp1Changed(JNIEnv* Env, jclass Clazz,jobject prop1)
{
    ...
    {
        gUTbSame2SameEnum2InterfaceJniClientOnProp1Changed(plocal_prop1);
    });
}
JNI_METHOD void Java_tbSame2_tbSame2jniclient_SameEnum2InterfaceJniClient_nativeOnProp2Changed(JNIEnv* Env, jclass Clazz,jobject prop2)
{
    ...
    {
        gUTbSame2SameEnum2InterfaceJniClientOnProp2Changed(plocal_prop2);
    });
}
    ...
    AsyncTask(ENamedThreads::GameThread, [ plocal_param1= MoveTemp(local_param1)]()
        {
            ...
            gUTbSame2SameEnum2InterfaceJniClientHandle->_GetPublisher()->BroadcastSig1Signal( plocal_param1);
        });
}
    ...
    AsyncTask(ENamedThreads::GameThread, [ plocal_param1= MoveTemp(local_param1),  plocal_param2= MoveTemp(local_param2)]()
        {
            ...
            gUTbSame2SameEnum2InterfaceJniClientHandle->_GetPublisher()->BroadcastSig2Signal( plocal_param1,  plocal_param2);
        });
}
...
JNI_METHOD void Java_tbSame2_tbSame2jniclient_SameEnum2InterfaceJniClient_nativeOnFunc1Result(JNIEnv* Env, jclass Clazz, jobject result, jstring callId)
{
    ...
    {
        gUTbSame2SameEnum2InterfaceJniClientmethodHelper.FulfillPromise(guid, local_result);
    });
