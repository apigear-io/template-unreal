...
FTbSame2Struct1 UTbSame2SameStruct1InterfaceJniClient::Func1(const FTbSame2Struct1& InParam1)
{
	...
	if (MethodID != nullptr)
	{
		...
		static const TCHAR* errorMsgId = TEXT("failed to craete java string for id in call func1Async on tbSame2/tbSame2jniclient/SameStruct1InterfaceJniClient");
...
bool UTbSame2SameStruct1InterfaceJniClient::_bindToService(FString servicePackage, FString connectionId)
{
	...
	if (MethodID != nullptr)
	{
		...
		static const TCHAR* errorMsgPackage = TEXT("failed to craete java string for package in call bind on tbSame2/tbSame2jniclient/SameStruct1InterfaceJniClient");
		TbSame2DataJavaConverter::checkJniError(errorMsgPackage);
		auto jConnId = FJavaHelper::ToJavaString(Env, connectionId);
		static const TCHAR* errorMsgId = TEXT("failed to craete java string for connection id in call bind on tbSame2/tbSame2jniclient/SameStruct1InterfaceJniClient");
		TbSame2DataJavaConverter::checkJniError(errorMsgId);
...
JNI_METHOD void Java_tbSame2_tbSame2jniclient_SameStruct1InterfaceJniClient_nativeOnFunc1Result(JNIEnv* Env, jclass Clazz, jobject result, jstring callId)
{
	...
	static const TCHAR* errorMsgId = TEXT("failed to craete java string for call id in call nativeOnFunc1 for tbSame2/tbSame2jniclient/SameStruct1InterfaceJniClient");
	TbSame2DataJavaConverter::checkJniError(errorMsgId);
	FGuid guid;
