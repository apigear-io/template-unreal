...
DECLARE_LOG_CATEGORY_EXTERN(LogTbSame2CommonJavaConverter_JNI, Log, All);

class FTbSame2CommonJavaConverter
{
public:
...
private:
	...
	FTbSame2CommonJavaConverter() = delete;
};

template<>
struct FTbSame2CommonJavaConverter::JniArrayTraits<bool>
{
...
template<>
struct FTbSame2CommonJavaConverter::JniArrayTraits<int32>
{
...
template<>
struct FTbSame2CommonJavaConverter::JniArrayTraits<int64>
{
...
template<>
struct FTbSame2CommonJavaConverter::JniArrayTraits<float>
{
...
template<>
struct FTbSame2CommonJavaConverter::JniArrayTraits<double>
{
...
FTbSame2CommonJavaConverter::TryFillArray(
    JNIEnv* Env, TArray<PrimitiveType>& OutPrimitiveArray, jarray InJniArray, const FString& InPropertyName)
{
	...
	{
		UE_LOG(LogTbSame2CommonJavaConverter_JNI, Warning, TEXT("%s is null"), *InPropertyName);
		return false;
	}
