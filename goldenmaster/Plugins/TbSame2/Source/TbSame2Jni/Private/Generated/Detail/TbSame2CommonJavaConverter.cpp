...
DEFINE_LOG_CATEGORY(LogTbSame2CommonJavaConverter_JNI);

bool FTbSame2CommonJavaConverter::CheckJniErrorOccurred(const TCHAR* Msg)
{
	...
	if (env->ExceptionCheck())
	{
		...
		env->ExceptionClear();
		UE_LOG(LogTbSame2CommonJavaConverter_JNI, Error, TEXT("%s"), Msg);
		return true;
	}
	return false;
}

bool FTbSame2CommonJavaConverter::TryFillArray(
