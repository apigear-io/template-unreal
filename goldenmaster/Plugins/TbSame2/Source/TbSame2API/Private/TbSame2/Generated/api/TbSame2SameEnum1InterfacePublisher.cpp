...
void UTbSame2SameEnum1InterfacePublisher::BroadcastSig1Signal(ETbSame2Enum1 Param1)
{
	...
	auto BroadcastAll = [WeakPtr = TWeakObjectPtr<UTbSame2SameEnum1InterfacePublisher>(this), SubscribersCopy, BPSubscribersCopy, Param1]()
	{
		if (!WeakPtr.IsValid())
		{
			return;
...
void UTbSame2SameEnum1InterfacePublisher::BroadcastProp1Changed(UPARAM(DisplayName = "Prop1") ETbSame2Enum1 InProp1)
{
	...
	auto BroadcastAll = [WeakPtr = TWeakObjectPtr<UTbSame2SameEnum1InterfacePublisher>(this), SubscribersCopy, BPSubscribersCopy, InProp1]()
	{
		if (!WeakPtr.IsValid())
		{
			return;
...
void UTbSame2SameEnum1InterfacePublisher::CleanUpSubscribers()
{
	...
	{
		FWriteScopeLock WriteLock(SubscribersLock);
		Subscribers.RemoveAllSwap([](const TWeakInterfacePtr<ITbSame2SameEnum1InterfaceSubscriberInterface>& Subscriber)
			{
	...
	{
		FWriteScopeLock WriteLock(BPSubscribersLock);
		BPSubscribers.RemoveAllSwap([](const TScriptInterface<ITbSame2SameEnum1InterfaceBPSubscriberInterface>& Subscriber)
			{
			UObject* Obj = Subscriber.GetObject();
