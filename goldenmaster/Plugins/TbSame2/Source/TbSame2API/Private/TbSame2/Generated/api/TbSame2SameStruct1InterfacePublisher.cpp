...
void UTbSame2SameStruct1InterfacePublisher::BroadcastSig1Signal(const FTbSame2Struct1& Param1)
{
	...
	auto BroadcastAll = [WeakPtr = TWeakObjectPtr<UTbSame2SameStruct1InterfacePublisher>(this), SubscribersCopy, BPSubscribersCopy, Param1]()
	{
		if (!WeakPtr.IsValid())
		{
			return;
...
void UTbSame2SameStruct1InterfacePublisher::BroadcastProp1Changed(UPARAM(DisplayName = "Prop1") const FTbSame2Struct1& InProp1)
{
	...
	auto BroadcastAll = [WeakPtr = TWeakObjectPtr<UTbSame2SameStruct1InterfacePublisher>(this), SubscribersCopy, BPSubscribersCopy, InProp1]()
	{
		if (!WeakPtr.IsValid())
		{
			return;
