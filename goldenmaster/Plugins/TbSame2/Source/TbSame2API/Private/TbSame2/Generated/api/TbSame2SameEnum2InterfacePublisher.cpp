...
void UTbSame2SameEnum2InterfacePublisher::BroadcastSig1Signal(ETbSame2Enum1 Param1)
{
	...
	auto BroadCastOnGameThread = [WeakPtr = TWeakObjectPtr<UTbSame2SameEnum2InterfacePublisher>(this), BPSubscribersCopy, Param1]()
	{
		if (WeakPtr.IsValid())
		{
...
void UTbSame2SameEnum2InterfacePublisher::BroadcastSig2Signal(ETbSame2Enum1 Param1, ETbSame2Enum2 Param2)
{
	...
	auto BroadCastOnGameThread = [WeakPtr = TWeakObjectPtr<UTbSame2SameEnum2InterfacePublisher>(this), BPSubscribersCopy, Param1, Param2]()
	{
		if (WeakPtr.IsValid())
		{
...
void UTbSame2SameEnum2InterfacePublisher::BroadcastProp1Changed(UPARAM(DisplayName = "Prop1") ETbSame2Enum1 InProp1)
{
	...
	auto BroadCastOnGameThread = [WeakPtr = TWeakObjectPtr<UTbSame2SameEnum2InterfacePublisher>(this), BPSubscribersCopy, InProp1]()
	{
		if (WeakPtr.IsValid())
		{
...
void UTbSame2SameEnum2InterfacePublisher::BroadcastProp2Changed(UPARAM(DisplayName = "Prop2") ETbSame2Enum2 InProp2)
{
	...
	auto BroadCastOnGameThread = [WeakPtr = TWeakObjectPtr<UTbSame2SameEnum2InterfacePublisher>(this), BPSubscribersCopy, InProp2]()
	{
		if (WeakPtr.IsValid())
		{
