...
{
	ensureMsgf(InTarget.GetObject() == nullptr || InTarget.GetObject()->Implements<UTbSame2SameStruct2InterfaceBPInterface>(),
		TEXT("UTbSame2SameStruct2InterfaceBPAdapter::Initialize: InTarget does not implement ITbSame2SameStruct2InterfaceBPInterface. All BP calls will be silently skipped."));
	Target = InTarget;
}
...
{
	TWeakObjectPtr<UTbSame2SameStruct2InterfaceBPAdapter> WeakThis(this);
	return Async(EAsyncExecution::TaskGraphMainThread,
		[Param1, WeakThis]()
		{
		if (UTbSame2SameStruct2InterfaceBPAdapter* StrongThis = WeakThis.Get())
		{
