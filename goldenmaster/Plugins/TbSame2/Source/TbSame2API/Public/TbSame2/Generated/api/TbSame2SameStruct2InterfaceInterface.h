...
/**
 * Subscriber interface for TbSame2SameStruct2Interface events. Intended for Blueprint-only use.
 * Does contain signal events and property-changed events.
 * @note Guaranteed to be run from within the GameThread.
 */
UINTERFACE(BlueprintType)
class UTbSame2SameStruct2InterfaceBPSubscriberInterface : public UInterface
{
	GENERATED_BODY()
};

class TBSAME2API_API ITbSame2SameStruct2InterfaceBPSubscriberInterface
{
	GENERATED_BODY()

public:
	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "ApiGear|TbSame2|SameStruct2Interface|Signals", DisplayName = "On Sig1 Signal")
	void OnSig1Signal(const FTbSame2Struct1& Param1);

	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "ApiGear|TbSame2|SameStruct2Interface|Signals", DisplayName = "On Sig2 Signal")
	void OnSig2Signal(const FTbSame2Struct1& Param1, const FTbSame2Struct2& Param2);

	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "ApiGear|TbSame2|SameStruct2Interface|Signals", DisplayName = "On Property Prop1 Changed")
	void OnProp1Changed(UPARAM(DisplayName = "Prop1") const FTbSame2Struct2& InProp1);

	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "ApiGear|TbSame2|SameStruct2Interface|Signals", DisplayName = "On Property Prop2 Changed")
	void OnProp2Changed(UPARAM(DisplayName = "Prop2") const FTbSame2Struct2& InProp2);
};

/**
 * Subscriber interface for TbSame2SameStruct2Interface events. Intended for C++ use.
 * Does contain signal events and property-changed events.
 * @note Not guaranteed to be run from within the GameThread - can be on any thread.
 */
UINTERFACE(BlueprintType, MinimalAPI, meta = (CannotImplementInterfaceInBlueprint))
class UTbSame2SameStruct2InterfaceSubscriberInterface : public UInterface
{
	GENERATED_BODY()
};

class TBSAME2API_API ITbSame2SameStruct2InterfaceSubscriberInterface
{
	GENERATED_BODY()
public:
	virtual void OnSig1Signal(const FTbSame2Struct1& Param1) = 0;

	virtual void OnSig2Signal(const FTbSame2Struct1& Param1, const FTbSame2Struct2& Param2) = 0;

	virtual void OnProp1Changed(UPARAM(DisplayName = "Prop1") const FTbSame2Struct2& InProp1) = 0;

	virtual void OnProp2Changed(UPARAM(DisplayName = "Prop2") const FTbSame2Struct2& InProp2) = 0;
};
...
public:
	...
	void Subscribe(const TWeakInterfacePtr<ITbSame2SameStruct2InterfaceSubscriberInterface>& Subscriber);
	UFUNCTION(BlueprintCallable, Category = "ApiGear|TbSame2|SameStruct2Interface|Signals")
	void Unsubscribe(const TScriptInterface<ITbSame2SameStruct2InterfaceBPSubscriberInterface>& Subscriber);
	void Unsubscribe(const TWeakInterfacePtr<ITbSame2SameStruct2InterfaceSubscriberInterface>& Subscriber);

private:
	void CleanUpSubscribers();

	TArray<TScriptInterface<ITbSame2SameStruct2InterfaceBPSubscriberInterface>> BPSubscribers;
	FRWLock BPSubscribersLock;
	TArray<TWeakInterfacePtr<ITbSame2SameStruct2InterfaceSubscriberInterface>> Subscribers;
...
public:
	...
	virtual TFuture<FTbSame2Struct1> Func1Async(const FTbSame2Struct1& Param1) = 0;
	...
	virtual TFuture<FTbSame2Struct1> Func2Async(const FTbSame2Struct1& Param1, const FTbSame2Struct2& Param2) = 0;
	UFUNCTION(BlueprintCallable, Category = "ApiGear|TbSame2|SameStruct2Interface|Operations")
