...
/**
 * Subscriber interface for TbSame2SameStruct1Interface events. Intended for Blueprint-only use.
 * Does contain signal events and property-changed events.
 * @note Guaranteed to be run from within the GameThread.
 */
UINTERFACE(BlueprintType)
class UTbSame2SameStruct1InterfaceBPSubscriberInterface : public UInterface
{
	GENERATED_BODY()
};

class TBSAME2API_API ITbSame2SameStruct1InterfaceBPSubscriberInterface
{
	GENERATED_BODY()

public:
	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "ApiGear|TbSame2|SameStruct1Interface|Signals", DisplayName = "On Sig1 Signal")
	void OnSig1Signal(const FTbSame2Struct1& Param1);

	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "ApiGear|TbSame2|SameStruct1Interface|Signals", DisplayName = "On Property Prop1 Changed")
	void OnProp1Changed(UPARAM(DisplayName = "Prop1") const FTbSame2Struct1& InProp1);
};

/**
 * Subscriber interface for TbSame2SameStruct1Interface events. Intended for C++ use.
 * Does contain signal events and property-changed events.
...
class TBSAME2API_API UTbSame2SameStruct1InterfacePublisher : public UObject
{
	GENERATED_BODY()
...
public:
	...
	virtual UTbSame2SameStruct1InterfacePublisher* _GetPublisher() = 0;
