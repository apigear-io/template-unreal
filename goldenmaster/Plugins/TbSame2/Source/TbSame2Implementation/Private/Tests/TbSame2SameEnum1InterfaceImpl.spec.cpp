...
void UTbSame2SameEnum1InterfaceImplSpec::Define()
{
	...
	LatentIt("Property.Prop1.ChangeBP", EAsyncExecution::ThreadPool, [this](const FDoneDelegate TestDone)
		...
		UTbSame2SameEnum1InterfacePublisher* TbSame2SameEnum1InterfacePublisher = ImplFixture->GetImplementation()->_GetPublisher();
		TbSame2SameEnum1InterfacePublisher->OnProp1ChangedBP.AddDynamic(ImplFixture->GetHelper().Get(), &UTbSame2SameEnum1InterfaceImplHelper::Prop1PropertyCb);
		// use different test value
		TestValue = ETbSame2Enum1::TS2E1_Value2;
		ImplFixture->GetImplementation()->SetProp1(TestValue);
	});
	...
	LatentIt("Signal.Sig1BP", EAsyncExecution::ThreadPool, [this](const FDoneDelegate TestDone)
		...
		ImplFixture->GetHelper()->SetTestDone(TestDone);
		UTbSame2SameEnum1InterfacePublisher* TbSame2SameEnum1InterfacePublisher = ImplFixture->GetImplementation()->_GetPublisher();
		TbSame2SameEnum1InterfacePublisher->OnSig1SignalBP.AddDynamic(ImplFixture->GetHelper().Get(), &UTbSame2SameEnum1InterfaceImplHelper::Sig1SignalCb);
