...
TSharedRef<IDetailCustomization> FExternTypesConnectionSettingsDetails::MakeInstance()
{
	return MakeShareable(new FExternTypesConnectionSettingsDetails);
}

TSharedRef<SWidget> FExternTypesConnectionSettingsDetails::MakeDefaultBackendServiceSelectorWidget(const TSharedPtr<IPropertyHandle>& PropertyHandle)
{
	...
	TSharedPtr<FText> LocalServiceName = TSharedPtr<FText>(new FText(FText::FromString(ExternTypesLocalBackendIdentifier)));
...
void FExternTypesConnectionSettingsDetails::CustomizeTracerDetails(IDetailLayoutBuilder& DetailBuilder)
{
...
TSharedRef<SWidget> FExternTypesConnectionSettingsDetails::MakeDefaultOLinkConnectionSelectorWidget(const TSharedPtr<IPropertyHandle>& PropertyHandle)
{
	UApiGearSettings* settings = GetMutableDefault<UApiGearSettings>();
	check(settings);
...
void FExternTypesConnectionSettingsDetails::CustomizeOLinkDetails(IDetailLayoutBuilder& DetailBuilder)
{
...
TSharedRef<SWidget> FExternTypesConnectionSettingsDetails::MakeDefaultMqttConnectionSelectorWidget(const TSharedPtr<IPropertyHandle>& PropertyHandle)
{
	UApiGearSettings* settings = GetMutableDefault<UApiGearSettings>();
	check(settings);
...
void FExternTypesConnectionSettingsDetails::CustomizeMqttDetails(IDetailLayoutBuilder& DetailBuilder)
{
...
void FExternTypesConnectionSettingsDetails::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
