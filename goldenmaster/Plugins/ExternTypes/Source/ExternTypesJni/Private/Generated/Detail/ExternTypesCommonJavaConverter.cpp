...
DEFINE_LOG_CATEGORY(LogExternTypesCommonJavaConverter_JNI);

bool FExternTypesCommonJavaConverter::CheckJniErrorOccurred(const TCHAR* Msg)
{
	...
	if (env->ExceptionCheck())
	{
		...
		env->ExceptionClear();
		UE_LOG(LogExternTypesCommonJavaConverter_JNI, Error, TEXT("%s"), Msg);
		return true;
	}
	return false;
}
