...
DECLARE_LOG_CATEGORY_EXTERN(LogExternTypesCommonJavaConverter_JNI, Log, All);

class FExternTypesCommonJavaConverter
{
public:
...
private:
	...
	FExternTypesCommonJavaConverter() = delete;
};

template<>
struct FExternTypesCommonJavaConverter::JniArrayTraits<bool>
{
...
template<>
struct FExternTypesCommonJavaConverter::JniArrayTraits<int32>
{
...
template<>
struct FExternTypesCommonJavaConverter::JniArrayTraits<int64>
{
...
template<>
struct FExternTypesCommonJavaConverter::JniArrayTraits<float>
{
...
template<>
struct FExternTypesCommonJavaConverter::JniArrayTraits<double>
{
...
FExternTypesCommonJavaConverter::TryFillArray(
    JNIEnv* Env, TArray<PrimitiveType>& OutPrimitiveArray, jarray InJniArray, const FString& InPropertyName)
{
