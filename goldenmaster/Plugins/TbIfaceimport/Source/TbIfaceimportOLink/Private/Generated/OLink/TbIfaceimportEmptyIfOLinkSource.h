...
DECLARE_LOG_CATEGORY_EXTERN(LogTbIfaceimportEmptyIfOLinkSource, Log, All);
/** @brief handles OLink network interactions specific to ITbIfaceimportEmptyIfInterface */
class TbIfaceimportEmptyIfOLinkSource : public ApiGear::ObjectLink::IObjectSource
{
public:
	explicit TbIfaceimportEmptyIfOLinkSource();
	virtual ~TbIfaceimportEmptyIfOLinkSource() = default;
...
class TbIfaceimportEmptyIfOLinkSource
{
};
