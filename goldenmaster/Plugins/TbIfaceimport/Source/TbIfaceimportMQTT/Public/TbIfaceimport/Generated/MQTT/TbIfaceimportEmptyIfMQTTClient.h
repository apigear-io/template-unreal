...
#include "Misc/Guid.h"
#include "TbIfaceimportEmptyIfMQTTClient.generated.h"
DECLARE_LOG_CATEGORY_EXTERN(LogTbIfaceimportEmptyIfMQTTClient, Log, All);

UCLASS(NotBlueprintable, BlueprintType)
class TBIFACEIMPORTMQTT_API UTbIfaceimportEmptyIfMQTTClient : public UAbstractTbIfaceimportEmptyIf
{
	GENERATED_BODY()
public:
	explicit UTbIfaceimportEmptyIfMQTTClient();

	// only needed in 4.25 to use TUniquePtr<TbIfaceimportEmptyIfPropertiesData>
	UTbIfaceimportEmptyIfMQTTClient(FVTableHelper& Helper);
	virtual ~UTbIfaceimportEmptyIfMQTTClient();
