...
DECLARE_LOG_CATEGORY_EXTERN(LogTbIfaceimportCommonJavaConverter_JNI, Log, All);

class FTbIfaceimportCommonJavaConverter
{
public:
	...
	static std::enable_if_t<std::is_arithmetic<PrimitiveType>::value, bool> TryFillArray(
...
private:
	...
	FTbIfaceimportCommonJavaConverter() = delete;
};

template<>
struct FTbIfaceimportCommonJavaConverter::JniArrayTraits<bool>
{
...
template<>
struct FTbIfaceimportCommonJavaConverter::JniArrayTraits<int32>
{
...
template<>
struct FTbIfaceimportCommonJavaConverter::JniArrayTraits<int64>
{
...
template<>
struct FTbIfaceimportCommonJavaConverter::JniArrayTraits<float>
{
...
template<>
struct FTbIfaceimportCommonJavaConverter::JniArrayTraits<double>
{
...
template <typename PrimitiveType>
std::enable_if_t<std::is_arithmetic<PrimitiveType>::value, bool>
FTbIfaceimportCommonJavaConverter::TryFillArray(
    JNIEnv* Env, TArray<PrimitiveType>& OutPrimitiveArray, jarray InJniArray, const FString& InPropertyName)
{
	...
	{
		Algo::Transform(TempJniArray, Result, [](JniElement V) { return static_cast<PrimitiveType>(V); });
	}
