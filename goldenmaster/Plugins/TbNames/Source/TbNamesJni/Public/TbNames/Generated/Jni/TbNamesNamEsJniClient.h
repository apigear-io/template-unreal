...
public:
	...
	/** @param package. This client will connect only to a NamEs Service,
...
private:
	...
	bool tryCallAsyncJavaSomeFunction(FGuid Guid, jmethodID MethodId, bool bInSomeParam);

	bool tryCallAsyncJavaSomeFunction2(FGuid Guid, jmethodID MethodId, bool bInSomeParam);
#endif
	...
	mutable FRWLock m_SwitchRWLock;
	mutable FRWLock m_SomePropertyRWLock;
	mutable FRWLock m_SomePoperty2RWLock;
	mutable FRWLock m_EnumPropertyRWLock;
};
