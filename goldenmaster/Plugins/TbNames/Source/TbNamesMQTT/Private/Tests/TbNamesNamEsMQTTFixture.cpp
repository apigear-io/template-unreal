...
namespace Tests
{
FTbNamesNamEsMQTTFixture::FTbNamesNamEsMQTTFixture()
{
	testImplementation = GetGameInstance()->GetSubsystem<UTbNamesNamEsMQTTClient>();
	...
	auto service = GetGameInstance()->GetSubsystem<UTbNamesNamEsImplementation>();
...
TScriptInterface<ITbNamesNamEsInterface> FTbNamesNamEsMQTTFixture::GetImplementation()
{
	return testImplementation;
}

UApiGearMQTTHost* FTbNamesNamEsMQTTFixture::GetHost()
{
	return Host.Get();
}

UTbNamesNamEsMQTTAdapter* FTbNamesNamEsMQTTFixture::GetAdapter()
{
	return GetGameInstance()->GetSubsystem<UTbNamesNamEsMQTTAdapter>();
}

UGameInstance* FTbNamesNamEsMQTTFixture::GetGameInstance()
{
...
void FTbNamesNamEsMQTTFixture::CleanUp()
{
	if (Host.IsValid())
	{
		Host->Stop();
