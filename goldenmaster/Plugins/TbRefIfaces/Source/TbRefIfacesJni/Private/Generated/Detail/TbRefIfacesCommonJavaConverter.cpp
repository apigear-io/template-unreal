...
DEFINE_LOG_CATEGORY(LogTbRefIfacesCommonJavaConverter_JNI);

bool FTbRefIfacesCommonJavaConverter::CheckJniErrorOccurred(const TCHAR* Msg)
{
	...
	if (env->ExceptionCheck())
	{
		...
		env->ExceptionClear();
		UE_LOG(LogTbRefIfacesCommonJavaConverter_JNI, Error, TEXT("%s"), Msg);
		return true;
	}
	return false;
}

bool FTbRefIfacesCommonJavaConverter::TryFillArray(
