...
DECLARE_LOG_CATEGORY_EXTERN(LogTbRefIfacesCommonJavaConverter_JNI, Log, All);

class FTbRefIfacesCommonJavaConverter
{
public:
...
private:
	...
	FTbRefIfacesCommonJavaConverter() = delete;
};

template<>
struct FTbRefIfacesCommonJavaConverter::JniArrayTraits<bool>
{
...
template<>
struct FTbRefIfacesCommonJavaConverter::JniArrayTraits<int32>
{
...
template<>
struct FTbRefIfacesCommonJavaConverter::JniArrayTraits<int64>
{
...
template<>
struct FTbRefIfacesCommonJavaConverter::JniArrayTraits<float>
{
...
template<>
struct FTbRefIfacesCommonJavaConverter::JniArrayTraits<double>
{
...
FTbRefIfacesCommonJavaConverter::TryFillArray(
    JNIEnv* Env, TArray<PrimitiveType>& OutPrimitiveArray, jarray InJniArray, const FString& InPropertyName)
{
	...
	{
		UE_LOG(LogTbRefIfacesCommonJavaConverter_JNI, Warning, TEXT("%s is null"), *InPropertyName);
		return false;
	}
