...
void UTbRefIfacesParentIfJniClient::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	if (TbRefIfacesJniCache::clientClassParentIfCtor == nullptr)
	{
	...
	jobject localRef = Env->NewObject(TbRefIfacesJniCache::clientClassParentIf, TbRefIfacesJniCache::clientClassParentIfCtor);
...
void UTbRefIfacesParentIfJniClient::SetLocalIf(const TScriptInterface<ITbRefIfacesSimpleLocalIfInterface>& InLocalIf)
{
	...
	{
		if (TbRefIfacesJniCache::javaClassParentIf == nullptr)
		{
		...
		jmethodID MethodID = TbRefIfacesJniCache::javaClassParentIfLocalIfSetterId;
		if (MethodID == nullptr)
		{
...
void UTbRefIfacesParentIfJniClient::SetLocalIfList(const TArray<TScriptInterface<ITbRefIfacesSimpleLocalIfInterface>>& InLocalIfList)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = TbRefIfacesJniCache::javaClassParentIfLocalIfListSetterId;
		if (MethodID == nullptr)
		{
...
void UTbRefIfacesParentIfJniClient::SetImportedIf(const TScriptInterface<ITbIfaceimportEmptyIfInterface>& InImportedIf)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = TbRefIfacesJniCache::javaClassParentIfImportedIfSetterId;
		if (MethodID == nullptr)
		{
...
void UTbRefIfacesParentIfJniClient::SetImportedIfList(const TArray<TScriptInterface<ITbIfaceimportEmptyIfInterface>>& InImportedIfList)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = TbRefIfacesJniCache::javaClassParentIfImportedIfListSetterId;
		if (MethodID == nullptr)
		{
...
TScriptInterface<ITbRefIfacesSimpleLocalIfInterface> UTbRefIfacesParentIfJniClient::LocalIfMethod(const TScriptInterface<ITbRefIfacesSimpleLocalIfInterface>& InParam)
{
...
#if PLATFORM_ANDROID && USE_ANDROID_JNI
	if (TbRefIfacesJniCache::clientClassParentIf == nullptr)
	{
	...
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
	jmethodID MethodID = TbRefIfacesJniCache::clientClassParentIfLocalIfMethodAsyncMethodID;
	if (MethodID != nullptr)
	{
		...
		static const TCHAR* errorMsgId = TEXT("failed to craete java string for id in call localIfMethodAsync on tbRefIfaces/tbRefIfacesjniclient/ParentIfJniClient");
...
TArray<TScriptInterface<ITbRefIfacesSimpleLocalIfInterface>> UTbRefIfacesParentIfJniClient::LocalIfMethodList(const TArray<TScriptInterface<ITbRefIfacesSimpleLocalIfInterface>>& InParam)
{
	...
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
	jmethodID MethodID = TbRefIfacesJniCache::clientClassParentIfLocalIfMethodListAsyncMethodID;
	if (MethodID != nullptr)
	{
		auto id = gUTbRefIfacesParentIfJniClientmethodHelper.StorePromise(Promise);
		auto idString = FJavaHelper::ToJavaString(Env, id.ToString(EGuidFormats::Digits));
		static const TCHAR* errorMsgId = TEXT("failed to craete java string for id in call localIfMethodListAsync on tbRefIfaces/tbRefIfacesjniclient/ParentIfJniClient");
		TbRefIfacesDataJavaConverter::checkJniError(errorMsgId);
		// interfaces are currently not supported. TbRefIfacesDataJavaConverter returns empty array.
...
TScriptInterface<ITbIfaceimportEmptyIfInterface> UTbRefIfacesParentIfJniClient::ImportedIfMethod(const TScriptInterface<ITbIfaceimportEmptyIfInterface>& InParam)
{
	...
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
	jmethodID MethodID = TbRefIfacesJniCache::clientClassParentIfImportedIfMethodAsyncMethodID;
	if (MethodID != nullptr)
	{
		auto id = gUTbRefIfacesParentIfJniClientmethodHelper.StorePromise(Promise);
		auto idString = FJavaHelper::ToJavaString(Env, id.ToString(EGuidFormats::Digits));
		static const TCHAR* errorMsgId = TEXT("failed to craete java string for id in call importedIfMethodAsync on tbRefIfaces/tbRefIfacesjniclient/ParentIfJniClient");
		TbRefIfacesDataJavaConverter::checkJniError(errorMsgId);
		// interfaces are currently not supported. TbIfaceimportDataJavaConverter returns nullptr.
...
TArray<TScriptInterface<ITbIfaceimportEmptyIfInterface>> UTbRefIfacesParentIfJniClient::ImportedIfMethodList(const TArray<TScriptInterface<ITbIfaceimportEmptyIfInterface>>& InParam)
{
	...
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
	jmethodID MethodID = TbRefIfacesJniCache::clientClassParentIfImportedIfMethodListAsyncMethodID;
	if (MethodID != nullptr)
	{
		auto id = gUTbRefIfacesParentIfJniClientmethodHelper.StorePromise(Promise);
		auto idString = FJavaHelper::ToJavaString(Env, id.ToString(EGuidFormats::Digits));
		static const TCHAR* errorMsgId = TEXT("failed to craete java string for id in call importedIfMethodListAsync on tbRefIfaces/tbRefIfacesjniclient/ParentIfJniClient");
		TbRefIfacesDataJavaConverter::checkJniError(errorMsgId);
		// interfaces are currently not supported. TbIfaceimportDataJavaConverter returns empty array.
...
bool UTbRefIfacesParentIfJniClient::_bindToService(FString servicePackage, FString connectionId)
{
	...
	jmethodID MethodID = TbRefIfacesJniCache::clientClassParentIfBindMethodID;
	if (MethodID != nullptr)
	{
		jobject Activity = FJavaWrapper::GameActivityThis;
		auto jPackage = FJavaHelper::ToJavaString(Env, servicePackage);
		static const TCHAR* errorMsgPackage = TEXT("failed to craete java string for package in call bind on tbRefIfaces/tbRefIfacesjniclient/ParentIfJniClient");
		TbRefIfacesDataJavaConverter::checkJniError(errorMsgPackage);
		auto jConnId = FJavaHelper::ToJavaString(Env, connectionId);
		static const TCHAR* errorMsgId = TEXT("failed to craete java string for connection id in call bind on tbRefIfaces/tbRefIfacesjniclient/ParentIfJniClient");
		TbRefIfacesDataJavaConverter::checkJniError(errorMsgId);
...
void UTbRefIfacesParentIfJniClient::_unbind()
{
	...
	jmethodID MethodID = TbRefIfacesJniCache::clientClassParentIfUnbindMethodID;
	if (MethodID != nullptr)
	{
...
JNI_METHOD void Java_tbRefIfaces_tbRefIfacesjniclient_ParentIfJniClient_nativeOnLocalIfMethodResult(JNIEnv* Env, jclass Clazz, jobject result, jstring callId)
{
	...
	static const TCHAR* errorMsgId = TEXT("failed to craete java string for call id in call nativeOnLocalIfMethod for tbRefIfaces/tbRefIfacesjniclient/ParentIfJniClient");
	TbRefIfacesDataJavaConverter::checkJniError(errorMsgId);
	FGuid guid;
...
JNI_METHOD void Java_tbRefIfaces_tbRefIfacesjniclient_ParentIfJniClient_nativeOnLocalIfMethodListResult(JNIEnv* Env, jclass Clazz, jobjectArray result, jstring callId)
{
	...
	FString callIdString = FJavaHelper::FStringFromParam(Env, callId);
	static const TCHAR* errorMsgId = TEXT("failed to craete java string for call id in call nativeOnLocalIfMethodList for tbRefIfaces/tbRefIfacesjniclient/ParentIfJniClient");
	TbRefIfacesDataJavaConverter::checkJniError(errorMsgId);
	FGuid guid;
...
JNI_METHOD void Java_tbRefIfaces_tbRefIfacesjniclient_ParentIfJniClient_nativeOnImportedIfMethodResult(JNIEnv* Env, jclass Clazz, jobject result, jstring callId)
{
	...
	FString callIdString = FJavaHelper::FStringFromParam(Env, callId);
	static const TCHAR* errorMsgId = TEXT("failed to craete java string for call id in call nativeOnImportedIfMethod for tbRefIfaces/tbRefIfacesjniclient/ParentIfJniClient");
	TbRefIfacesDataJavaConverter::checkJniError(errorMsgId);
	FGuid guid;
...
JNI_METHOD void Java_tbRefIfaces_tbRefIfacesjniclient_ParentIfJniClient_nativeOnImportedIfMethodListResult(JNIEnv* Env, jclass Clazz, jobjectArray result, jstring callId)
{
	...
	FString callIdString = FJavaHelper::FStringFromParam(Env, callId);
	static const TCHAR* errorMsgId = TEXT("failed to craete java string for call id in call nativeOnImportedIfMethodList for tbRefIfaces/tbRefIfacesjniclient/ParentIfJniClient");
	TbRefIfacesDataJavaConverter::checkJniError(errorMsgId);
	FGuid guid;
