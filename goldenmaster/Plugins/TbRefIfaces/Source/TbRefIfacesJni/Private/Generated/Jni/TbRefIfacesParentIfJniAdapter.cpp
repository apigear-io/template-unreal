...
void UTbRefIfacesParentIfJniAdapter::callJniServiceReady(bool isServiceReady)
{
	...
	{
		if (!TbRefIfacesJniCache::javaClassParentIf || !m_javaJniServiceInstance || !TbRefIfacesJniCache::serviceClassParentIfReadyMethodID)
		{
		...
		FJavaWrapper::CallVoidMethod(Env, m_javaJniServiceInstance, TbRefIfacesJniCache::serviceClassParentIfReadyMethodID, isServiceReady);
...
void UTbRefIfacesParentIfJniAdapter::OnLocalIfSignalSignal(const TScriptInterface<ITbRefIfacesSimpleLocalIfInterface>& Param)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (TbRefIfacesJniCache::serviceClassParentIf == nullptr || m_javaJniServiceInstance == nullptr)
		{
		...
		jmethodID MethodID = TbRefIfacesJniCache::serviceClassParentIfLocalIfSignalSignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTbRefIfacesParentIfJniAdapter::OnLocalIfSignalListSignal(const TArray<TScriptInterface<ITbRefIfacesSimpleLocalIfInterface>>& Param)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = TbRefIfacesJniCache::serviceClassParentIfLocalIfSignalListSignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTbRefIfacesParentIfJniAdapter::OnImportedIfSignalSignal(const TScriptInterface<ITbIfaceimportEmptyIfInterface>& Param)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = TbRefIfacesJniCache::serviceClassParentIfImportedIfSignalSignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTbRefIfacesParentIfJniAdapter::OnImportedIfSignalListSignal(const TArray<TScriptInterface<ITbIfaceimportEmptyIfInterface>>& Param)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = TbRefIfacesJniCache::serviceClassParentIfImportedIfSignalListSignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTbRefIfacesParentIfJniAdapter::OnLocalIfChanged(const TScriptInterface<ITbRefIfacesSimpleLocalIfInterface>& LocalIf)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (TbRefIfacesJniCache::serviceClassParentIf == nullptr)
		{
		...
		jmethodID MethodID = TbRefIfacesJniCache::serviceClassParentIfLocalIfChangedMethodID;
		if (MethodID == nullptr)
		{
...
void UTbRefIfacesParentIfJniAdapter::OnLocalIfListChanged(const TArray<TScriptInterface<ITbRefIfacesSimpleLocalIfInterface>>& LocalIfList)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = TbRefIfacesJniCache::serviceClassParentIfLocalIfListChangedMethodID;
		if (MethodID == nullptr)
		{
...
void UTbRefIfacesParentIfJniAdapter::OnImportedIfChanged(const TScriptInterface<ITbIfaceimportEmptyIfInterface>& ImportedIf)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = TbRefIfacesJniCache::serviceClassParentIfImportedIfChangedMethodID;
		if (MethodID == nullptr)
		{
...
void UTbRefIfacesParentIfJniAdapter::OnImportedIfListChanged(const TArray<TScriptInterface<ITbIfaceimportEmptyIfInterface>>& ImportedIfList)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = TbRefIfacesJniCache::serviceClassParentIfImportedIfListChangedMethodID;
		if (MethodID == nullptr)
		{
