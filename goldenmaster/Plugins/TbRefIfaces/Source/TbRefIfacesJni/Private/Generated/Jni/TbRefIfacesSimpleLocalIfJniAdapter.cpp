...
void UTbRefIfacesSimpleLocalIfJniAdapter::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	TbRefIfacesDataJavaConverter::checkJniError(errorMsgCls);
	...
	TbRefIfacesDataJavaConverter::checkJniError(errorMsgMethodId);
	...
	TbRefIfacesDataJavaConverter::checkJniError(errorMsgCall);
...
void UTbRefIfacesSimpleLocalIfJniAdapter::callJniServiceReady(bool isServiceReady)
{
	...
	{
		if (!TbRefIfacesJniCache::javaClassSimpleLocalIf || !m_javaJniServiceInstance || !TbRefIfacesJniCache::serviceClassSimpleLocalIfReadyMethodID)
		{
		...
		FJavaWrapper::CallVoidMethod(Env, m_javaJniServiceInstance, TbRefIfacesJniCache::serviceClassSimpleLocalIfReadyMethodID, isServiceReady);
...
void UTbRefIfacesSimpleLocalIfJniAdapter::OnIntSignalSignal(int32 Param)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (TbRefIfacesJniCache::serviceClassSimpleLocalIf == nullptr || m_javaJniServiceInstance == nullptr)
		{
		...
		jmethodID MethodID = TbRefIfacesJniCache::serviceClassSimpleLocalIfIntSignalSignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTbRefIfacesSimpleLocalIfJniAdapter::OnIntPropertyChanged(int32 IntProperty)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (TbRefIfacesJniCache::serviceClassSimpleLocalIf == nullptr)
		{
		...
		jmethodID MethodID = TbRefIfacesJniCache::serviceClassSimpleLocalIfIntPropertyChangedMethodID;
		if (MethodID == nullptr)
		{
