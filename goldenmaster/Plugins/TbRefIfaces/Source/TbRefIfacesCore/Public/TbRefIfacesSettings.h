...
#include "TbRefIfacesSettings.generated.h"

const FString TbRefIfacesLocalBackendIdentifier = "Local";
...
/**
 * Implements the settings for the TbRefIfaces plugin.
 */
UCLASS(Config = Engine, DefaultConfig)
class TBREFIFACESCORE_API UTbRefIfacesSettings : public UObject
{
	GENERATED_BODY()

	UTbRefIfacesSettings(const FObjectInitializer& ObjectInitializer);
