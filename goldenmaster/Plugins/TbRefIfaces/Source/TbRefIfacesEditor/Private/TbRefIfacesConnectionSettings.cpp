...
TSharedRef<SWidget> FTbRefIfacesConnectionSettingsDetails::MakeDefaultMqttConnectionSelectorWidget(const TSharedPtr<IPropertyHandle>& PropertyHandle)
{
	UApiGearSettings* settings = GetMutableDefault<UApiGearSettings>();
	check(settings);
...
void FTbRefIfacesConnectionSettingsDetails::CustomizeMqttDetails(IDetailLayoutBuilder& DetailBuilder)
{
