...
TSharedRef<IDetailCustomization> FTbRefIfacesConnectionSettingsDetails::MakeInstance()
{
	return MakeShareable(new FTbRefIfacesConnectionSettingsDetails);
}

TSharedRef<SWidget> FTbRefIfacesConnectionSettingsDetails::MakeDefaultBackendServiceSelectorWidget(const TSharedPtr<IPropertyHandle>& PropertyHandle)
{
	...
	TSharedPtr<FText> LocalServiceName = TSharedPtr<FText>(new FText(FText::FromString(TbRefIfacesLocalBackendIdentifier)));
...
void FTbRefIfacesConnectionSettingsDetails::CustomizeTracerDetails(IDetailLayoutBuilder& DetailBuilder)
{
...
TSharedRef<SWidget> FTbRefIfacesConnectionSettingsDetails::MakeDefaultOLinkConnectionSelectorWidget(const TSharedPtr<IPropertyHandle>& PropertyHandle)
{
	UApiGearSettings* settings = GetMutableDefault<UApiGearSettings>();
	check(settings);
...
void FTbRefIfacesConnectionSettingsDetails::CustomizeOLinkDetails(IDetailLayoutBuilder& DetailBuilder)
{
...
void FTbRefIfacesConnectionSettingsDetails::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
