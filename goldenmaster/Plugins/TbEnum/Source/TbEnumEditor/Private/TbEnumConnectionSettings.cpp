...
TSharedRef<IDetailCustomization> FTbEnumConnectionSettingsDetails::MakeInstance()
{
...
TSharedRef<SWidget> FTbEnumConnectionSettingsDetails::MakeDefaultMqttConnectionSelectorWidget(const TSharedPtr<IPropertyHandle>& PropertyHandle)
{
	UApiGearSettings* settings = GetMutableDefault<UApiGearSettings>();
	check(settings);
...
void FTbEnumConnectionSettingsDetails::CustomizeMqttDetails(IDetailLayoutBuilder& DetailBuilder)
{
