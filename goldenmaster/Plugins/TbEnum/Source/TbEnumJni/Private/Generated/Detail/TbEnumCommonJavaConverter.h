...
DECLARE_LOG_CATEGORY_EXTERN(LogTbEnumCommonJavaConverter_JNI, Log, All);

class FTbEnumCommonJavaConverter
{
public:
...
private:
	...
	FTbEnumCommonJavaConverter() = delete;
};

template<>
struct FTbEnumCommonJavaConverter::JniArrayTraits<bool>
{
...
template<>
struct FTbEnumCommonJavaConverter::JniArrayTraits<int32>
{
...
template<>
struct FTbEnumCommonJavaConverter::JniArrayTraits<int64>
{
...
template<>
struct FTbEnumCommonJavaConverter::JniArrayTraits<float>
{
...
template<>
struct FTbEnumCommonJavaConverter::JniArrayTraits<double>
{
