...
void UTbEnumEnumInterfaceJniAdapterCache::init()
{
	...
	TbEnumDataJavaConverter::checkJniErrorOccurred(errorMsgReadyMethod);
	...
	TbEnumDataJavaConverter::checkJniErrorOccurred(errorMsgProp0Changed);
	...
	TbEnumDataJavaConverter::checkJniErrorOccurred(errorMsgProp1Changed);
	...
	TbEnumDataJavaConverter::checkJniErrorOccurred(errorMsgProp2Changed);
	...
	TbEnumDataJavaConverter::checkJniErrorOccurred(errorMsgProp3Changed);
	...
	TbEnumDataJavaConverter::checkJniErrorOccurred(errorMsgSig0Signal);
	...
	TbEnumDataJavaConverter::checkJniErrorOccurred(errorMsgSig1Signal);
	...
	TbEnumDataJavaConverter::checkJniErrorOccurred(errorMsgSig2Signal);
	...
	TbEnumDataJavaConverter::checkJniErrorOccurred(errorMsgSig3Signal);
}
