...
namespace Tests
{
BEGIN_DEFINE_SPEC(UTbSame1SameEnum1InterfaceJniSpec, "TbSame1.SameEnum1Interface.Jni", TbSame1TestFilterMask);

TUniquePtr<FTbSame1SameEnum1InterfaceJniFixture> ImplFixture;

END_DEFINE_SPEC(UTbSame1SameEnum1InterfaceJniSpec);

void UTbSame1SameEnum1InterfaceJniSpec::Define()
{
	LatentBeforeEach([this](const FDoneDelegate& TestDone)
		{
		ImplFixture = MakeUnique<FTbSame1SameEnum1InterfaceJniFixture>();
		...
		// setup client
		UTbSame1SameEnum1InterfaceJniClient* JniClient = ImplFixture->GetClient();
	...
	LatentIt("Property.Prop1.Change", EAsyncExecution::ThreadPool, [this](const FDoneDelegate TestDone)
		...
		UTbSame1SameEnum1InterfacePublisher* TbSame1SameEnum1InterfacePublisher = ImplFixture->GetClient()->_GetPublisher();
	...
	LatentIt("Property.Prop1.ChangeLocalCheckRemote", EAsyncExecution::ThreadPool, [this](const FDoneDelegate TestDone)
		...
		UTbSame1SameEnum1InterfacePublisher* TbSame1SameEnum1InterfacePublisher = ImplFixture->GetClient()->_GetPublisher();
#else
		UTbSame1SameEnum1InterfacePublisher* TbSame1SameEnum1InterfacePublisher = ImplFixture->GetLocalImplementation()->_GetPublisher();
#endif
		TbSame1SameEnum1InterfacePublisher->OnProp1Changed.AddLambda([this, DefaultValue, TestDone](ETbSame1Enum1 InProp1)
			{
			ETbSame1Enum1 TestValue = ETbSame1Enum1::TS1E1_Value1;
			// use different test value
			TestValue = ETbSame1Enum1::TS1E1_Value2;
...
#if PLATFORM_ANDROID && USE_ANDROID_JNI
		UTbSame1SameEnum1InterfacePublisher* TbSame1SameEnum1InterfacePublisher = ImplFixture->GetClient()->_GetPublisher();
		TbSame1SameEnum1InterfacePublisher->OnProp1Changed.AddLambda([this, TestDone, count = 0](ETbSame1Enum1 InProp1) mutable
#else
		UTbSame1SameEnum1InterfacePublisher* TbSame1SameEnum1InterfacePublisher = ImplFixture->GetLocalImplementation()->_GetPublisher();
		TbSame1SameEnum1InterfacePublisher->OnProp1Changed.AddLambda([this, TestDone, StartValue, count = 0](ETbSame1Enum1 InProp1) mutable
#endif
			{
	...
	LatentIt("Signal.Sig1", EAsyncExecution::ThreadPool, [this](const FDoneDelegate TestDone)
		{
		UTbSame1SameEnum1InterfacePublisher* SourceTbSame1SameEnum1InterfacePublisher = ImplFixture->GetLocalImplementation()->_GetPublisher();
#if PLATFORM_ANDROID && USE_ANDROID_JNI
		UTbSame1SameEnum1InterfacePublisher* TbSame1SameEnum1InterfacePublisher = ImplFixture->GetClient()->_GetPublisher();
#else
		UTbSame1SameEnum1InterfacePublisher* TbSame1SameEnum1InterfacePublisher = ImplFixture->GetLocalImplementation()->_GetPublisher();
		...
		// use different test value
		ETbSame1Enum1 Param1TestValue = ETbSame1Enum1::TS1E1_Value2;
		SourceTbSame1SameEnum1InterfacePublisher->BroadcastSig1Signal(Param1TestValue);
	});
}
} // namespace Tests
} // namespace Jni
