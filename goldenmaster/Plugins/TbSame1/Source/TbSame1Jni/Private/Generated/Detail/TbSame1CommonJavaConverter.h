...
DECLARE_LOG_CATEGORY_EXTERN(LogTbSame1CommonJavaConverter_JNI, Log, All);

class FTbSame1CommonJavaConverter
{
public:
...
private:
	...
	FTbSame1CommonJavaConverter() = delete;
};

template<>
struct FTbSame1CommonJavaConverter::JniArrayTraits<bool>
{
...
template<>
struct FTbSame1CommonJavaConverter::JniArrayTraits<int32>
{
...
template<>
struct FTbSame1CommonJavaConverter::JniArrayTraits<int64>
{
...
template<>
struct FTbSame1CommonJavaConverter::JniArrayTraits<float>
{
...
template<>
struct FTbSame1CommonJavaConverter::JniArrayTraits<double>
{
...
FTbSame1CommonJavaConverter::TryFillArray(
    JNIEnv* Env, TArray<PrimitiveType>& OutPrimitiveArray, jarray InJniArray, const FString& InPropertyName)
{
	...
	{
		UE_LOG(LogTbSame1CommonJavaConverter_JNI, Warning, TEXT("%s is null"), *InPropertyName);
		return false;
	}
