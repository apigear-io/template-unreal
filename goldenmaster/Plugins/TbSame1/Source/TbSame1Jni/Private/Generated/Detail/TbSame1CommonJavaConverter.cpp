...
DEFINE_LOG_CATEGORY(LogTbSame1CommonJavaConverter_JNI);

bool FTbSame1CommonJavaConverter::CheckJniErrorOccurred(const TCHAR* Msg)
{
	...
	if (env->ExceptionCheck())
	{
		...
		env->ExceptionClear();
		UE_LOG(LogTbSame1CommonJavaConverter_JNI, Error, TEXT("%s"), Msg);
		return true;
	}
	return false;
}

bool FTbSame1CommonJavaConverter::TryFillArray(
