...
void UTbSame1SameEnum1InterfaceJniAdapter::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	if (!UTbSame1SameEnum1InterfaceJniAdapterCache::Get())
	{
		UE_LOG(LogTbSame1SameEnum1Interface_JNI, Error, TEXT("Failed to initialize UTbSame1SameEnum1InterfaceJniAdapterCache. Bailing..."));
		return;
	}
