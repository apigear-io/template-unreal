...
void UTbSame1SameStruct2InterfaceJniClient::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	if (TbSame1JniCache::clientClassSameStruct2InterfaceCtor == nullptr)
	{
	...
	jobject localRef = Env->NewObject(TbSame1JniCache::clientClassSameStruct2Interface, TbSame1JniCache::clientClassSameStruct2InterfaceCtor);
...
void UTbSame1SameStruct2InterfaceJniClient::SetProp1(const FTbSame1Struct2& InProp1)
{
	...
	{
		if (TbSame1JniCache::javaClassSameStruct2Interface == nullptr)
		{
		...
		jmethodID MethodID = TbSame1JniCache::javaClassSameStruct2InterfaceProp1SetterId;
		if (MethodID == nullptr)
		{
...
void UTbSame1SameStruct2InterfaceJniClient::SetProp2(const FTbSame1Struct2& InProp2)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = TbSame1JniCache::javaClassSameStruct2InterfaceProp2SetterId;
		if (MethodID == nullptr)
		{
...
FTbSame1Struct1 UTbSame1SameStruct2InterfaceJniClient::Func1(const FTbSame1Struct1& InParam1)
{
...
#if PLATFORM_ANDROID && USE_ANDROID_JNI
	if (TbSame1JniCache::clientClassSameStruct2Interface == nullptr)
	{
	...
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
	jmethodID MethodID = TbSame1JniCache::clientClassSameStruct2InterfaceFunc1AsyncMethodID;
	if (MethodID != nullptr)
	{
...
FTbSame1Struct1 UTbSame1SameStruct2InterfaceJniClient::Func2(const FTbSame1Struct1& InParam1, const FTbSame1Struct2& InParam2)
{
	...
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
	jmethodID MethodID = TbSame1JniCache::clientClassSameStruct2InterfaceFunc2AsyncMethodID;
	if (MethodID != nullptr)
	{
		auto id = gUTbSame1SameStruct2InterfaceJniClientmethodHelper.StorePromise(Promise);
		auto idString = FJavaHelper::ToJavaString(Env, id.ToString(EGuidFormats::Digits));
...
bool UTbSame1SameStruct2InterfaceJniClient::_bindToService(FString servicePackage, FString connectionId)
{
	...
	jmethodID MethodID = TbSame1JniCache::clientClassSameStruct2InterfaceBindMethodID;
	if (MethodID != nullptr)
	{
...
void UTbSame1SameStruct2InterfaceJniClient::_unbind()
{
	...
	jmethodID MethodID = TbSame1JniCache::clientClassSameStruct2InterfaceUnbindMethodID;
	if (MethodID != nullptr)
	{
