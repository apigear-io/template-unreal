...
void UTbSame1SameStruct2InterfaceJniClientCache::init()
{
	...
	if (NewData->clientClassSameStruct2Interface == nullptr || TbSame1DataJavaConverter::CheckJniErrorOccurred(errorMsgCls))
	{
		return;
	}
	...
	if (NewData->Prop2SetterId == nullptr || TbSame1DataJavaConverter::CheckJniErrorOccurred(errorMsgProp2Setter))
	{
		return;
	}
	...
	if (NewData->Func2AsyncMethodID == nullptr || TbSame1DataJavaConverter::CheckJniErrorOccurred(errorMsgFunc2AsyncMethod))
	{
		return;
	}
	...
	if (NewData->clientClassSameStruct2InterfaceCtor == nullptr || TbSame1DataJavaConverter::CheckJniErrorOccurred(errorMsgInit))
	{
		return;
	}
...
void UTbSame1SameStruct2InterfaceJniClient::Deinitialize()
{
	...
	gUTbSame1SameStruct2InterfaceJniClientmethodHelper.FlushPendingPromises();
...
void UTbSame1SameStruct2InterfaceJniClient::OnSig1Signal(const FTbSame1Struct1& InParam1)
{
	...
	TWeakObjectPtr<UTbSame1SameStruct2InterfaceJniClient> weakSelf(this);
	AsyncTask(
		ENamedThreads::GameThread,
		[updateAndBroadcastValueChanged = MoveTemp(updateAndBroadcastValueChanged), weakSelf]
		{
		UTbSame1SameStruct2InterfaceJniClient* self = weakSelf.Get();
		if (self != nullptr)
		{
...
#if PLATFORM_ANDROID && USE_ANDROID_JNI
bool UTbSame1SameStruct2InterfaceJniClient::tryCallAsyncJavaFunc1(FGuid Guid, jmethodID MethodID, const FTbSame1Struct1& InParam1)
{
	UE_LOG(LogTbSame1SameStruct2InterfaceClient_JNI, Verbose, TEXT("call async tbSame1/tbSame1jniclient/SameStruct2InterfaceJniClient:func1"));
...
bool UTbSame1SameStruct2InterfaceJniClient::tryCallAsyncJavaFunc2(FGuid Guid, jmethodID MethodID, const FTbSame1Struct1& InParam1, const FTbSame1Struct2& InParam2)
{
	UE_LOG(LogTbSame1SameStruct2InterfaceClient_JNI, Verbose, TEXT("call async tbSame1/tbSame1jniclient/SameStruct2InterfaceJniClient:func2"));
...
void UTbSame1SameStruct2InterfaceJniClient::notifyIsReady(bool bInIsReady)
{
	b_isReady.store(bInIsReady, std::memory_order_release);

	auto broadcastConnectionStatusChanged = [](UTbSame1SameStruct2InterfaceJniClient& self)
	{
...
JNI_METHOD void Java_tbSame1_tbSame1jniclient_SameStruct2InterfaceJniClient_nativeAsyncOperationFailed(JNIEnv* Env, jclass Clazz, jstring callId, jstring errorMessage, jint errorCode)
{
	FString callIdString = FJavaHelper::FStringFromParam(Env, callId);
	static const TCHAR* errorMsgId = TEXT("failed to convert call id string in nativeAsyncOperationFailed for tbSame1/tbSame1jniclient/SameStruct2InterfaceJniClient");
	if (TbSame1DataJavaConverter::CheckJniErrorOccurred(errorMsgId))
	{
		return;
	}
	...
	UE_LOG(LogTbSame1SameStruct2InterfaceClient_JNI, Warning,
		TEXT("Async operation failed for id %s: %s (code: %d)"),
		*callIdString, *errorMsgString, static_cast<int32>(errorCode));

	FGuid guid;
	FGuid::Parse(callIdString, guid);
	gUTbSame1SameStruct2InterfaceJniClientmethodHelper.FulfillPromiseWithDefaultValue(guid);
}
#endif
