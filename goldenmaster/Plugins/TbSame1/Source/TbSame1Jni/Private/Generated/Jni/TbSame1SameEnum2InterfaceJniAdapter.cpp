...
void UTbSame1SameEnum2InterfaceJniAdapterCache::init()
{
	...
	if (NewData->Prop2ChangedMethodID == nullptr || TbSame1DataJavaConverter::CheckJniErrorOccurred(errorMsgProp2Changed))
	{
		return;
	}
	...
	if (NewData->Sig2SignalMethodID == nullptr || TbSame1DataJavaConverter::CheckJniErrorOccurred(errorMsgSig2Signal))
	{
		return;
	}
