...
void UTbSame1SameEnum2InterfaceJniAdapter::callJniServiceReady(bool isServiceReady)
{
	...
	{
		if (!TbSame1JniCache::javaClassSameEnum2Interface || !m_javaJniServiceInstance || !TbSame1JniCache::serviceClassSameEnum2InterfaceReadyMethodID)
		{
		...
		FJavaWrapper::CallVoidMethod(Env, m_javaJniServiceInstance, TbSame1JniCache::serviceClassSameEnum2InterfaceReadyMethodID, isServiceReady);
...
void UTbSame1SameEnum2InterfaceJniAdapter::OnSig1Signal(ETbSame1Enum1 Param1)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (TbSame1JniCache::serviceClassSameEnum2Interface == nullptr || m_javaJniServiceInstance == nullptr)
		{
		...
		jmethodID MethodID = TbSame1JniCache::serviceClassSameEnum2InterfaceSig1SignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTbSame1SameEnum2InterfaceJniAdapter::OnSig2Signal(ETbSame1Enum1 Param1, ETbSame1Enum2 Param2)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = TbSame1JniCache::serviceClassSameEnum2InterfaceSig2SignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTbSame1SameEnum2InterfaceJniAdapter::OnProp1Changed(ETbSame1Enum1 Prop1)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (TbSame1JniCache::serviceClassSameEnum2Interface == nullptr)
		{
		...
		jmethodID MethodID = TbSame1JniCache::serviceClassSameEnum2InterfaceProp1ChangedMethodID;
		if (MethodID == nullptr)
		{
...
void UTbSame1SameEnum2InterfaceJniAdapter::OnProp2Changed(ETbSame1Enum2 Prop2)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = TbSame1JniCache::serviceClassSameEnum2InterfaceProp2ChangedMethodID;
		if (MethodID == nullptr)
		{
