...
namespace
{
std::atomic<ITbSame1SameStruct2InterfaceJniAdapterAccessor*> gUTbSame1SameStruct2InterfaceJniAdapterHandle{nullptr};
}

#if PLATFORM_ANDROID && USE_ANDROID_JNI

struct FUTbSame1SameStruct2InterfaceJniAdapterCacheData
{
	...
	~FUTbSame1SameStruct2InterfaceJniAdapterCacheData()
	{
		if (javaService)
		{
...
{
public:
	static TSharedPtr<FUTbSame1SameStruct2InterfaceJniAdapterCacheData, ESPMode::ThreadSafe> Get()
	{
...
private:
	...
	static TSharedPtr<FUTbSame1SameStruct2InterfaceJniAdapterCacheData, ESPMode::ThreadSafe> CacheData;
};

FCriticalSection UTbSame1SameStruct2InterfaceJniAdapterCache::CacheLock;
TSharedPtr<FUTbSame1SameStruct2InterfaceJniAdapterCacheData, ESPMode::ThreadSafe> UTbSame1SameStruct2InterfaceJniAdapterCache::CacheData;

void UTbSame1SameStruct2InterfaceJniAdapterCache::init()
{
	auto NewData = MakeShared<FUTbSame1SameStruct2InterfaceJniAdapterCacheData, ESPMode::ThreadSafe>();
	JNIEnv* env = FAndroidApplication::GetJavaEnv();
...
void UTbSame1SameStruct2InterfaceJniAdapter::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	gUTbSame1SameStruct2InterfaceJniAdapterHandle.store(this, std::memory_order_release);
#if PLATFORM_ANDROID
#if USE_ANDROID_JNI
...
void UTbSame1SameStruct2InterfaceJniAdapter::Deinitialize()
{
	...
	gUTbSame1SameStruct2InterfaceJniAdapterHandle.store(nullptr, std::memory_order_release);
#if PLATFORM_ANDROID
#if USE_ANDROID_JNI
...
TScriptInterface<ITbSame1SameStruct2InterfaceInterface> UTbSame1SameStruct2InterfaceJniAdapter::getBackendServiceForJNI() const
{
	FScopeLock Lock(&BackendServiceCS);
	return BackendService;
}

void UTbSame1SameStruct2InterfaceJniAdapter::jniServiceStatusChanged(bool isConnected)
{
	TWeakObjectPtr<UTbSame1SameStruct2InterfaceJniAdapter> WeakThis(this);
	if (isConnected)
	{
		AsyncTask(ENamedThreads::GameThread, [WeakThis]()
			...
			{
				UE_LOG(LogTbSame1SameStruct2Interface_JNI, Verbose, TEXT("Attempted to notify service started on JniAdapter which is already dead. Aborting..."));
				return;
			}
	...
	else
	{
		AsyncTask(ENamedThreads::GameThread, [WeakThis]()
			...
			if (WeakThis.Get() == nullptr)
			{
				UE_LOG(LogTbSame1SameStruct2Interface_JNI, Verbose, TEXT("Attempted to notify service died on JniAdapter which is already dead. Aborting..."));
				return;
			}
...
JNI_METHOD jobject Java_tbSame1_tbSame1jniservice_SameStruct2InterfaceJniService_nativeFunc1(JNIEnv* Env, jclass Clazz, jobject param1)
{
	...
	auto jniAccessor = gUTbSame1SameStruct2InterfaceJniAdapterHandle.load();
	if (!jniAccessor)
	{
		UE_LOG(LogTbSame1SameStruct2Interface_JNI, Warning, TEXT("Java_tbSame1_tbSame1jniservice_SameStruct2InterfaceJniService_nativeFunc1, UTbSame1SameStruct2InterfaceJniAdapter not valid to use, probably too early or too late."));
		return nullptr;
	}
	...
	if (service != nullptr)
	{
		auto optResult = FTbSame1ThreadingHelper::EvalInGameThread(
			[&]() -> TOptional<FTbSame1Struct1>
			{
			auto jniAccessor = gUTbSame1SameStruct2InterfaceJniAdapterHandle.load();
			if (!jniAccessor)
			{
				UE_LOG(LogTbSame1SameStruct2Interface_JNI, Warning, TEXT("Java_tbSame1_tbSame1jniservice_SameStruct2InterfaceJniService_nativeFunc1 (in GameThread), UTbSame1SameStruct2InterfaceJniAdapter not valid to use, probably too early or too late."));
				return TOptional<FTbSame1Struct1>();
			}
		...
		if (!optResult.IsSet())
		{
			UE_LOG(LogTbSame1SameStruct2Interface_JNI, Warning, TEXT("Java_tbSame1_tbSame1jniservice_SameStruct2InterfaceJniService_nativeFunc1, couldn't get result."));
			return nullptr;
		}
...
JNI_METHOD jobject Java_tbSame1_tbSame1jniservice_SameStruct2InterfaceJniService_nativeFunc2(JNIEnv* Env, jclass Clazz, jobject param1, jobject param2)
{
	...
	if (!jniAccessor)
	{
		UE_LOG(LogTbSame1SameStruct2Interface_JNI, Warning, TEXT("Java_tbSame1_tbSame1jniservice_SameStruct2InterfaceJniService_nativeFunc2, UTbSame1SameStruct2InterfaceJniAdapter not valid to use, probably too early or too late."));
		return nullptr;
	}
	...
	if (service != nullptr)
	{
		auto optResult = FTbSame1ThreadingHelper::EvalInGameThread(
			...
			if (!jniAccessor)
			{
				UE_LOG(LogTbSame1SameStruct2Interface_JNI, Warning, TEXT("Java_tbSame1_tbSame1jniservice_SameStruct2InterfaceJniService_nativeFunc2 (in GameThread), UTbSame1SameStruct2InterfaceJniAdapter not valid to use, probably too early or too late."));
				return TOptional<FTbSame1Struct1>();
			}
		...
		if (!optResult.IsSet())
		{
			UE_LOG(LogTbSame1SameStruct2Interface_JNI, Warning, TEXT("Java_tbSame1_tbSame1jniservice_SameStruct2InterfaceJniService_nativeFunc2, couldn't get result."));
			return nullptr;
		}
		auto result = optResult.GetValue();
		jobject jresult = TbSame1DataJavaConverter::makeJavaStruct1(Env, result);
...
JNI_METHOD void Java_tbSame1_tbSame1jniservice_SameStruct2InterfaceJniService_nativeSetProp1(JNIEnv* Env, jclass Clazz, jobject prop1)
{
	...
	if (!jniAccessor)
	{
		UE_LOG(LogTbSame1SameStruct2Interface_JNI, Warning, TEXT("Java_tbSame1_tbSame1jniservice_SameStruct2InterfaceJniService_nativeSetProp1, UTbSame1SameStruct2InterfaceJniAdapter not valid to use, probably too early or too late."));
		return;
	}
...
JNI_METHOD jobject Java_tbSame1_tbSame1jniservice_SameStruct2InterfaceJniService_nativeGetProp1(JNIEnv* Env, jclass Clazz)
{
	...
	if (!jniAccessor)
	{
		UE_LOG(LogTbSame1SameStruct2Interface_JNI, Warning, TEXT("Java_tbSame1_tbSame1jniservice_SameStruct2InterfaceJniService_nativeGetProp1, UTbSame1SameStruct2InterfaceJniAdapter not valid to use, probably too early or too late."));
		return nullptr;
	}
...
JNI_METHOD void Java_tbSame1_tbSame1jniservice_SameStruct2InterfaceJniService_nativeSetProp2(JNIEnv* Env, jclass Clazz, jobject prop2)
{
	...
	if (!jniAccessor)
	{
		UE_LOG(LogTbSame1SameStruct2Interface_JNI, Warning, TEXT("Java_tbSame1_tbSame1jniservice_SameStruct2InterfaceJniService_nativeSetProp2, UTbSame1SameStruct2InterfaceJniAdapter not valid to use, probably too early or too late."));
		return;
	}
...
JNI_METHOD jobject Java_tbSame1_tbSame1jniservice_SameStruct2InterfaceJniService_nativeGetProp2(JNIEnv* Env, jclass Clazz)
{
	...
	if (!jniAccessor)
	{
		UE_LOG(LogTbSame1SameStruct2Interface_JNI, Warning, TEXT("Java_tbSame1_tbSame1jniservice_SameStruct2InterfaceJniService_nativeGetProp2, UTbSame1SameStruct2InterfaceJniAdapter not valid to use, probably too early or too late."));
		return nullptr;
	}
...
JNI_METHOD void Java_tbSame1_tbSame1jniservice_SameStruct2InterfaceJniServiceStarter_nativeOnAndroidServiceConnectionStatusChanged(JNIEnv* Env, jclass Clazz, jboolean value)
{
	auto jniAccessor = gUTbSame1SameStruct2InterfaceJniAdapterHandle.load();
	if (!jniAccessor)
	{
		UE_LOG(LogTbSame1SameStruct2Interface_JNI, Warning, TEXT("Java_tbSame1_tbSame1jniservice_SameStruct2InterfaceJniServiceStarter_nativeOnAndroidServiceConnectionStatusChanged, UTbSame1SameStruct2InterfaceJniAdapter not valid to use, probably too early or too late."));
		return;
	}
