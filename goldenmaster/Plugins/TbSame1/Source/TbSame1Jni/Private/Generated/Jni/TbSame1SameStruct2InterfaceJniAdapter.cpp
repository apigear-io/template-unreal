...
void UTbSame1SameStruct2InterfaceJniAdapter::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	TbSame1DataJavaConverter::checkJniError(errorMsgCls);
	...
	TbSame1DataJavaConverter::checkJniError(errorMsgMethodId);
	...
	TbSame1DataJavaConverter::checkJniError(errorMsgCall);
...
void UTbSame1SameStruct2InterfaceJniAdapter::callJniServiceReady(bool isServiceReady)
{
	...
	{
		if (!TbSame1JniCache::javaClassSameStruct2Interface || !m_javaJniServiceInstance || !TbSame1JniCache::serviceClassSameStruct2InterfaceReadyMethodID)
		{
		...
		FJavaWrapper::CallVoidMethod(Env, m_javaJniServiceInstance, TbSame1JniCache::serviceClassSameStruct2InterfaceReadyMethodID, isServiceReady);
...
void UTbSame1SameStruct2InterfaceJniAdapter::OnSig1Signal(const FTbSame1Struct1& Param1)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (TbSame1JniCache::serviceClassSameStruct2Interface == nullptr || m_javaJniServiceInstance == nullptr)
		{
		...
		jmethodID MethodID = TbSame1JniCache::serviceClassSameStruct2InterfaceSig1SignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTbSame1SameStruct2InterfaceJniAdapter::OnSig2Signal(const FTbSame1Struct1& Param1, const FTbSame1Struct2& Param2)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = TbSame1JniCache::serviceClassSameStruct2InterfaceSig2SignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTbSame1SameStruct2InterfaceJniAdapter::OnProp1Changed(const FTbSame1Struct2& Prop1)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (TbSame1JniCache::serviceClassSameStruct2Interface == nullptr)
		{
		...
		jmethodID MethodID = TbSame1JniCache::serviceClassSameStruct2InterfaceProp1ChangedMethodID;
		if (MethodID == nullptr)
		{
...
void UTbSame1SameStruct2InterfaceJniAdapter::OnProp2Changed(const FTbSame1Struct2& Prop2)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = TbSame1JniCache::serviceClassSameStruct2InterfaceProp2ChangedMethodID;
		if (MethodID == nullptr)
		{
