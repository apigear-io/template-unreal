...
TSharedPtr<FTbSame1DataJavaConverterCacheData, ESPMode::ThreadSafe> TbSame1DataJavaConverter::ensureInitialized()
{
	...
	if (checkJniErrorOccured(errorMsgSameStruct1Interface))
	{
		UE_LOG(LogTbSame1DataJavaConverter_JNI, Warning, TEXT("TbSame1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgSameStruct2Interface))
	{
		UE_LOG(LogTbSame1DataJavaConverter_JNI, Warning, TEXT("TbSame1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgSameEnum1Interface))
	{
		UE_LOG(LogTbSame1DataJavaConverter_JNI, Warning, TEXT("TbSame1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgSameEnum2Interface))
	{
		UE_LOG(LogTbSame1DataJavaConverter_JNI, Warning, TEXT("TbSame1DataJavaConverter initialization failed"));
		return nullptr;
	}
