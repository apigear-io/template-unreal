...
#include "TbSame1SameStruct1InterfaceJniClient.generated.h"
...
class TBSAME1JNI_API UTbSame1SameStruct1InterfaceJniClient : public UAbstractTbSame1SameStruct1Interface
{
	GENERATED_BODY()
public:
	explicit UTbSame1SameStruct1InterfaceJniClient();

	UTbSame1SameStruct1InterfaceJniClient(FVTableHelper& Helper);
	virtual ~UTbSame1SameStruct1InterfaceJniClient();
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "ApiGear|TbSame1|SameStruct1Interface|JNI")
	bool _IsReady() const;

	/**
	* @param package. This client will connect only to a SameStruct1Interface Service, that myb be exposed by the application that runs it.
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "ApiGear|TbSame1|SameStruct1Interface|JNI|Connection")
