...
#include "TbSame1SameEnum1InterfaceJniClient.generated.h"

DECLARE_LOG_CATEGORY_EXTERN(LogTbSame1SameEnum1InterfaceClient_JNI, Log, All);

// A helper class that exposes part of UTbSame1SameEnum1InterfaceJniClient to use for native JNI calls.
...
class TBSAME1JNI_API IUTbSame1SameEnum1InterfaceJniClientJniAccessor
{
public:
...
class TBSAME1JNI_API UTbSame1SameEnum1InterfaceJniClient : public UAbstractTbSame1SameEnum1Interface, public IUTbSame1SameEnum1InterfaceJniClientJniAccessor
{
	GENERATED_BODY()
public:
	explicit UTbSame1SameEnum1InterfaceJniClient();

	UTbSame1SameEnum1InterfaceJniClient(FVTableHelper& Helper);
	virtual ~UTbSame1SameEnum1InterfaceJniClient();
	...
	UPROPERTY(BlueprintAssignable, Category = "ApiGear|TbSame1|SameEnum1Interface|Jni|Remote", DisplayName = "Connection Status Changed")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "ApiGear|TbSame1|SameEnum1Interface|JNI")
	bool _IsReady() const;

	/** @param package. This client will connect only to a SameEnum1Interface Service,
	...
	*/
	UFUNCTION(BlueprintCallable, Category = "ApiGear|TbSame1|SameEnum1Interface|JNI|Connection")
