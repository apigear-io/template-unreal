...
namespace Tests
{
FTbSame1SameEnum1InterfaceMQTTFixture::FTbSame1SameEnum1InterfaceMQTTFixture()
{
	testImplementation = GetGameInstance()->GetSubsystem<UTbSame1SameEnum1InterfaceMQTTClient>();
	...
	auto service = GetGameInstance()->GetSubsystem<UTbSame1SameEnum1InterfaceImplementation>();
...
TScriptInterface<ITbSame1SameEnum1InterfaceInterface> FTbSame1SameEnum1InterfaceMQTTFixture::GetImplementation()
{
	return testImplementation;
}

UApiGearMQTTHost* FTbSame1SameEnum1InterfaceMQTTFixture::GetHost()
{
	return Host.Get();
}

UTbSame1SameEnum1InterfaceMQTTAdapter* FTbSame1SameEnum1InterfaceMQTTFixture::GetAdapter()
{
	return GetGameInstance()->GetSubsystem<UTbSame1SameEnum1InterfaceMQTTAdapter>();
}

UGameInstance* FTbSame1SameEnum1InterfaceMQTTFixture::GetGameInstance()
{
...
void FTbSame1SameEnum1InterfaceMQTTFixture::CleanUp()
{
	if (Host.IsValid())
	{
		Host->Stop();
