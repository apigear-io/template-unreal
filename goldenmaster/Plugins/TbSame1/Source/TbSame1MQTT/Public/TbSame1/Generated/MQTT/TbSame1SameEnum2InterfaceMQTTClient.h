...
#include "Misc/Guid.h"
#include "TbSame1SameEnum2InterfaceMQTTClient.generated.h"

class TbSame1SameEnum2InterfacePropertiesData;
DECLARE_LOG_CATEGORY_EXTERN(LogTbSame1SameEnum2InterfaceMQTTClient, Log, All);

UCLASS(NotBlueprintable, BlueprintType)
class TBSAME1MQTT_API UTbSame1SameEnum2InterfaceMQTTClient : public UAbstractTbSame1SameEnum2Interface
{
	GENERATED_BODY()
public:
	explicit UTbSame1SameEnum2InterfaceMQTTClient();

	// only needed in 4.25 to use TUniquePtr<TbSame1SameEnum2InterfacePropertiesData>
	UTbSame1SameEnum2InterfaceMQTTClient(FVTableHelper& Helper);
	virtual ~UTbSame1SameEnum2InterfaceMQTTClient();
...
private:
	...
	/// @param InMsg contains the param of the type ETbSame1Enum2
	...
	/// @param InMsg contains the param(s) of the type(s) ETbSame1Enum1 Param1, ETbSame1Enum2 Param2
