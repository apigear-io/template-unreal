...
#include "Misc/Guid.h"
#include "TbSame1SameStruct2InterfaceMQTTClient.generated.h"

class TbSame1SameStruct2InterfacePropertiesData;
DECLARE_LOG_CATEGORY_EXTERN(LogTbSame1SameStruct2InterfaceMQTTClient, Log, All);

UCLASS(NotBlueprintable, BlueprintType)
class TBSAME1MQTT_API UTbSame1SameStruct2InterfaceMQTTClient : public UAbstractTbSame1SameStruct2Interface
{
	GENERATED_BODY()
public:
	explicit UTbSame1SameStruct2InterfaceMQTTClient();

	// only needed in 4.25 to use TUniquePtr<TbSame1SameStruct2InterfacePropertiesData>
	UTbSame1SameStruct2InterfaceMQTTClient(FVTableHelper& Helper);
	virtual ~UTbSame1SameStruct2InterfaceMQTTClient();
...
private:
	...
	/// @param InMsg contains the param of the type FTbSame1Struct2
	...
	/// @param InMsg contains the param(s) of the type(s) const FTbSame1Struct1& Param1, const FTbSame1Struct2& Param2
