...
/**
 * Subscriber interface for TbSame1SameStruct2Interface events. Intended for Blueprint-only use.
 * Does contain signal events and property-changed events.
 * @note Guaranteed to be run from within the GameThread.
 */
UINTERFACE(BlueprintType)
class UTbSame1SameStruct2InterfaceBPSubscriberInterface : public UInterface
{
	GENERATED_BODY()
};

class TBSAME1API_API ITbSame1SameStruct2InterfaceBPSubscriberInterface
{
	GENERATED_BODY()

public:
	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "ApiGear|TbSame1|SameStruct2Interface|Signals", DisplayName = "On Sig1 Signal")
	void OnSig1Signal(const FTbSame1Struct1& Param1);

	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "ApiGear|TbSame1|SameStruct2Interface|Signals", DisplayName = "On Sig2 Signal")
	void OnSig2Signal(const FTbSame1Struct1& Param1, const FTbSame1Struct2& Param2);

	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "ApiGear|TbSame1|SameStruct2Interface|Signals", DisplayName = "On Property Prop1 Changed")
	void OnProp1Changed(UPARAM(DisplayName = "Prop1") const FTbSame1Struct2& InProp1);

	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "ApiGear|TbSame1|SameStruct2Interface|Signals", DisplayName = "On Property Prop2 Changed")
	void OnProp2Changed(UPARAM(DisplayName = "Prop2") const FTbSame1Struct2& InProp2);
};

/**
 * Subscriber interface for TbSame1SameStruct2Interface events. Intended for C++ use.
 * Does contain signal events and property-changed events.
 * @note Not guaranteed to be run from within the GameThread - can be on any thread.
 */
UINTERFACE(BlueprintType, MinimalAPI, meta = (CannotImplementInterfaceInBlueprint))
class UTbSame1SameStruct2InterfaceSubscriberInterface : public UInterface
{
	GENERATED_BODY()
};

class TBSAME1API_API ITbSame1SameStruct2InterfaceSubscriberInterface
{
	GENERATED_BODY()
public:
	...
	virtual void OnProp1Changed(UPARAM(DisplayName = "Prop1") const FTbSame1Struct2& InProp1) = 0;

	virtual void OnProp2Changed(UPARAM(DisplayName = "Prop2") const FTbSame1Struct2& InProp2) = 0;
};

/**
 * Class UTbSame1SameStruct2InterfaceInterfacePublisher
 * Contains delegates for properties and signals
 * this is needed since we cannot declare delegates on an UInterface
 */
UCLASS(BlueprintType)
class TBSAME1API_API UTbSame1SameStruct2InterfacePublisher : public UObject
{
	GENERATED_BODY()
...
public:
	...
	void Subscribe(const TWeakInterfacePtr<ITbSame1SameStruct2InterfaceSubscriberInterface>& Subscriber);
	UFUNCTION(BlueprintCallable, Category = "ApiGear|TbSame1|SameStruct2Interface|Signals")
	void Unsubscribe(const TScriptInterface<ITbSame1SameStruct2InterfaceBPSubscriberInterface>& Subscriber);
	void Unsubscribe(const TWeakInterfacePtr<ITbSame1SameStruct2InterfaceSubscriberInterface>& Subscriber);

private:
	void CleanUpSubscribers();

	TArray<TScriptInterface<ITbSame1SameStruct2InterfaceBPSubscriberInterface>> BPSubscribers;
	FRWLock BPSubscribersLock;
	TArray<TWeakInterfacePtr<ITbSame1SameStruct2InterfaceSubscriberInterface>> Subscribers;
 ...
 */
class TBSAME1API_API ITbSame1SameStruct2InterfaceInterface
{
	GENERATED_BODY()
...
public:
	...
	virtual UTbSame1SameStruct2InterfacePublisher* _GetPublisher() = 0;
