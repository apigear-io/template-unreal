...
static void from_json(const nlohmann::json& j, FTbSame1Struct1& p)
{
	...
	{
		UE_LOG(LogTbSame1, Verbose, TEXT("from_json: struct field 'field1' missing or type mismatch in FTbSame1Struct1 -> using default value"));
	}
	...
	{
		UE_LOG(LogTbSame1, Verbose, TEXT("from_json: struct field 'field2' missing or type mismatch in FTbSame1Struct1 -> using default value"));
	}
	...
	{
		UE_LOG(LogTbSame1, Verbose, TEXT("from_json: struct field 'field3' missing or type mismatch in FTbSame1Struct1 -> using default value"));
	}
}
...
static void from_json(const nlohmann::json& j, FTbSame1Struct2& p)
{
	...
	{
		UE_LOG(LogTbSame1, Verbose, TEXT("from_json: struct field 'field1' missing or type mismatch in FTbSame1Struct2 -> using default value"));
	}
	...
	{
		UE_LOG(LogTbSame1, Verbose, TEXT("from_json: struct field 'field2' missing or type mismatch in FTbSame1Struct2 -> using default value"));
	}
	...
	{
		UE_LOG(LogTbSame1, Verbose, TEXT("from_json: struct field 'field3' missing or type mismatch in FTbSame1Struct2 -> using default value"));
	}
}
...
static void from_json(const nlohmann::json& j, TScriptInterface<ITbSame1SameStruct1InterfaceInterface>& p)
{
	...
	{
		UE_LOG(LogTbSame1, Verbose, TEXT("from_json: interface property 'prop1' missing or type mismatch in ITbSame1SameStruct1InterfaceInterface -> ignore"));
	}
}
...
static void from_json(const nlohmann::json& j, TScriptInterface<ITbSame1SameStruct2InterfaceInterface>& p)
{
	...
	{
		UE_LOG(LogTbSame1, Verbose, TEXT("from_json: interface property 'prop1' missing or type mismatch in ITbSame1SameStruct2InterfaceInterface -> ignore"));
	}
	...
	{
		UE_LOG(LogTbSame1, Verbose, TEXT("from_json: interface property 'prop2' missing or type mismatch in ITbSame1SameStruct2InterfaceInterface -> ignore"));
	}
}
...
static void from_json(const nlohmann::json& j, TScriptInterface<ITbSame1SameEnum1InterfaceInterface>& p)
{
	...
	{
		UE_LOG(LogTbSame1, Verbose, TEXT("from_json: interface property 'prop1' missing or type mismatch in ITbSame1SameEnum1InterfaceInterface -> ignore"));
	}
}
...
static void from_json(const nlohmann::json& j, TScriptInterface<ITbSame1SameEnum2InterfaceInterface>& p)
{
	...
	{
		UE_LOG(LogTbSame1, Verbose, TEXT("from_json: interface property 'prop1' missing or type mismatch in ITbSame1SameEnum2InterfaceInterface -> ignore"));
	}
	...
	{
		UE_LOG(LogTbSame1, Verbose, TEXT("from_json: interface property 'prop2' missing or type mismatch in ITbSame1SameEnum2InterfaceInterface -> ignore"));
	}
}
