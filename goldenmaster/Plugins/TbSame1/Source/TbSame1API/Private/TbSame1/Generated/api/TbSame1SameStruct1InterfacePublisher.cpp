...
void UTbSame1SameStruct1InterfacePublisher::BroadcastSig1Signal(const FTbSame1Struct1& Param1)
{
	...
	auto BroadcastAll = [WeakPtr = TWeakObjectPtr<UTbSame1SameStruct1InterfacePublisher>(this), SubscribersCopy, BPSubscribersCopy, Param1]()
	{
		if (!WeakPtr.IsValid())
		{
			return;
...
void UTbSame1SameStruct1InterfacePublisher::BroadcastProp1Changed(UPARAM(DisplayName = "Prop1") const FTbSame1Struct1& InProp1)
{
	...
	auto BroadcastAll = [WeakPtr = TWeakObjectPtr<UTbSame1SameStruct1InterfacePublisher>(this), SubscribersCopy, BPSubscribersCopy, InProp1]()
	{
		if (!WeakPtr.IsValid())
		{
			return;
