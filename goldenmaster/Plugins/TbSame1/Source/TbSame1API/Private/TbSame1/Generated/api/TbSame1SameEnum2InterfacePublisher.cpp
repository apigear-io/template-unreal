...
void UTbSame1SameEnum2InterfacePublisher::BroadcastSig1Signal(ETbSame1Enum1 Param1)
{
	...
	auto BroadcastAll = [WeakPtr = TWeakObjectPtr<UTbSame1SameEnum2InterfacePublisher>(this), SubscribersCopy, BPSubscribersCopy, Param1]()
	{
		if (!WeakPtr.IsValid())
		{
			return;
...
void UTbSame1SameEnum2InterfacePublisher::BroadcastSig2Signal(ETbSame1Enum1 Param1, ETbSame1Enum2 Param2)
{
	...
	auto BroadcastAll = [WeakPtr = TWeakObjectPtr<UTbSame1SameEnum2InterfacePublisher>(this), SubscribersCopy, BPSubscribersCopy, Param1, Param2]()
	{
		if (!WeakPtr.IsValid())
		{
			return;
...
void UTbSame1SameEnum2InterfacePublisher::BroadcastProp1Changed(UPARAM(DisplayName = "Prop1") ETbSame1Enum1 InProp1)
{
	...
	auto BroadcastAll = [WeakPtr = TWeakObjectPtr<UTbSame1SameEnum2InterfacePublisher>(this), SubscribersCopy, BPSubscribersCopy, InProp1]()
	{
		if (!WeakPtr.IsValid())
		{
			return;
...
void UTbSame1SameEnum2InterfacePublisher::BroadcastProp2Changed(UPARAM(DisplayName = "Prop2") ETbSame1Enum2 InProp2)
{
	...
	auto BroadcastAll = [WeakPtr = TWeakObjectPtr<UTbSame1SameEnum2InterfacePublisher>(this), SubscribersCopy, BPSubscribersCopy, InProp2]()
	{
		if (!WeakPtr.IsValid())
		{
			return;
