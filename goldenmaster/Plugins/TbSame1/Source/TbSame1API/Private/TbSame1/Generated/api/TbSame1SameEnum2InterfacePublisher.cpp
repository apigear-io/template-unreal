...
void UTbSame1SameEnum2InterfacePublisher::BroadcastSig1Signal(ETbSame1Enum1 Param1)
{
	...
	{
		AsyncTask(ENamedThreads::GameThread, [WeakPtr = TWeakObjectPtr<UTbSame1SameEnum2InterfacePublisher>(this), BPSubscribersCopy, Param1]()
			{
			if (WeakPtr.IsValid())
			{
...
void UTbSame1SameEnum2InterfacePublisher::BroadcastSig2Signal(ETbSame1Enum1 Param1, ETbSame1Enum2 Param2)
{
	...
	{
		AsyncTask(ENamedThreads::GameThread, [WeakPtr = TWeakObjectPtr<UTbSame1SameEnum2InterfacePublisher>(this), BPSubscribersCopy, Param1, Param2]()
			{
			if (WeakPtr.IsValid())
			{
...
void UTbSame1SameEnum2InterfacePublisher::BroadcastProp1Changed(UPARAM(DisplayName = "Prop1") ETbSame1Enum1 InProp1)
{
	...
	{
		AsyncTask(ENamedThreads::GameThread, [WeakPtr = TWeakObjectPtr<UTbSame1SameEnum2InterfacePublisher>(this), BPSubscribersCopy, InProp1]()
			{
			if (WeakPtr.IsValid())
			{
...
void UTbSame1SameEnum2InterfacePublisher::BroadcastProp2Changed(UPARAM(DisplayName = "Prop2") ETbSame1Enum2 InProp2)
{
	...
	{
		AsyncTask(ENamedThreads::GameThread, [WeakPtr = TWeakObjectPtr<UTbSame1SameEnum2InterfacePublisher>(this), BPSubscribersCopy, InProp2]()
			{
			if (WeakPtr.IsValid())
			{
