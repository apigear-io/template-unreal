...
void UTbSame1SameStruct1InterfaceMsgBusSpec::Prop1PropertyChangeLocalCheckRemoteCb(const FTbSame1Struct1& InProp1)
{
	FTbSame1Struct1 TestValue = FTbSame1Struct1();
	// use different test value
	TestValue = createTestFTbSame1Struct1();
...
void UTbSame1SameStruct1InterfaceMsgBusSpec::Prop1PropertyChangeLocalChangeRemoteCb(const FTbSame1Struct1& InProp1)
{
