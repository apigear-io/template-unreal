...
void UTbSame1SameEnum2InterfaceMsgBusSpec::Prop1PropertyChangeLocalCheckRemoteCb(ETbSame1Enum1 InProp1)
{
	ETbSame1Enum1 TestValue = ETbSame1Enum1::TS1E1_VALUE1;
	// use different test value
	TestValue = ETbSame1Enum1::TS1E1_VALUE2;
...
void UTbSame1SameEnum2InterfaceMsgBusSpec::Prop1PropertyChangeLocalChangeRemoteCb(ETbSame1Enum1 InProp1)
{
...
void UTbSame1SameEnum2InterfaceMsgBusSpec::Prop2PropertyChangeLocalCheckRemoteCb(ETbSame1Enum2 InProp2)
{
	ETbSame1Enum2 TestValue = ETbSame1Enum2::TS1E2_VALUE1;
	// use different test value
	TestValue = ETbSame1Enum2::TS1E2_VALUE2;
...
void UTbSame1SameEnum2InterfaceMsgBusSpec::Prop2PropertyChangeLocalChangeRemoteCb(ETbSame1Enum2 InProp2)
{
	// this function must be called twice before we can successfully pass this test.
	// first call it should have the test value of the parameter
	// second call it should have the default value of the parameter again
