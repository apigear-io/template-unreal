...
void UTbSame1SameEnum1InterfaceOLinkHelper::Prop1PropertyChangeLocalCheckRemoteCb(ETbSame1Enum1 Prop1)
{
	if (Spec)
	{
...
void UTbSame1SameEnum1InterfaceOLinkHelper::Prop1PropertyChangeLocalChangeRemoteCb(ETbSame1Enum1 Prop1)
{
	if (Spec)
	{
