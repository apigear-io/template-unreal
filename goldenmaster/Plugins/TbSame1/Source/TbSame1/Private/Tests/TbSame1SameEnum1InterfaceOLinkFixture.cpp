...
void UTbSame1SameEnum1InterfaceOLinkHelper::SetParentFixture(TWeakPtr<FTbSame1SameEnum1InterfaceOLinkFixture> InFixture)
{
	ImplFixture = InFixture;
}

void UTbSame1SameEnum1InterfaceOLinkHelper::SetSpec(FAutomationTestBase* InSpec)
{
	Spec = InSpec;
}

void UTbSame1SameEnum1InterfaceOLinkHelper::SetTestDone(const FDoneDelegate& InDone)
{
...
void UTbSame1SameEnum1InterfaceOLinkHelper::Prop1PropertyChangeLocalChangeRemoteCb(ETbSame1Enum1 InProp1)
{
...
{
	Helper = NewObject<UTbSame1SameEnum1InterfaceOLinkHelper>(GetTransientPackage());
	Helper->AddToRoot();
