...
void UTbSame1SameEnum2InterfaceOLinkAdapter::setBackendService(TScriptInterface<ITbSame1SameEnum2InterfaceInterface> InService)
{
	...
	OnProp1ChangedHandle = BackendPublisher->OnProp1Changed.AddUObject(this, &UTbSame1SameEnum2InterfaceOLinkAdapter::OnProp1Changed);
	OnProp2ChangedHandle = BackendPublisher->OnProp2Changed.AddUObject(this, &UTbSame1SameEnum2InterfaceOLinkAdapter::OnProp2Changed);
	OnSig1SignalHandle = BackendPublisher->OnSig1Signal.AddUObject(this, &UTbSame1SameEnum2InterfaceOLinkAdapter::OnSig1);
	OnSig2SignalHandle = BackendPublisher->OnSig2Signal.AddUObject(this, &UTbSame1SameEnum2InterfaceOLinkAdapter::OnSig2);
