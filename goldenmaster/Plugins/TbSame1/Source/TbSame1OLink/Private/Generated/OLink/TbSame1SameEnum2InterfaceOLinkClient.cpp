...
void UTbSame1SameEnum2InterfaceOLinkClient::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	TWeakObjectPtr<UTbSame1SameEnum2InterfaceOLinkClient> weak(this);
...
void UTbSame1SameEnum2InterfaceOLinkClient::UseConnection(TScriptInterface<IApiGearConnection> InConnection)
{
	...
	{
		UE_LOG(LogTbSame1SameEnum2InterfaceOLinkClient, Error, TEXT("The olink connection for the %s client does not implement the connection interface."), UTF8_TO_TCHAR(m_sink->olinkObjectName().c_str()));
		return;
	}
...
TFuture<ETbSame1Enum1> UTbSame1SameEnum2InterfaceOLinkClient::Func1Async(ETbSame1Enum1 Param1)
{
	...
	m_sink->GetNode()->invokeRemote(memberId, {Param1},
		...
		{
			UE_LOG(LogTbSame1SameEnum2InterfaceOLinkClient, Error, TEXT("Func1Async: invalid return value type or null -> returning default"));
			Promise->SetValue(ETbSame1Enum1::TS1E1_Value1);
		}
	});
...
TFuture<ETbSame1Enum1> UTbSame1SameEnum2InterfaceOLinkClient::Func2Async(ETbSame1Enum1 Param1, ETbSame1Enum2 Param2)
{
	...
	m_sink->GetNode()->invokeRemote(memberId, {Param1, Param2},
		...
		{
			UE_LOG(LogTbSame1SameEnum2InterfaceOLinkClient, Error, TEXT("Func2Async: invalid return value type or null -> returning default"));
			Promise->SetValue(ETbSame1Enum1::TS1E1_Value1);
		}
	});
