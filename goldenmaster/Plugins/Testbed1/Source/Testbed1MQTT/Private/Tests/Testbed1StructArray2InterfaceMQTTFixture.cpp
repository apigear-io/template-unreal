...
namespace Tests
{
FTestbed1StructArray2InterfaceMQTTFixture::FTestbed1StructArray2InterfaceMQTTFixture()
{
	testImplementation = GetGameInstance()->GetSubsystem<UTestbed1StructArray2InterfaceMQTTClient>();
	...
	auto service = GetGameInstance()->GetSubsystem<UTestbed1StructArray2InterfaceImplementation>();
...
TScriptInterface<ITestbed1StructArray2InterfaceInterface> FTestbed1StructArray2InterfaceMQTTFixture::GetImplementation()
{
	return testImplementation;
}

UApiGearMQTTHost* FTestbed1StructArray2InterfaceMQTTFixture::GetHost()
{
	return Host.Get();
}

UTestbed1StructArray2InterfaceMQTTAdapter* FTestbed1StructArray2InterfaceMQTTFixture::GetAdapter()
{
	return GetGameInstance()->GetSubsystem<UTestbed1StructArray2InterfaceMQTTAdapter>();
}

UGameInstance* FTestbed1StructArray2InterfaceMQTTFixture::GetGameInstance()
{
...
void FTestbed1StructArray2InterfaceMQTTFixture::CleanUp()
{
	if (Host.IsValid())
	{
		Host->Stop();
