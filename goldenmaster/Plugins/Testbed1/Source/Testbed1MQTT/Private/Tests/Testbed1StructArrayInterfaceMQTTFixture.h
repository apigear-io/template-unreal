...
class UTestbed1StructArrayInterfaceMQTTSpec;
class ITestbed1StructArrayInterfaceInterface;
class UTestbed1StructArrayInterfaceMQTTAdapter;
...
namespace Tests
{
class FTestbed1StructArrayInterfaceMQTTFixture
{
public:
	FTestbed1StructArrayInterfaceMQTTFixture();
	~FTestbed1StructArrayInterfaceMQTTFixture();

	UGameInstance* GetGameInstance();
	TScriptInterface<ITestbed1StructArrayInterfaceInterface> GetImplementation();
	UApiGearMQTTHost* GetHost();
	UTestbed1StructArrayInterfaceMQTTAdapter* GetAdapter();
