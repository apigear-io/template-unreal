...
void UTestbed1StructArrayInterfaceJniClientCache::init()
{
	...
	static const TCHAR* errorMsgCls = TEXT("failed to get java testbed1/testbed1jniclient/StructArrayInterfaceJniClient. Bailing...");
	if (NewData->clientClassStructArrayInterface == nullptr || Testbed1DataJavaConverter::CheckJniErrorOccurred(errorMsgCls))
	{
		return;
	}
	...
	static const TCHAR* errorMsgPropBoolSetter = TEXT("failed to get java setPropBool, [Ltestbed1/testbed1_api/StructBool;)V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient. Bailing...");
	...
	static const TCHAR* errorMsgPropIntSetter = TEXT("failed to get java setPropInt, [Ltestbed1/testbed1_api/StructInt;)V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient. Bailing...");
	...
	static const TCHAR* errorMsgPropFloatSetter = TEXT("failed to get java setPropFloat, [Ltestbed1/testbed1_api/StructFloat;)V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient. Bailing...");
	...
	static const TCHAR* errorMsgPropStringSetter = TEXT("failed to get java setPropString, [Ltestbed1/testbed1_api/StructString;)V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient. Bailing...");
	...
	static const TCHAR* errorMsgPropEnumSetter = TEXT("failed to get java setPropEnum, [Ltestbed1/testbed1_api/Enum0;)V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient. Bailing...");
	...
	static const TCHAR* errorMsgFuncBoolAsyncMethod = TEXT("failed to get java funcBoolAsync, (Ljava/lang/String;[Ltestbed1/testbed1_api/StructBool;)V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient. Bailing...");
	...
	static const TCHAR* errorMsgFuncIntAsyncMethod = TEXT("failed to get java funcIntAsync, (Ljava/lang/String;[Ltestbed1/testbed1_api/StructInt;)V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient. Bailing...");
	...
	static const TCHAR* errorMsgFuncFloatAsyncMethod = TEXT("failed to get java funcFloatAsync, (Ljava/lang/String;[Ltestbed1/testbed1_api/StructFloat;)V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient. Bailing...");
	...
	static const TCHAR* errorMsgFuncStringAsyncMethod = TEXT("failed to get java funcStringAsync, (Ljava/lang/String;[Ltestbed1/testbed1_api/StructString;)V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient. Bailing...");
	...
	static const TCHAR* errorMsgFuncEnumAsyncMethod = TEXT("failed to get java funcEnumAsync, (Ljava/lang/String;[Ltestbed1/testbed1_api/Enum0;)V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient. Bailing...");
	...
	static const TCHAR* errorMsgInit = TEXT("failed to get java init, ()V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient. Bailing...");
	if (NewData->clientClassStructArrayInterfaceCtor == nullptr || Testbed1DataJavaConverter::CheckJniErrorOccurred(errorMsgInit))
	{
		return;
	}
	...
	static const TCHAR* errorMsgBind = TEXT("failed to get java bind, (Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z for testbed1/testbed1jniclient/StructArrayInterfaceJniClient. Bailing...");
	...
	static const TCHAR* errorMsgUnbind = TEXT("failed to get java unbind, ()V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient. Bailing...");
...
{
	auto updateAndBroadcastValueChanged = [InParamBool](UTestbed1StructArrayInterfaceJniClient& self)
	{
	...
	TWeakObjectPtr<UTestbed1StructArrayInterfaceJniClient> weakSelf(this);
	AsyncTask(
		ENamedThreads::GameThread,
		[updateAndBroadcastValueChanged = MoveTemp(updateAndBroadcastValueChanged), weakSelf]
		{
		UTestbed1StructArrayInterfaceJniClient* self = weakSelf.Get();
		if (self != nullptr)
		{
...
{
	auto updateAndBroadcastValueChanged = [InParamInt](UTestbed1StructArrayInterfaceJniClient& self)
	{
...
{
	auto updateAndBroadcastValueChanged = [InParamFloat](UTestbed1StructArrayInterfaceJniClient& self)
	{
...
{
	auto updateAndBroadcastValueChanged = [InParamString](UTestbed1StructArrayInterfaceJniClient& self)
	{
...
{
	auto updateAndBroadcastValueChanged = [InParamEnum](UTestbed1StructArrayInterfaceJniClient& self)
	{
		self._GetPublisher()->BroadcastSigEnumSignal(InParamEnum);
	};
...
{
	auto updateAndBroadcastValueChanged = [InPropBool](UTestbed1StructArrayInterfaceJniClient& self)
	{
...
{
	auto updateAndBroadcastValueChanged = [InPropInt](UTestbed1StructArrayInterfaceJniClient& self)
	{
...
{
	auto updateAndBroadcastValueChanged = [InPropFloat](UTestbed1StructArrayInterfaceJniClient& self)
	{
...
{
	auto updateAndBroadcastValueChanged = [InPropString](UTestbed1StructArrayInterfaceJniClient& self)
	{
...
{
	auto updateAndBroadcastValueChanged = [InPropEnum](UTestbed1StructArrayInterfaceJniClient& self)
	{
...
#if PLATFORM_ANDROID && USE_ANDROID_JNI
bool UTestbed1StructArrayInterfaceJniClient::tryCallAsyncJavaFuncBool(FGuid Guid, jmethodID MethodID, const TArray<FTestbed1StructBool>& InParamBool)
{
	UE_LOG(LogTestbed1StructArrayInterfaceClient_JNI, Verbose, TEXT("call async testbed1/testbed1jniclient/StructArrayInterfaceJniClient:funcBool"));
...
bool UTestbed1StructArrayInterfaceJniClient::tryCallAsyncJavaFuncInt(FGuid Guid, jmethodID MethodID, const TArray<FTestbed1StructInt>& InParamInt)
{
	UE_LOG(LogTestbed1StructArrayInterfaceClient_JNI, Verbose, TEXT("call async testbed1/testbed1jniclient/StructArrayInterfaceJniClient:funcInt"));
...
bool UTestbed1StructArrayInterfaceJniClient::tryCallAsyncJavaFuncFloat(FGuid Guid, jmethodID MethodID, const TArray<FTestbed1StructFloat>& InParamFloat)
{
	UE_LOG(LogTestbed1StructArrayInterfaceClient_JNI, Verbose, TEXT("call async testbed1/testbed1jniclient/StructArrayInterfaceJniClient:funcFloat"));
...
bool UTestbed1StructArrayInterfaceJniClient::tryCallAsyncJavaFuncString(FGuid Guid, jmethodID MethodID, const TArray<FTestbed1StructString>& InParamString)
{
	UE_LOG(LogTestbed1StructArrayInterfaceClient_JNI, Verbose, TEXT("call async testbed1/testbed1jniclient/StructArrayInterfaceJniClient:funcString"));
...
bool UTestbed1StructArrayInterfaceJniClient::tryCallAsyncJavaFuncEnum(FGuid Guid, jmethodID MethodID, const TArray<ETestbed1Enum0>& InParamEnum)
{
	UE_LOG(LogTestbed1StructArrayInterfaceClient_JNI, Verbose, TEXT("call async testbed1/testbed1jniclient/StructArrayInterfaceJniClient:funcEnum"));
...
void UTestbed1StructArrayInterfaceJniClient::notifyIsReady(bool bInIsReady)
{
	b_isReady.store(bInIsReady, std::memory_order_release);

	auto broadcastConnectionStatusChanged = [](UTestbed1StructArrayInterfaceJniClient& self)
	{
...
JNI_METHOD void Java_testbed1_testbed1jniclient_StructArrayInterfaceJniClient_nativeAsyncOperationFailed(JNIEnv* Env, jclass Clazz, jstring callId, jstring errorMessage, jint errorCode)
{
	FString callIdString = FJavaHelper::FStringFromParam(Env, callId);
	static const TCHAR* errorMsgId = TEXT("failed to convert call id string in nativeAsyncOperationFailed for testbed1/testbed1jniclient/StructArrayInterfaceJniClient");
	if (Testbed1DataJavaConverter::CheckJniErrorOccurred(errorMsgId))
	{
		return;
	}
	...
	UE_LOG(LogTestbed1StructArrayInterfaceClient_JNI, Warning,
		TEXT("Async operation failed for id %s: %s (code: %d)"),
		*callIdString, *errorMsgString, static_cast<int32>(errorCode));

	FGuid guid;
	FGuid::Parse(callIdString, guid);
	gUTestbed1StructArrayInterfaceJniClientmethodHelper.FulfillPromiseWithDefaultValue(guid);
}
#endif
