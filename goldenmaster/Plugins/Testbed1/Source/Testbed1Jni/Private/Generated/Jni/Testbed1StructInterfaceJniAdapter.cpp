...
void UTestbed1StructInterfaceJniAdapter::callJniServiceReady(bool isServiceReady)
{
	...
	{
		if (!Testbed1JniCache::javaClassStructInterface || !m_javaJniServiceInstance || !Testbed1JniCache::serviceClassStructInterfaceReadyMethodID)
		{
		...
		FJavaWrapper::CallVoidMethod(Env, m_javaJniServiceInstance, Testbed1JniCache::serviceClassStructInterfaceReadyMethodID, isServiceReady);
...
void UTestbed1StructInterfaceJniAdapter::OnSigBoolSignal(const FTestbed1StructBool& ParamBool)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (Testbed1JniCache::serviceClassStructInterface == nullptr || m_javaJniServiceInstance == nullptr)
		{
		...
		jmethodID MethodID = Testbed1JniCache::serviceClassStructInterfaceSigBoolSignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed1StructInterfaceJniAdapter::OnSigIntSignal(const FTestbed1StructInt& ParamInt)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed1JniCache::serviceClassStructInterfaceSigIntSignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed1StructInterfaceJniAdapter::OnSigFloatSignal(const FTestbed1StructFloat& ParamFloat)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed1JniCache::serviceClassStructInterfaceSigFloatSignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed1StructInterfaceJniAdapter::OnSigStringSignal(const FTestbed1StructString& ParamString)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed1JniCache::serviceClassStructInterfaceSigStringSignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed1StructInterfaceJniAdapter::OnPropBoolChanged(const FTestbed1StructBool& PropBool)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (Testbed1JniCache::serviceClassStructInterface == nullptr)
		{
		...
		jmethodID MethodID = Testbed1JniCache::serviceClassStructInterfacePropBoolChangedMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed1StructInterfaceJniAdapter::OnPropIntChanged(const FTestbed1StructInt& PropInt)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed1JniCache::serviceClassStructInterfacePropIntChangedMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed1StructInterfaceJniAdapter::OnPropFloatChanged(const FTestbed1StructFloat& PropFloat)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed1JniCache::serviceClassStructInterfacePropFloatChangedMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed1StructInterfaceJniAdapter::OnPropStringChanged(const FTestbed1StructString& PropString)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed1JniCache::serviceClassStructInterfacePropStringChangedMethodID;
		if (MethodID == nullptr)
		{
