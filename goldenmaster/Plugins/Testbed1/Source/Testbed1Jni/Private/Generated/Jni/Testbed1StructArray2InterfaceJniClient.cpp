...
void UTestbed1StructArray2InterfaceJniClient::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	if (Testbed1JniCache::clientClassStructArray2InterfaceCtor == nullptr)
	{
	...
	jobject localRef = Env->NewObject(Testbed1JniCache::clientClassStructArray2Interface, Testbed1JniCache::clientClassStructArray2InterfaceCtor);
...
void UTestbed1StructArray2InterfaceJniClient::SetPropBool(const FTestbed1StructBoolWithArray& InPropBool)
{
	...
	{
		if (Testbed1JniCache::javaClassStructArray2Interface == nullptr)
		{
		...
		jmethodID MethodID = Testbed1JniCache::javaClassStructArray2InterfacePropBoolSetterId;
		if (MethodID == nullptr)
		{
...
void UTestbed1StructArray2InterfaceJniClient::SetPropInt(const FTestbed1StructIntWithArray& InPropInt)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed1JniCache::javaClassStructArray2InterfacePropIntSetterId;
		if (MethodID == nullptr)
		{
...
void UTestbed1StructArray2InterfaceJniClient::SetPropFloat(const FTestbed1StructFloatWithArray& InPropFloat)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed1JniCache::javaClassStructArray2InterfacePropFloatSetterId;
		if (MethodID == nullptr)
		{
...
void UTestbed1StructArray2InterfaceJniClient::SetPropString(const FTestbed1StructStringWithArray& InPropString)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed1JniCache::javaClassStructArray2InterfacePropStringSetterId;
		if (MethodID == nullptr)
		{
...
void UTestbed1StructArray2InterfaceJniClient::SetPropEnum(const FTestbed1StructEnumWithArray& InPropEnum)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed1JniCache::javaClassStructArray2InterfacePropEnumSetterId;
		if (MethodID == nullptr)
		{
...
TArray<FTestbed1StructBool> UTestbed1StructArray2InterfaceJniClient::FuncBool(const FTestbed1StructBoolWithArray& InParamBool)
{
...
#if PLATFORM_ANDROID && USE_ANDROID_JNI
	if (Testbed1JniCache::clientClassStructArray2Interface == nullptr)
	{
	...
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
	jmethodID MethodID = Testbed1JniCache::clientClassStructArray2InterfaceFuncBoolAsyncMethodID;
	if (MethodID != nullptr)
	{
...
TArray<FTestbed1StructInt> UTestbed1StructArray2InterfaceJniClient::FuncInt(const FTestbed1StructIntWithArray& InParamInt)
{
	...
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
	jmethodID MethodID = Testbed1JniCache::clientClassStructArray2InterfaceFuncIntAsyncMethodID;
	if (MethodID != nullptr)
	{
		auto id = gUTestbed1StructArray2InterfaceJniClientmethodHelper.StorePromise(Promise);
		auto idString = FJavaHelper::ToJavaString(Env, id.ToString(EGuidFormats::Digits));
...
TArray<FTestbed1StructFloat> UTestbed1StructArray2InterfaceJniClient::FuncFloat(const FTestbed1StructFloatWithArray& InParamFloat)
{
	...
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
	jmethodID MethodID = Testbed1JniCache::clientClassStructArray2InterfaceFuncFloatAsyncMethodID;
	if (MethodID != nullptr)
	{
		auto id = gUTestbed1StructArray2InterfaceJniClientmethodHelper.StorePromise(Promise);
		auto idString = FJavaHelper::ToJavaString(Env, id.ToString(EGuidFormats::Digits));
...
TArray<FTestbed1StructString> UTestbed1StructArray2InterfaceJniClient::FuncString(const FTestbed1StructStringWithArray& InParamString)
{
	...
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
	jmethodID MethodID = Testbed1JniCache::clientClassStructArray2InterfaceFuncStringAsyncMethodID;
	if (MethodID != nullptr)
	{
		auto id = gUTestbed1StructArray2InterfaceJniClientmethodHelper.StorePromise(Promise);
		auto idString = FJavaHelper::ToJavaString(Env, id.ToString(EGuidFormats::Digits));
...
TArray<ETestbed1Enum0> UTestbed1StructArray2InterfaceJniClient::FuncEnum(const FTestbed1StructEnumWithArray& InParamEnum)
{
	...
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
	jmethodID MethodID = Testbed1JniCache::clientClassStructArray2InterfaceFuncEnumAsyncMethodID;
	if (MethodID != nullptr)
	{
		auto id = gUTestbed1StructArray2InterfaceJniClientmethodHelper.StorePromise(Promise);
		auto idString = FJavaHelper::ToJavaString(Env, id.ToString(EGuidFormats::Digits));
...
bool UTestbed1StructArray2InterfaceJniClient::_bindToService(FString servicePackage, FString connectionId)
{
	...
	jmethodID MethodID = Testbed1JniCache::clientClassStructArray2InterfaceBindMethodID;
	if (MethodID != nullptr)
	{
...
void UTestbed1StructArray2InterfaceJniClient::_unbind()
{
	...
	jmethodID MethodID = Testbed1JniCache::clientClassStructArray2InterfaceUnbindMethodID;
	if (MethodID != nullptr)
	{
