...
DEFINE_LOG_CATEGORY(LogTestbed1JniCache_JNI);

void Testbed1JniCache::checkException(JNIEnv* env, FString memberInfo)
{
	if (env->ExceptionCheck())
	{
		env->ExceptionDescribe(); // logs in java
		env->ExceptionClear();
		UE_LOG(LogTestbed1JniCache_JNI, Warning, TEXT("Could not find %s"), *memberInfo);
	}
}
...
void Testbed1JniCache::init()
{
	...
	checkException(env, "fieldString, Ljava/lang/String; for testbed1/testbed1_api/StructString");
	javaStructStructStruct = FAndroidApplication::FindJavaClassGlobalRef("testbed1/testbed1_api/StructStruct");
	checkException(env, "testbed1/testbed1_api/StructStruct");
	javaStructStructStructCtor = env->GetMethodID(Testbed1JniCache::javaStructStructStruct, "<init>", "()V");
	checkException(env, "method <init>, ()V for testbed1/testbed1_api/StructStruct");
	...
	checkException(env, "fieldString, Ltestbed1/testbed1_api/StructString; for testbed1/testbed1_api/StructStruct");
	javaStructStructEnum = FAndroidApplication::FindJavaClassGlobalRef("testbed1/testbed1_api/StructEnum");
	checkException(env, "testbed1/testbed1_api/StructEnum");
	javaStructStructEnumCtor = env->GetMethodID(Testbed1JniCache::javaStructStructEnum, "<init>", "()V");
	checkException(env, "method <init>, ()V for testbed1/testbed1_api/StructEnum");
	...
	checkException(env, "fieldString, [Ljava/lang/String; for testbed1/testbed1_api/StructStringWithArray");
	javaStructStructStructWithArray = FAndroidApplication::FindJavaClassGlobalRef("testbed1/testbed1_api/StructStructWithArray");
	checkException(env, "testbed1/testbed1_api/StructStructWithArray");
	javaStructStructStructWithArrayCtor = env->GetMethodID(Testbed1JniCache::javaStructStructStructWithArray, "<init>", "()V");
	checkException(env, "method <init>, ()V for testbed1/testbed1_api/StructStructWithArray");
	...
	checkException(env, "fieldStruct, [Ltestbed1/testbed1_api/StructStringWithArray; for testbed1/testbed1_api/StructStructWithArray");
	javaStructStructEnumWithArray = FAndroidApplication::FindJavaClassGlobalRef("testbed1/testbed1_api/StructEnumWithArray");
	checkException(env, "testbed1/testbed1_api/StructEnumWithArray");
	javaStructStructEnumWithArrayCtor = env->GetMethodID(Testbed1JniCache::javaStructStructEnumWithArray, "<init>", "()V");
	checkException(env, "method <init>, ()V for testbed1/testbed1_api/StructEnumWithArray");
	...
	checkException(env, "fieldEnum, [Ltestbed1/testbed1_api/Enum0; for testbed1/testbed1_api/StructEnumWithArray");
	javaEnumEnum0 = FAndroidApplication::FindJavaClassGlobalRef("testbed1/testbed1_api/Enum0");
	checkException(env, "testbed1/testbed1_api/Enum0");
	...
	checkException(env, "fromValue (I)Ltestbed1/testbed1_api/Enum0; for testbed1/testbed1_api/Enum0");
	javaEnumEnum0GetValueMethod = env->GetMethodID(Testbed1JniCache::javaEnumEnum0, "getValue", "()I");
	checkException(env, "getValue (I)Ltestbed1/testbed1_api/Enum0; for testbed1/testbed1_api/Enum0");

	javaClassStructInterface = FAndroidApplication::FindJavaClassGlobalRef("testbed1/testbed1_api/IStructInterface");
	checkException(env, "testbed1/testbed1_api/IStructInterface");
	...
	checkException(env, "setPropBool, (Ltestbed1/testbed1_api/StructBool;)V  for testbed1/testbed1_api/IStructInterface");
	...
	checkException(env, "getPropBool, ()Ltestbed1/testbed1_api/StructBool; for testbed1/testbed1_api/IStructInterface");
	...
	checkException(env, "setPropInt, (Ltestbed1/testbed1_api/StructInt;)V  for testbed1/testbed1_api/IStructInterface");
	...
	checkException(env, "getPropInt, ()Ltestbed1/testbed1_api/StructInt; for testbed1/testbed1_api/IStructInterface");
	...
	checkException(env, "setPropFloat, (Ltestbed1/testbed1_api/StructFloat;)V  for testbed1/testbed1_api/IStructInterface");
	...
	checkException(env, "getPropFloat, ()Ltestbed1/testbed1_api/StructFloat; for testbed1/testbed1_api/IStructInterface");
	...
	checkException(env, "setPropString, (Ltestbed1/testbed1_api/StructString;)V  for testbed1/testbed1_api/IStructInterface");
	...
	checkException(env, "getPropString, ()Ltestbed1/testbed1_api/StructString; for testbed1/testbed1_api/IStructInterface");
	...
	checkException(env, "testbed1/testbed1jniservice/StructInterfaceJniService");
	...
	checkException(env, "nativeServiceReady, (Z)V for testbed1/testbed1jniservice/StructInterfaceJniService");
	...
	checkException(env, "onPropBoolChanged, (Ltestbed1/testbed1_api/StructBool;)V for testbed1/testbed1jniservice/StructInterfaceJniService");
	...
	checkException(env, "onPropIntChanged, (Ltestbed1/testbed1_api/StructInt;)V for testbed1/testbed1jniservice/StructInterfaceJniService");
	...
	checkException(env, "onPropFloatChanged, (Ltestbed1/testbed1_api/StructFloat;)V for testbed1/testbed1jniservice/StructInterfaceJniService");
	...
	checkException(env, "onPropStringChanged, (Ltestbed1/testbed1_api/StructString;)V for testbed1/testbed1jniservice/StructInterfaceJniService");
	...
	checkException(env, "onSigBool, (Ltestbed1/testbed1_api/StructBool;)V for testbed1/testbed1jniservice/StructInterfaceJniService");
	...
	checkException(env, "onSigInt, (Ltestbed1/testbed1_api/StructInt;)V for testbed1/testbed1jniservice/StructInterfaceJniService");
	...
	checkException(env, "onSigFloat, (Ltestbed1/testbed1_api/StructFloat;)V for testbed1/testbed1jniservice/StructInterfaceJniService");
	...
	checkException(env, "onSigString, (Ltestbed1/testbed1_api/StructString;)V for testbed1/testbed1jniservice/StructInterfaceJniService");
	...
	checkException(env, "testbed1/testbed1jniclient/StructInterfaceJniClient");
	...
	checkException(env, "funcBoolAsync, (Ljava/lang/String;Ltestbed1/testbed1_api/StructBool;)V for testbed1/testbed1jniclient/StructInterfaceJniClient");
	...
	checkException(env, "funcIntAsync, (Ljava/lang/String;Ltestbed1/testbed1_api/StructInt;)V for testbed1/testbed1jniclient/StructInterfaceJniClient");
	...
	checkException(env, "funcFloatAsync, (Ljava/lang/String;Ltestbed1/testbed1_api/StructFloat;)V for testbed1/testbed1jniclient/StructInterfaceJniClient");
	...
	checkException(env, "funcStringAsync, (Ljava/lang/String;Ltestbed1/testbed1_api/StructString;)V for testbed1/testbed1jniclient/StructInterfaceJniClient");
	clientClassStructInterfaceCtor = env->GetMethodID(Testbed1JniCache::clientClassStructInterface, "<init>", "()V");
	checkException(env, "init, ()V for testbed1/testbed1jniclient/StructInterfaceJniClient");
	...
	checkException(env, "bind, (Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z for testbed1/testbed1jniclient/StructInterfaceJniClient");
	clientClassStructInterfaceUnbindMethodID = env->GetMethodID(Testbed1JniCache::clientClassStructInterface, "unbind", "()V");
	checkException(env, "unbind, ()V for testbed1/testbed1jniclient/StructInterfaceJniClient");

	javaClassStructArrayInterface = FAndroidApplication::FindJavaClassGlobalRef("testbed1/testbed1_api/IStructArrayInterface");
	checkException(env, "testbed1/testbed1_api/IStructArrayInterface");
	...
	checkException(env, "setPropBool, ([Ltestbed1/testbed1_api/StructBool;)V  for testbed1/testbed1_api/IStructArrayInterface");
	...
	checkException(env, "getPropBool, ()[Ltestbed1/testbed1_api/StructBool; for testbed1/testbed1_api/IStructArrayInterface");
	...
	checkException(env, "setPropInt, ([Ltestbed1/testbed1_api/StructInt;)V  for testbed1/testbed1_api/IStructArrayInterface");
	...
	checkException(env, "getPropInt, ()[Ltestbed1/testbed1_api/StructInt; for testbed1/testbed1_api/IStructArrayInterface");
	...
	checkException(env, "setPropFloat, ([Ltestbed1/testbed1_api/StructFloat;)V  for testbed1/testbed1_api/IStructArrayInterface");
	...
	checkException(env, "getPropFloat, ()[Ltestbed1/testbed1_api/StructFloat; for testbed1/testbed1_api/IStructArrayInterface");
	...
	checkException(env, "setPropString, ([Ltestbed1/testbed1_api/StructString;)V  for testbed1/testbed1_api/IStructArrayInterface");
	...
	checkException(env, "getPropString, ()[Ltestbed1/testbed1_api/StructString; for testbed1/testbed1_api/IStructArrayInterface");
	...
	checkException(env, "setPropEnum, ([Ltestbed1/testbed1_api/Enum0;)V  for testbed1/testbed1_api/IStructArrayInterface");
	...
	checkException(env, "getPropEnum, ()[Ltestbed1/testbed1_api/Enum0; for testbed1/testbed1_api/IStructArrayInterface");
	...
	checkException(env, "testbed1/testbed1jniservice/StructArrayInterfaceJniService");
	...
	checkException(env, "nativeServiceReady, (Z)V for testbed1/testbed1jniservice/StructArrayInterfaceJniService");
	...
	checkException(env, "onPropBoolChanged, ([Ltestbed1/testbed1_api/StructBool;)V for testbed1/testbed1jniservice/StructArrayInterfaceJniService");
	...
	checkException(env, "onPropIntChanged, ([Ltestbed1/testbed1_api/StructInt;)V for testbed1/testbed1jniservice/StructArrayInterfaceJniService");
	...
	checkException(env, "onPropFloatChanged, ([Ltestbed1/testbed1_api/StructFloat;)V for testbed1/testbed1jniservice/StructArrayInterfaceJniService");
	...
	checkException(env, "onPropStringChanged, ([Ltestbed1/testbed1_api/StructString;)V for testbed1/testbed1jniservice/StructArrayInterfaceJniService");
	...
	checkException(env, "onPropEnumChanged, ([Ltestbed1/testbed1_api/Enum0;)V for testbed1/testbed1jniservice/StructArrayInterfaceJniService");
	...
	checkException(env, "onSigBool, ([Ltestbed1/testbed1_api/StructBool;)V for testbed1/testbed1jniservice/StructArrayInterfaceJniService");
	...
	checkException(env, "onSigInt, ([Ltestbed1/testbed1_api/StructInt;)V for testbed1/testbed1jniservice/StructArrayInterfaceJniService");
	...
	checkException(env, "onSigFloat, ([Ltestbed1/testbed1_api/StructFloat;)V for testbed1/testbed1jniservice/StructArrayInterfaceJniService");
	...
	checkException(env, "onSigString, ([Ltestbed1/testbed1_api/StructString;)V for testbed1/testbed1jniservice/StructArrayInterfaceJniService");
	...
	checkException(env, "onSigEnum, ([Ltestbed1/testbed1_api/Enum0;)V for testbed1/testbed1jniservice/StructArrayInterfaceJniService");
	...
	checkException(env, "testbed1/testbed1jniclient/StructArrayInterfaceJniClient");
	...
	checkException(env, "funcBoolAsync, (Ljava/lang/String;[Ltestbed1/testbed1_api/StructBool;)V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient");
	...
	checkException(env, "funcIntAsync, (Ljava/lang/String;[Ltestbed1/testbed1_api/StructInt;)V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient");
	...
	checkException(env, "funcFloatAsync, (Ljava/lang/String;[Ltestbed1/testbed1_api/StructFloat;)V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient");
	...
	checkException(env, "funcStringAsync, (Ljava/lang/String;[Ltestbed1/testbed1_api/StructString;)V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient");
	...
	checkException(env, "funcEnumAsync, (Ljava/lang/String;[Ltestbed1/testbed1_api/Enum0;)V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient");
	clientClassStructArrayInterfaceCtor = env->GetMethodID(Testbed1JniCache::clientClassStructArrayInterface, "<init>", "()V");
	checkException(env, "init, ()V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient");
	...
	checkException(env, "bind, (Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z for testbed1/testbed1jniclient/StructArrayInterfaceJniClient");
	clientClassStructArrayInterfaceUnbindMethodID = env->GetMethodID(Testbed1JniCache::clientClassStructArrayInterface, "unbind", "()V");
	checkException(env, "unbind, ()V for testbed1/testbed1jniclient/StructArrayInterfaceJniClient");

	javaClassStructArray2Interface = FAndroidApplication::FindJavaClassGlobalRef("testbed1/testbed1_api/IStructArray2Interface");
	checkException(env, "testbed1/testbed1_api/IStructArray2Interface");
	...
	checkException(env, "setPropBool, (Ltestbed1/testbed1_api/StructBoolWithArray;)V  for testbed1/testbed1_api/IStructArray2Interface");
	...
	checkException(env, "getPropBool, ()Ltestbed1/testbed1_api/StructBoolWithArray; for testbed1/testbed1_api/IStructArray2Interface");
	...
	checkException(env, "setPropInt, (Ltestbed1/testbed1_api/StructIntWithArray;)V  for testbed1/testbed1_api/IStructArray2Interface");
	...
	checkException(env, "getPropInt, ()Ltestbed1/testbed1_api/StructIntWithArray; for testbed1/testbed1_api/IStructArray2Interface");
	...
	checkException(env, "setPropFloat, (Ltestbed1/testbed1_api/StructFloatWithArray;)V  for testbed1/testbed1_api/IStructArray2Interface");
	...
	checkException(env, "getPropFloat, ()Ltestbed1/testbed1_api/StructFloatWithArray; for testbed1/testbed1_api/IStructArray2Interface");
	...
	checkException(env, "setPropString, (Ltestbed1/testbed1_api/StructStringWithArray;)V  for testbed1/testbed1_api/IStructArray2Interface");
	...
	checkException(env, "getPropString, ()Ltestbed1/testbed1_api/StructStringWithArray; for testbed1/testbed1_api/IStructArray2Interface");
	...
	checkException(env, "setPropEnum, (Ltestbed1/testbed1_api/StructEnumWithArray;)V  for testbed1/testbed1_api/IStructArray2Interface");
	...
	checkException(env, "getPropEnum, ()Ltestbed1/testbed1_api/StructEnumWithArray; for testbed1/testbed1_api/IStructArray2Interface");
	...
	checkException(env, "testbed1/testbed1jniservice/StructArray2InterfaceJniService");
	...
	checkException(env, "nativeServiceReady, (Z)V for testbed1/testbed1jniservice/StructArray2InterfaceJniService");
	...
	checkException(env, "onPropBoolChanged, (Ltestbed1/testbed1_api/StructBoolWithArray;)V for testbed1/testbed1jniservice/StructArray2InterfaceJniService");
	...
	checkException(env, "onPropIntChanged, (Ltestbed1/testbed1_api/StructIntWithArray;)V for testbed1/testbed1jniservice/StructArray2InterfaceJniService");
	...
	checkException(env, "onPropFloatChanged, (Ltestbed1/testbed1_api/StructFloatWithArray;)V for testbed1/testbed1jniservice/StructArray2InterfaceJniService");
	...
	checkException(env, "onPropStringChanged, (Ltestbed1/testbed1_api/StructStringWithArray;)V for testbed1/testbed1jniservice/StructArray2InterfaceJniService");
	...
	checkException(env, "onPropEnumChanged, (Ltestbed1/testbed1_api/StructEnumWithArray;)V for testbed1/testbed1jniservice/StructArray2InterfaceJniService");
	...
	checkException(env, "onSigBool, (Ltestbed1/testbed1_api/StructBoolWithArray;)V for testbed1/testbed1jniservice/StructArray2InterfaceJniService");
	...
	checkException(env, "onSigInt, (Ltestbed1/testbed1_api/StructIntWithArray;)V for testbed1/testbed1jniservice/StructArray2InterfaceJniService");
	...
	checkException(env, "onSigFloat, (Ltestbed1/testbed1_api/StructFloatWithArray;)V for testbed1/testbed1jniservice/StructArray2InterfaceJniService");
	...
	checkException(env, "onSigString, (Ltestbed1/testbed1_api/StructStringWithArray;)V for testbed1/testbed1jniservice/StructArray2InterfaceJniService");
	...
	checkException(env, "testbed1/testbed1jniclient/StructArray2InterfaceJniClient");
	...
	checkException(env, "funcBoolAsync, (Ljava/lang/String;Ltestbed1/testbed1_api/StructBoolWithArray;)V for testbed1/testbed1jniclient/StructArray2InterfaceJniClient");
	...
	checkException(env, "funcIntAsync, (Ljava/lang/String;Ltestbed1/testbed1_api/StructIntWithArray;)V for testbed1/testbed1jniclient/StructArray2InterfaceJniClient");
	...
	checkException(env, "funcFloatAsync, (Ljava/lang/String;Ltestbed1/testbed1_api/StructFloatWithArray;)V for testbed1/testbed1jniclient/StructArray2InterfaceJniClient");
	...
	checkException(env, "funcStringAsync, (Ljava/lang/String;Ltestbed1/testbed1_api/StructStringWithArray;)V for testbed1/testbed1jniclient/StructArray2InterfaceJniClient");
	...
	checkException(env, "funcEnumAsync, (Ljava/lang/String;Ltestbed1/testbed1_api/StructEnumWithArray;)V for testbed1/testbed1jniclient/StructArray2InterfaceJniClient");
	clientClassStructArray2InterfaceCtor = env->GetMethodID(Testbed1JniCache::clientClassStructArray2Interface, "<init>", "()V");
	checkException(env, "init, ()V for testbed1/testbed1jniclient/StructArray2InterfaceJniClient");
	...
	checkException(env, "bind, (Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z for testbed1/testbed1jniclient/StructArray2InterfaceJniClient");
	...
	checkException(env, "unbind, ()V for testbed1/testbed1jniclient/StructArray2InterfaceJniClient");
