...
struct FTestbed1DataJavaConverterCacheData
{
	...
	~FTestbed1DataJavaConverterCacheData()
	{
		...
		if (Env)
		{
			if (jStructBool) Env->DeleteGlobalRef(jStructBool);
			if (jStructInt) Env->DeleteGlobalRef(jStructInt);
			if (jStructFloat) Env->DeleteGlobalRef(jStructFloat);
			if (jStructString) Env->DeleteGlobalRef(jStructString);
			if (jStructStruct) Env->DeleteGlobalRef(jStructStruct);
			if (jStructEnum) Env->DeleteGlobalRef(jStructEnum);
			if (jStructBoolWithArray) Env->DeleteGlobalRef(jStructBoolWithArray);
			if (jStructIntWithArray) Env->DeleteGlobalRef(jStructIntWithArray);
			if (jStructFloatWithArray) Env->DeleteGlobalRef(jStructFloatWithArray);
			if (jStructStringWithArray) Env->DeleteGlobalRef(jStructStringWithArray);
			if (jStructStructWithArray) Env->DeleteGlobalRef(jStructStructWithArray);
			if (jStructEnumWithArray) Env->DeleteGlobalRef(jStructEnumWithArray);
			if (jEnum0) Env->DeleteGlobalRef(jEnum0);
			if (jStructInterface) Env->DeleteGlobalRef(jStructInterface);
			if (jStructArrayInterface) Env->DeleteGlobalRef(jStructArrayInterface);
			if (jStructArray2Interface) Env->DeleteGlobalRef(jStructArray2Interface);
		}
	}
};
