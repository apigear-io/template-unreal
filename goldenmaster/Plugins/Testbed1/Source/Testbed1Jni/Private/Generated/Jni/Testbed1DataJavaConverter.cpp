...
TSharedPtr<FTestbed1DataJavaConverterCacheData, ESPMode::ThreadSafe> Testbed1DataJavaConverter::ensureInitialized()
{
	...
	if (checkJniErrorOccured(errorMsgStructBool))
	{
	...
	if (checkJniErrorOccured(errorMsgStructInt))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgStructFloat))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgStructString))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgStructStruct))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgStructEnum))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgStructBoolWithArray))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgStructIntWithArray))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgStructFloatWithArray))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgStructStringWithArray))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgStructStructWithArray))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgStructEnumWithArray))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgEnum0))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgStructInterface))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgStructArrayInterface))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgStructArray2Interface))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
