...
TSharedPtr<FTestbed1DataJavaConverterCacheData, ESPMode::ThreadSafe> Testbed1DataJavaConverter::ensureInitialized()
{
	...
	if (CheckJniErrorOccurred(errorMsgStructBool))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgStructInt))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgStructFloat))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgStructString))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgStructStruct))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgStructEnum))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgStructBoolWithArray))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgStructIntWithArray))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgStructFloatWithArray))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgStructStringWithArray))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgStructStructWithArray))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgStructEnumWithArray))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgEnum0))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgStructInterface))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgStructArrayInterface))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (CheckJniErrorOccurred(errorMsgStructArray2Interface))
	{
		UE_LOG(LogTestbed1DataJavaConverter_JNI, Warning, TEXT("Testbed1DataJavaConverter initialization failed"));
		return nullptr;
	}
