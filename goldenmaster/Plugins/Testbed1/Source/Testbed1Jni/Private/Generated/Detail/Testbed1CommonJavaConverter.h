...
DECLARE_LOG_CATEGORY_EXTERN(LogTestbed1CommonJavaConverter_JNI, Log, All);

class FTestbed1CommonJavaConverter
{
public:
...
private:
	...
	FTestbed1CommonJavaConverter() = delete;
};

template<>
struct FTestbed1CommonJavaConverter::JniArrayTraits<bool>
{
...
template<>
struct FTestbed1CommonJavaConverter::JniArrayTraits<int32>
{
...
template<>
struct FTestbed1CommonJavaConverter::JniArrayTraits<int64>
{
...
template<>
struct FTestbed1CommonJavaConverter::JniArrayTraits<float>
{
...
template<>
struct FTestbed1CommonJavaConverter::JniArrayTraits<double>
{
    ...
    JNIEnv* Env, TArray<PrimitiveType>& OutPrimitiveArray, jarray InJniArray, const FString& InPropertyName)
{
	...
	{
		UE_LOG(LogTestbed1CommonJavaConverter_JNI, Warning, TEXT("%s is null"), *InPropertyName);
		return false;
	}
