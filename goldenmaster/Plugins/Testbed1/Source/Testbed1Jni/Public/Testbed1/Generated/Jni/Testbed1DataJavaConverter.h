...
private:
	...
	static TSharedPtr<FTestbed1DataJavaConverterCacheData, ESPMode::ThreadSafe> CacheData;
	static TSharedPtr<FTestbed1DataJavaConverterCacheData, ESPMode::ThreadSafe> ensureInitialized();
