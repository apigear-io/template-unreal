...
void UTestbed1StructArrayInterfaceMsgBusClient::OnConnectionInit(const FTestbed1StructArrayInterfaceInitMessage& InMessage, const TSharedRef<IMessageContext, ESPMode::ThreadSafe>& Context)
{
	...
	{
		UE_LOG(LogTestbed1StructArrayInterfaceMsgBusClient, Warning,
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("ApiGear.Testbed1.StructArrayInterface.MsgBus.SetPropBool");
	if (!_IsConnected())
	{
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("ApiGear.Testbed1.StructArrayInterface.MsgBus.SetPropInt");
	if (!_IsConnected())
	{
		UE_LOG(LogTestbed1StructArrayInterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
		return;
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("ApiGear.Testbed1.StructArrayInterface.MsgBus.SetPropFloat");
	if (!_IsConnected())
	{
		UE_LOG(LogTestbed1StructArrayInterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
		return;
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("ApiGear.Testbed1.StructArrayInterface.MsgBus.SetPropString");
	if (!_IsConnected())
	{
		UE_LOG(LogTestbed1StructArrayInterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
		return;
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("ApiGear.Testbed1.StructArrayInterface.MsgBus.SetPropEnum");
	if (!_IsConnected())
	{
		UE_LOG(LogTestbed1StructArrayInterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
		return;
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("ApiGear.Testbed1.StructArrayInterface.MsgBus.FuncBool");
	if (!_IsConnected())
	{
		UE_LOG(LogTestbed1StructArrayInterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
	...
	auto Promise = StorePromise<TArray<FTestbed1StructBool>>(msg->ResponseId);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("ApiGear.Testbed1.StructArrayInterface.MsgBus.FuncInt");
	if (!_IsConnected())
	{
		UE_LOG(LogTestbed1StructArrayInterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
	...
	auto Promise = StorePromise<TArray<FTestbed1StructInt>>(msg->ResponseId);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("ApiGear.Testbed1.StructArrayInterface.MsgBus.FuncFloat");
	if (!_IsConnected())
	{
		UE_LOG(LogTestbed1StructArrayInterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
	...
	auto Promise = StorePromise<TArray<FTestbed1StructFloat>>(msg->ResponseId);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("ApiGear.Testbed1.StructArrayInterface.MsgBus.FuncString");
	if (!_IsConnected())
	{
		UE_LOG(LogTestbed1StructArrayInterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
	...
	auto Promise = StorePromise<TArray<FTestbed1StructString>>(msg->ResponseId);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("ApiGear.Testbed1.StructArrayInterface.MsgBus.FuncEnum");
	if (!_IsConnected())
	{
		UE_LOG(LogTestbed1StructArrayInterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
	...
	auto Promise = StorePromise<TArray<ETestbed1Enum0>>(msg->ResponseId);
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("ApiGear.Testbed1.StructArrayInterface.MsgBus.SignalSigBool");
	if (ServiceAddress != Context->GetSender())
	{
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("ApiGear.Testbed1.StructArrayInterface.MsgBus.SignalSigInt");
	if (ServiceAddress != Context->GetSender())
	{
		UE_LOG(LogTestbed1StructArrayInterfaceMsgBusClient, Error, TEXT("Got a message from wrong service(%s) instead of %s"), *Context->GetSender().ToString(), *ServiceAddress.ToString());
		return;
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("ApiGear.Testbed1.StructArrayInterface.MsgBus.SignalSigFloat");
	if (ServiceAddress != Context->GetSender())
	{
		UE_LOG(LogTestbed1StructArrayInterfaceMsgBusClient, Error, TEXT("Got a message from wrong service(%s) instead of %s"), *Context->GetSender().ToString(), *ServiceAddress.ToString());
		return;
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("ApiGear.Testbed1.StructArrayInterface.MsgBus.SignalSigString");
	if (ServiceAddress != Context->GetSender())
	{
		UE_LOG(LogTestbed1StructArrayInterfaceMsgBusClient, Error, TEXT("Got a message from wrong service(%s) instead of %s"), *Context->GetSender().ToString(), *ServiceAddress.ToString());
		return;
...
{
	TRACE_CPUPROFILER_EVENT_SCOPE_STR("ApiGear.Testbed1.StructArrayInterface.MsgBus.SignalSigEnum");
	if (ServiceAddress != Context->GetSender())
	{
		UE_LOG(LogTestbed1StructArrayInterfaceMsgBusClient, Error, TEXT("Got a message from wrong service(%s) instead of %s"), *Context->GetSender().ToString(), *ServiceAddress.ToString());
		return;
	...
	_GetPublisher()->BroadcastSigEnumSignal(InMessage.ParamEnum);
	return;
}
...
TSharedPtr<TPromise<ResultType>> UTestbed1StructArrayInterfaceMsgBusClient::StorePromise(const FGuid& Id)
{
...
void UTestbed1StructArrayInterfaceMsgBusClient::CancelAllPromises()
{
...
template TSharedPtr<TPromise<TArray<ETestbed1Enum0>>> UTestbed1StructArrayInterfaceMsgBusClient::StorePromise<TArray<ETestbed1Enum0>>(const FGuid& Id);
...
template TSharedPtr<TPromise<TArray<FTestbed1StructBool>>> UTestbed1StructArrayInterfaceMsgBusClient::StorePromise<TArray<FTestbed1StructBool>>(const FGuid& Id);
...
template TSharedPtr<TPromise<TArray<FTestbed1StructFloat>>> UTestbed1StructArrayInterfaceMsgBusClient::StorePromise<TArray<FTestbed1StructFloat>>(const FGuid& Id);
...
template TSharedPtr<TPromise<TArray<FTestbed1StructInt>>> UTestbed1StructArrayInterfaceMsgBusClient::StorePromise<TArray<FTestbed1StructInt>>(const FGuid& Id);
...
template TSharedPtr<TPromise<TArray<FTestbed1StructString>>> UTestbed1StructArrayInterfaceMsgBusClient::StorePromise<TArray<FTestbed1StructString>>(const FGuid& Id);
