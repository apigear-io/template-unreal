...
void UTestbed1StructArray2InterfaceMsgBusAdapter::_setBackendService(TScriptInterface<ITestbed1StructArray2InterfaceInterface> InService)
{
	...
	if (BackendService != nullptr)
	{
		...
		BackendSignals->OnPropBoolChanged.RemoveDynamic(this, &UTestbed1StructArray2InterfaceMsgBusAdapter::OnPropBoolChanged);
		BackendSignals->OnPropIntChanged.RemoveDynamic(this, &UTestbed1StructArray2InterfaceMsgBusAdapter::OnPropIntChanged);
		BackendSignals->OnPropFloatChanged.RemoveDynamic(this, &UTestbed1StructArray2InterfaceMsgBusAdapter::OnPropFloatChanged);
		BackendSignals->OnPropStringChanged.RemoveDynamic(this, &UTestbed1StructArray2InterfaceMsgBusAdapter::OnPropStringChanged);
		BackendSignals->OnPropEnumChanged.RemoveDynamic(this, &UTestbed1StructArray2InterfaceMsgBusAdapter::OnPropEnumChanged);
		BackendSignals->OnSigBoolSignal.RemoveDynamic(this, &UTestbed1StructArray2InterfaceMsgBusAdapter::OnSigBool);
		BackendSignals->OnSigIntSignal.RemoveDynamic(this, &UTestbed1StructArray2InterfaceMsgBusAdapter::OnSigInt);
		BackendSignals->OnSigFloatSignal.RemoveDynamic(this, &UTestbed1StructArray2InterfaceMsgBusAdapter::OnSigFloat);
		BackendSignals->OnSigStringSignal.RemoveDynamic(this, &UTestbed1StructArray2InterfaceMsgBusAdapter::OnSigString);
	}
	...
	BackendSignals->OnPropBoolChanged.AddDynamic(this, &UTestbed1StructArray2InterfaceMsgBusAdapter::OnPropBoolChanged);
	BackendSignals->OnPropIntChanged.AddDynamic(this, &UTestbed1StructArray2InterfaceMsgBusAdapter::OnPropIntChanged);
	BackendSignals->OnPropFloatChanged.AddDynamic(this, &UTestbed1StructArray2InterfaceMsgBusAdapter::OnPropFloatChanged);
	BackendSignals->OnPropStringChanged.AddDynamic(this, &UTestbed1StructArray2InterfaceMsgBusAdapter::OnPropStringChanged);
	BackendSignals->OnPropEnumChanged.AddDynamic(this, &UTestbed1StructArray2InterfaceMsgBusAdapter::OnPropEnumChanged);
	BackendSignals->OnSigBoolSignal.AddDynamic(this, &UTestbed1StructArray2InterfaceMsgBusAdapter::OnSigBool);
	BackendSignals->OnSigIntSignal.AddDynamic(this, &UTestbed1StructArray2InterfaceMsgBusAdapter::OnSigInt);
	BackendSignals->OnSigFloatSignal.AddDynamic(this, &UTestbed1StructArray2InterfaceMsgBusAdapter::OnSigFloat);
	BackendSignals->OnSigStringSignal.AddDynamic(this, &UTestbed1StructArray2InterfaceMsgBusAdapter::OnSigString);
}
