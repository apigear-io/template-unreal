...
FTestbed1StructBoolWithArray UTestbed1StructArray2InterfaceMsgBusClient::GetPropBool_Implementation() const
{
	return PropBool;
}

void UTestbed1StructArray2InterfaceMsgBusClient::SetPropBool_Implementation(const FTestbed1StructBoolWithArray& InPropBool)
{
	if (!_IsConnected())
	{
...
FTestbed1StructIntWithArray UTestbed1StructArray2InterfaceMsgBusClient::GetPropInt_Implementation() const
{
	return PropInt;
}

void UTestbed1StructArray2InterfaceMsgBusClient::SetPropInt_Implementation(const FTestbed1StructIntWithArray& InPropInt)
{
	if (!_IsConnected())
	{
		UE_LOG(LogTestbed1StructArray2InterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
...
FTestbed1StructFloatWithArray UTestbed1StructArray2InterfaceMsgBusClient::GetPropFloat_Implementation() const
{
	return PropFloat;
}

void UTestbed1StructArray2InterfaceMsgBusClient::SetPropFloat_Implementation(const FTestbed1StructFloatWithArray& InPropFloat)
{
	if (!_IsConnected())
	{
		UE_LOG(LogTestbed1StructArray2InterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
...
FTestbed1StructStringWithArray UTestbed1StructArray2InterfaceMsgBusClient::GetPropString_Implementation() const
{
	return PropString;
}

void UTestbed1StructArray2InterfaceMsgBusClient::SetPropString_Implementation(const FTestbed1StructStringWithArray& InPropString)
{
	if (!_IsConnected())
	{
		UE_LOG(LogTestbed1StructArray2InterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
...
FTestbed1StructEnumWithArray UTestbed1StructArray2InterfaceMsgBusClient::GetPropEnum_Implementation() const
{
	return PropEnum;
}

void UTestbed1StructArray2InterfaceMsgBusClient::SetPropEnum_Implementation(const FTestbed1StructEnumWithArray& InPropEnum)
{
	if (!_IsConnected())
	{
		UE_LOG(LogTestbed1StructArray2InterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
...
TArray<FTestbed1StructBool> UTestbed1StructArray2InterfaceMsgBusClient::FuncBool_Implementation(const FTestbed1StructBoolWithArray& InParamBool)
{
	if (!_IsConnected())
	{
		UE_LOG(LogTestbed1StructArray2InterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
...
TArray<FTestbed1StructInt> UTestbed1StructArray2InterfaceMsgBusClient::FuncInt_Implementation(const FTestbed1StructIntWithArray& InParamInt)
{
	if (!_IsConnected())
	{
		UE_LOG(LogTestbed1StructArray2InterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
...
TArray<FTestbed1StructFloat> UTestbed1StructArray2InterfaceMsgBusClient::FuncFloat_Implementation(const FTestbed1StructFloatWithArray& InParamFloat)
{
	if (!_IsConnected())
	{
		UE_LOG(LogTestbed1StructArray2InterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
...
TArray<FTestbed1StructString> UTestbed1StructArray2InterfaceMsgBusClient::FuncString_Implementation(const FTestbed1StructStringWithArray& InParamString)
{
	if (!_IsConnected())
	{
		UE_LOG(LogTestbed1StructArray2InterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
...
TArray<ETestbed1Enum0> UTestbed1StructArray2InterfaceMsgBusClient::FuncEnum_Implementation(const FTestbed1StructEnumWithArray& InParamEnum)
{
	if (!_IsConnected())
	{
		UE_LOG(LogTestbed1StructArray2InterfaceMsgBusClient, Error, TEXT("Client has no connection to service."));
