...
class TESTBED1_API UTestbed1StructArray2InterfaceLoggingDecorator : public UAbstractTestbed1StructArray2Interface
{
	GENERATED_BODY()
...
public:
	...
	void SetPropBool_Implementation(const FTestbed1StructBoolWithArray& InPropBool) override;

	FTestbed1StructIntWithArray GetPropInt_Implementation() const override;

	void SetPropInt_Implementation(const FTestbed1StructIntWithArray& InPropInt) override;

	FTestbed1StructFloatWithArray GetPropFloat_Implementation() const override;

	void SetPropFloat_Implementation(const FTestbed1StructFloatWithArray& InPropFloat) override;

	FTestbed1StructStringWithArray GetPropString_Implementation() const override;

	void SetPropString_Implementation(const FTestbed1StructStringWithArray& InPropString) override;

	FTestbed1StructEnumWithArray GetPropEnum_Implementation() const override;

	void SetPropEnum_Implementation(const FTestbed1StructEnumWithArray& InPropEnum) override;
