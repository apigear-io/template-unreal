 ...
 */
USTRUCT(BlueprintType)
struct TESTBED1_API FTestbed1StructStruct : public FTableRowBase
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct TESTBED1_API FTestbed1StructEnum : public FTableRowBase
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct TESTBED1_API FTestbed1StructBoolWithArray : public FTableRowBase
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct TESTBED1_API FTestbed1StructIntWithArray : public FTableRowBase
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct TESTBED1_API FTestbed1StructFloatWithArray : public FTableRowBase
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct TESTBED1_API FTestbed1StructStringWithArray : public FTableRowBase
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct TESTBED1_API FTestbed1StructStructWithArray : public FTableRowBase
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct TESTBED1_API FTestbed1StructEnumWithArray : public FTableRowBase
{
	GENERATED_BODY()
