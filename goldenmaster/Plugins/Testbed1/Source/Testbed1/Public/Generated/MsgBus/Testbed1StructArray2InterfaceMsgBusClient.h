...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FTestbed1StructArray2InterfaceConnectionStatusChangedDelegate, bool, IsConnected);

UCLASS(NotBlueprintable, BlueprintType)
class TESTBED1_API UTestbed1StructArray2InterfaceMsgBusClient : public UAbstractTestbed1StructArray2Interface
{
	GENERATED_BODY()
public:
