...
void UTestbed2NestedStruct3InterfacePublisher::BroadcastSig1Signal(const FTestbed2NestedStruct1& Param1)
{
	...
	{
		AsyncTask(ENamedThreads::GameThread, [WeakPtr = TWeakObjectPtr<UTestbed2NestedStruct3InterfacePublisher>(this), BPSubscribersCopy, Param1]()
			{
			if (WeakPtr.IsValid())
			{
...
void UTestbed2NestedStruct3InterfacePublisher::BroadcastSig2Signal(const FTestbed2NestedStruct1& Param1, const FTestbed2NestedStruct2& Param2)
{
	...
	{
		AsyncTask(ENamedThreads::GameThread, [WeakPtr = TWeakObjectPtr<UTestbed2NestedStruct3InterfacePublisher>(this), BPSubscribersCopy, Param1, Param2]()
			{
			if (WeakPtr.IsValid())
			{
...
void UTestbed2NestedStruct3InterfacePublisher::BroadcastSig3Signal(const FTestbed2NestedStruct1& Param1, const FTestbed2NestedStruct2& Param2, const FTestbed2NestedStruct3& Param3)
{
	...
	{
		AsyncTask(ENamedThreads::GameThread, [WeakPtr = TWeakObjectPtr<UTestbed2NestedStruct3InterfacePublisher>(this), BPSubscribersCopy, Param1, Param2, Param3]()
			{
			if (WeakPtr.IsValid())
			{
...
void UTestbed2NestedStruct3InterfacePublisher::BroadcastProp1Changed(UPARAM(DisplayName = "Prop1") const FTestbed2NestedStruct1& InProp1)
{
	...
	{
		AsyncTask(ENamedThreads::GameThread, [WeakPtr = TWeakObjectPtr<UTestbed2NestedStruct3InterfacePublisher>(this), BPSubscribersCopy, InProp1]()
			{
			if (WeakPtr.IsValid())
			{
...
void UTestbed2NestedStruct3InterfacePublisher::BroadcastProp2Changed(UPARAM(DisplayName = "Prop2") const FTestbed2NestedStruct2& InProp2)
{
	...
	{
		AsyncTask(ENamedThreads::GameThread, [WeakPtr = TWeakObjectPtr<UTestbed2NestedStruct3InterfacePublisher>(this), BPSubscribersCopy, InProp2]()
			{
			if (WeakPtr.IsValid())
			{
...
void UTestbed2NestedStruct3InterfacePublisher::BroadcastProp3Changed(UPARAM(DisplayName = "Prop3") const FTestbed2NestedStruct3& InProp3)
{
	...
	{
		AsyncTask(ENamedThreads::GameThread, [WeakPtr = TWeakObjectPtr<UTestbed2NestedStruct3InterfacePublisher>(this), BPSubscribersCopy, InProp3]()
			{
			if (WeakPtr.IsValid())
			{
