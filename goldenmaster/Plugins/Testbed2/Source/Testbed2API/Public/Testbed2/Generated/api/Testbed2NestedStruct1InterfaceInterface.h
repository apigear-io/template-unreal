 ...
 */
// signal delegates
DECLARE_MULTICAST_DELEGATE_OneParam(FTestbed2NestedStruct1InterfaceSig1Delegate, const FTestbed2NestedStruct1& /* Param1 */);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FTestbed2NestedStruct1InterfaceSig1DelegateBP, const FTestbed2NestedStruct1&, Param1);

// property delegates
DECLARE_MULTICAST_DELEGATE_OneParam(FTestbed2NestedStruct1InterfaceProp1ChangedDelegate, const FTestbed2NestedStruct1& /* Prop1 */);
...
class TESTBED2API_API ITestbed2NestedStruct1InterfaceBPSubscriberInterface
{
	GENERATED_BODY()

public:
	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "ApiGear|Testbed2|NestedStruct1Interface|Signals", DisplayName = "On Sig1 Signal")
	void OnSig1Signal(const FTestbed2NestedStruct1& Param1);

	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "ApiGear|Testbed2|NestedStruct1Interface|Signals", DisplayName = "On Property Prop1 Changed")
...
class TESTBED2API_API ITestbed2NestedStruct1InterfaceSubscriberInterface
{
	GENERATED_BODY()
public:
...
public:
	...
	FTestbed2NestedStruct1InterfaceSig1DelegateBP OnSig1SignalBP;
	...
	FTestbed2NestedStruct1InterfaceProp1ChangedDelegateBP OnProp1ChangedBP;
	...
	void Subscribe(const TWeakInterfacePtr<ITestbed2NestedStruct1InterfaceSubscriberInterface>& Subscriber);
	UFUNCTION(BlueprintCallable, Category = "ApiGear|Testbed2|NestedStruct1Interface|Signals")
	void Unsubscribe(const TScriptInterface<ITestbed2NestedStruct1InterfaceBPSubscriberInterface>& Subscriber);
	void Unsubscribe(const TWeakInterfacePtr<ITestbed2NestedStruct1InterfaceSubscriberInterface>& Subscriber);

private:
	UPROPERTY()
	TArray<TScriptInterface<ITestbed2NestedStruct1InterfaceBPSubscriberInterface>> BPSubscribers;
	FRWLock BPSubscribersLock;
	TArray<TWeakInterfacePtr<ITestbed2NestedStruct1InterfaceSubscriberInterface>> Subscribers;
