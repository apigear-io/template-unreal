...
struct TESTBED2API_API FTestbed2Struct1 : public FTableRowBase
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct TESTBED2API_API FTestbed2Struct2 : public FTableRowBase
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct TESTBED2API_API FTestbed2Struct3 : public FTableRowBase
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct TESTBED2API_API FTestbed2Struct4 : public FTableRowBase
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct TESTBED2API_API FTestbed2NestedStruct1 : public FTableRowBase
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct TESTBED2API_API FTestbed2NestedStruct2 : public FTableRowBase
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct TESTBED2API_API FTestbed2NestedStruct3 : public FTableRowBase
{
	GENERATED_BODY()
...
class TESTBED2API_API UTestbed2Library : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
