...
/**
 * Subscriber interface for Testbed2NestedStruct3Interface events. Intended for Blueprint-only use.
...
/**
 * Subscriber interface for Testbed2NestedStruct3Interface events. Intended for C++ use.
 * Does contain signal events and property-changed events.
...
class TESTBED2API_API UTestbed2NestedStruct3InterfacePublisher : public UObject
{
	GENERATED_BODY()
...
public:
	...
	virtual UTestbed2NestedStruct3InterfacePublisher* _GetPublisher() = 0;
	...
	virtual TFuture<FTestbed2NestedStruct1> Func3Async(const FTestbed2NestedStruct1& Param1, const FTestbed2NestedStruct2& Param2, const FTestbed2NestedStruct3& Param3) = 0;
	UFUNCTION(BlueprintCallable, Category = "ApiGear|Testbed2|NestedStruct3Interface|Operations")
