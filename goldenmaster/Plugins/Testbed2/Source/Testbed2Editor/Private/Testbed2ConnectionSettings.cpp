...
TSharedRef<IDetailCustomization> FTestbed2ConnectionSettingsDetails::MakeInstance()
{
...
TSharedRef<SWidget> FTestbed2ConnectionSettingsDetails::MakeDefaultMqttConnectionSelectorWidget(const TSharedPtr<IPropertyHandle>& PropertyHandle)
{
	UApiGearSettings* settings = GetMutableDefault<UApiGearSettings>();
	check(settings);
...
void FTestbed2ConnectionSettingsDetails::CustomizeMqttDetails(IDetailLayoutBuilder& DetailBuilder)
{
