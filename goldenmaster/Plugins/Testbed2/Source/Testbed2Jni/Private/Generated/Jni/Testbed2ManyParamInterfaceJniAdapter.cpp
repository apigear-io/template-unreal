...
void UTestbed2ManyParamInterfaceJniAdapter::callJniServiceReady(bool isServiceReady)
{
	...
	{
		if (!Testbed2JniCache::javaClassManyParamInterface || !m_javaJniServiceInstance || !Testbed2JniCache::serviceClassManyParamInterfaceReadyMethodID)
		{
		...
		FJavaWrapper::CallVoidMethod(Env, m_javaJniServiceInstance, Testbed2JniCache::serviceClassManyParamInterfaceReadyMethodID, isServiceReady);
...
void UTestbed2ManyParamInterfaceJniAdapter::OnSig1Signal(int32 Param1)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (Testbed2JniCache::serviceClassManyParamInterface == nullptr || m_javaJniServiceInstance == nullptr)
		{
		...
		jmethodID MethodID = Testbed2JniCache::serviceClassManyParamInterfaceSig1SignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed2ManyParamInterfaceJniAdapter::OnSig2Signal(int32 Param1, int32 Param2)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed2JniCache::serviceClassManyParamInterfaceSig2SignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed2ManyParamInterfaceJniAdapter::OnSig3Signal(int32 Param1, int32 Param2, int32 Param3)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed2JniCache::serviceClassManyParamInterfaceSig3SignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed2ManyParamInterfaceJniAdapter::OnSig4Signal(int32 Param1, int32 Param2, int32 Param3, int32 Param4)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed2JniCache::serviceClassManyParamInterfaceSig4SignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed2ManyParamInterfaceJniAdapter::OnProp1Changed(int32 Prop1)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (Testbed2JniCache::serviceClassManyParamInterface == nullptr)
		{
		...
		jmethodID MethodID = Testbed2JniCache::serviceClassManyParamInterfaceProp1ChangedMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed2ManyParamInterfaceJniAdapter::OnProp2Changed(int32 Prop2)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed2JniCache::serviceClassManyParamInterfaceProp2ChangedMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed2ManyParamInterfaceJniAdapter::OnProp3Changed(int32 Prop3)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed2JniCache::serviceClassManyParamInterfaceProp3ChangedMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed2ManyParamInterfaceJniAdapter::OnProp4Changed(int32 Prop4)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed2JniCache::serviceClassManyParamInterfaceProp4ChangedMethodID;
		if (MethodID == nullptr)
		{
