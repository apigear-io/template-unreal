...
void UTestbed2NestedStruct1InterfaceJniAdapter::callJniServiceReady(bool isServiceReady)
{
	...
	{
		if (!Testbed2JniCache::javaClassNestedStruct1Interface || !m_javaJniServiceInstance || !Testbed2JniCache::serviceClassNestedStruct1InterfaceReadyMethodID)
		{
		...
		FJavaWrapper::CallVoidMethod(Env, m_javaJniServiceInstance, Testbed2JniCache::serviceClassNestedStruct1InterfaceReadyMethodID, isServiceReady);
...
void UTestbed2NestedStruct1InterfaceJniAdapter::OnSig1Signal(const FTestbed2NestedStruct1& Param1)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (Testbed2JniCache::serviceClassNestedStruct1Interface == nullptr || m_javaJniServiceInstance == nullptr)
		{
		...
		jmethodID MethodID = Testbed2JniCache::serviceClassNestedStruct1InterfaceSig1SignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed2NestedStruct1InterfaceJniAdapter::OnProp1Changed(const FTestbed2NestedStruct1& Prop1)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (Testbed2JniCache::serviceClassNestedStruct1Interface == nullptr)
		{
		...
		jmethodID MethodID = Testbed2JniCache::serviceClassNestedStruct1InterfaceProp1ChangedMethodID;
		if (MethodID == nullptr)
		{
