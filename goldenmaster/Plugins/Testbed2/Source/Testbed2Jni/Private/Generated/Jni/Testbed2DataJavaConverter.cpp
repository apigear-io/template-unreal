...
TSharedPtr<FTestbed2DataJavaConverterCacheData, ESPMode::ThreadSafe> Testbed2DataJavaConverter::ensureInitialized()
{
	...
	if (checkJniErrorOccured(errorMsgStruct1))
	{
	...
	if (checkJniErrorOccured(errorMsgStruct2))
	{
		UE_LOG(LogTestbed2DataJavaConverter_JNI, Warning, TEXT("Testbed2DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgStruct3))
	{
		UE_LOG(LogTestbed2DataJavaConverter_JNI, Warning, TEXT("Testbed2DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgStruct4))
	{
		UE_LOG(LogTestbed2DataJavaConverter_JNI, Warning, TEXT("Testbed2DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgNestedStruct1))
	{
		UE_LOG(LogTestbed2DataJavaConverter_JNI, Warning, TEXT("Testbed2DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgNestedStruct2))
	{
		UE_LOG(LogTestbed2DataJavaConverter_JNI, Warning, TEXT("Testbed2DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgNestedStruct3))
	{
		UE_LOG(LogTestbed2DataJavaConverter_JNI, Warning, TEXT("Testbed2DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgEnum1))
	{
		UE_LOG(LogTestbed2DataJavaConverter_JNI, Warning, TEXT("Testbed2DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgEnum2))
	{
		UE_LOG(LogTestbed2DataJavaConverter_JNI, Warning, TEXT("Testbed2DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgEnum3))
	{
		UE_LOG(LogTestbed2DataJavaConverter_JNI, Warning, TEXT("Testbed2DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgManyParamInterface))
	{
		UE_LOG(LogTestbed2DataJavaConverter_JNI, Warning, TEXT("Testbed2DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgNestedStruct1Interface))
	{
		UE_LOG(LogTestbed2DataJavaConverter_JNI, Warning, TEXT("Testbed2DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgNestedStruct2Interface))
	{
		UE_LOG(LogTestbed2DataJavaConverter_JNI, Warning, TEXT("Testbed2DataJavaConverter initialization failed"));
		return nullptr;
	}
	...
	if (checkJniErrorOccured(errorMsgNestedStruct3Interface))
	{
		UE_LOG(LogTestbed2DataJavaConverter_JNI, Warning, TEXT("Testbed2DataJavaConverter initialization failed"));
		return nullptr;
	}
