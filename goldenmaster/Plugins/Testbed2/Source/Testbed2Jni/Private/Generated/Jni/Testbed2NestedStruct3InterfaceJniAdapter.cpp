...
void UTestbed2NestedStruct3InterfaceJniAdapter::callJniServiceReady(bool isServiceReady)
{
	...
	{
		if (!Testbed2JniCache::javaClassNestedStruct3Interface || !m_javaJniServiceInstance || !Testbed2JniCache::serviceClassNestedStruct3InterfaceReadyMethodID)
		{
		...
		FJavaWrapper::CallVoidMethod(Env, m_javaJniServiceInstance, Testbed2JniCache::serviceClassNestedStruct3InterfaceReadyMethodID, isServiceReady);
...
void UTestbed2NestedStruct3InterfaceJniAdapter::OnSig1Signal(const FTestbed2NestedStruct1& Param1)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (Testbed2JniCache::serviceClassNestedStruct3Interface == nullptr || m_javaJniServiceInstance == nullptr)
		{
		...
		jmethodID MethodID = Testbed2JniCache::serviceClassNestedStruct3InterfaceSig1SignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed2NestedStruct3InterfaceJniAdapter::OnSig2Signal(const FTestbed2NestedStruct1& Param1, const FTestbed2NestedStruct2& Param2)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed2JniCache::serviceClassNestedStruct3InterfaceSig2SignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed2NestedStruct3InterfaceJniAdapter::OnSig3Signal(const FTestbed2NestedStruct1& Param1, const FTestbed2NestedStruct2& Param2, const FTestbed2NestedStruct3& Param3)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed2JniCache::serviceClassNestedStruct3InterfaceSig3SignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed2NestedStruct3InterfaceJniAdapter::OnProp1Changed(const FTestbed2NestedStruct1& Prop1)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (Testbed2JniCache::serviceClassNestedStruct3Interface == nullptr)
		{
		...
		jmethodID MethodID = Testbed2JniCache::serviceClassNestedStruct3InterfaceProp1ChangedMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed2NestedStruct3InterfaceJniAdapter::OnProp2Changed(const FTestbed2NestedStruct2& Prop2)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed2JniCache::serviceClassNestedStruct3InterfaceProp2ChangedMethodID;
		if (MethodID == nullptr)
		{
...
void UTestbed2NestedStruct3InterfaceJniAdapter::OnProp3Changed(const FTestbed2NestedStruct3& Prop3)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed2JniCache::serviceClassNestedStruct3InterfaceProp3ChangedMethodID;
		if (MethodID == nullptr)
		{
