...
void UTestbed2NestedStruct3InterfaceJniClientCache::init()
{
	...
	if (NewData->clientClassNestedStruct3Interface == nullptr || Testbed2DataJavaConverter::CheckJniErrorOccurred(errorMsgCls))
	{
		return;
	}
	...
	if (NewData->clientClassNestedStruct3InterfaceCtor == nullptr || Testbed2DataJavaConverter::CheckJniErrorOccurred(errorMsgInit))
	{
		return;
	}
...
FTestbed2MethodHelper gUTestbed2NestedStruct3InterfaceJniClientmethodHelper(TEXT("UTestbed2NestedStruct3InterfaceJniClient"));
...
void UTestbed2NestedStruct3InterfaceJniClient::Deinitialize()
{
	...
	gUTestbed2NestedStruct3InterfaceJniClientmethodHelper.FlushPendingPromises();
...
FTestbed2NestedStruct1 UTestbed2NestedStruct3InterfaceJniClient::Func1(const FTestbed2NestedStruct1& InParam1)
{
	...
	if (MethodID != nullptr)
	{
		auto id = gUTestbed2NestedStruct3InterfaceJniClientmethodHelper.StorePromise(MoveTemp(Promise));
		if (!tryCallAsyncJavaFunc1(id, MethodID, InParam1))
		{
			gUTestbed2NestedStruct3InterfaceJniClientmethodHelper.FulfillPromise(id, FTestbed2NestedStruct1());
			return FTestbed2NestedStruct1();
		}
	}
	else
...
TFuture<FTestbed2NestedStruct1> UTestbed2NestedStruct3InterfaceJniClient::Func1Async(const FTestbed2NestedStruct1& InParam1)
{
	UE_LOG(LogTestbed2NestedStruct3InterfaceClient_JNI, Verbose, TEXT("testbed2/testbed2jniclient/NestedStruct3InterfaceJniClient:func1Async"));
...
TFuture<FTestbed2NestedStruct1> UTestbed2NestedStruct3InterfaceJniClient::Func2Async(const FTestbed2NestedStruct1& InParam1, const FTestbed2NestedStruct2& InParam2)
{
	UE_LOG(LogTestbed2NestedStruct3InterfaceClient_JNI, Verbose, TEXT("testbed2/testbed2jniclient/NestedStruct3InterfaceJniClient:func2Async"));
...
TFuture<FTestbed2NestedStruct1> UTestbed2NestedStruct3InterfaceJniClient::Func3Async(const FTestbed2NestedStruct1& InParam1, const FTestbed2NestedStruct2& InParam2, const FTestbed2NestedStruct3& InParam3)
{
	UE_LOG(LogTestbed2NestedStruct3InterfaceClient_JNI, Verbose, TEXT("testbed2/testbed2jniclient/NestedStruct3InterfaceJniClient:func3Async"));
...
{
	auto updateAndBroadcastValueChanged = [InParam1](UTestbed2NestedStruct3InterfaceJniClient& self)
	{
	...
	TWeakObjectPtr<UTestbed2NestedStruct3InterfaceJniClient> weakSelf(this);
	AsyncTask(
		ENamedThreads::GameThread,
		[updateAndBroadcastValueChanged = MoveTemp(updateAndBroadcastValueChanged), weakSelf]
		{
		UTestbed2NestedStruct3InterfaceJniClient* self = weakSelf.Get();
		if (self != nullptr)
		{
...
{
	auto updateAndBroadcastValueChanged = [InParam1, InParam2](UTestbed2NestedStruct3InterfaceJniClient& self)
	{
...
{
	auto updateAndBroadcastValueChanged = [InParam1, InParam2, InParam3](UTestbed2NestedStruct3InterfaceJniClient& self)
	{
...
{
	auto updateAndBroadcastValueChanged = [InProp1](UTestbed2NestedStruct3InterfaceJniClient& self)
	{
		self.Prop1 = InProp1;
...
{
	auto updateAndBroadcastValueChanged = [InProp2](UTestbed2NestedStruct3InterfaceJniClient& self)
	{
		self.Prop2 = InProp2;
...
{
	auto updateAndBroadcastValueChanged = [InProp3](UTestbed2NestedStruct3InterfaceJniClient& self)
	{
		self.Prop3 = InProp3;
...
#if PLATFORM_ANDROID && USE_ANDROID_JNI
bool UTestbed2NestedStruct3InterfaceJniClient::tryCallAsyncJavaFunc1(FGuid Guid, jmethodID MethodID, const FTestbed2NestedStruct1& InParam1)
{
	UE_LOG(LogTestbed2NestedStruct3InterfaceClient_JNI, Verbose, TEXT("call async testbed2/testbed2jniclient/NestedStruct3InterfaceJniClient:func1"));
...
bool UTestbed2NestedStruct3InterfaceJniClient::tryCallAsyncJavaFunc2(FGuid Guid, jmethodID MethodID, const FTestbed2NestedStruct1& InParam1, const FTestbed2NestedStruct2& InParam2)
{
	UE_LOG(LogTestbed2NestedStruct3InterfaceClient_JNI, Verbose, TEXT("call async testbed2/testbed2jniclient/NestedStruct3InterfaceJniClient:func2"));
...
bool UTestbed2NestedStruct3InterfaceJniClient::tryCallAsyncJavaFunc3(FGuid Guid, jmethodID MethodID, const FTestbed2NestedStruct1& InParam1, const FTestbed2NestedStruct2& InParam2, const FTestbed2NestedStruct3& InParam3)
{
	UE_LOG(LogTestbed2NestedStruct3InterfaceClient_JNI, Verbose, TEXT("call async testbed2/testbed2jniclient/NestedStruct3InterfaceJniClient:func3"));
...
void UTestbed2NestedStruct3InterfaceJniClient::notifyIsReady(bool bInIsReady)
{
	b_isReady.store(bInIsReady, std::memory_order_release);

	auto broadcastConnectionStatusChanged = [](UTestbed2NestedStruct3InterfaceJniClient& self)
	{
...
JNI_METHOD void Java_testbed2_testbed2jniclient_NestedStruct3InterfaceJniClient_nativeAsyncOperationFailed(JNIEnv* Env, jclass Clazz, jstring callId, jstring errorMessage, jint errorCode)
{
	FString callIdString = FJavaHelper::FStringFromParam(Env, callId);
	static const TCHAR* errorMsgId = TEXT("failed to convert call id string in nativeAsyncOperationFailed for testbed2/testbed2jniclient/NestedStruct3InterfaceJniClient");
	if (Testbed2DataJavaConverter::CheckJniErrorOccurred(errorMsgId))
	{
		return;
	}
	...
	UE_LOG(LogTestbed2NestedStruct3InterfaceClient_JNI, Warning,
		TEXT("Async operation failed for id %s: %s (code: %d)"),
		*callIdString, *errorMsgString, static_cast<int32>(errorCode));

	FGuid guid;
	FGuid::Parse(callIdString, guid);
	gUTestbed2NestedStruct3InterfaceJniClientmethodHelper.FulfillPromiseWithDefaultValue(guid);
}
#endif
