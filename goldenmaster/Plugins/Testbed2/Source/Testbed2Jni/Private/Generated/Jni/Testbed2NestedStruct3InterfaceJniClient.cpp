...
void UTestbed2NestedStruct3InterfaceJniClient::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	if (Testbed2JniCache::clientClassNestedStruct3InterfaceCtor == nullptr)
	{
	...
	jobject localRef = Env->NewObject(Testbed2JniCache::clientClassNestedStruct3Interface, Testbed2JniCache::clientClassNestedStruct3InterfaceCtor);
...
void UTestbed2NestedStruct3InterfaceJniClient::SetProp1(const FTestbed2NestedStruct1& InProp1)
{
	...
	{
		if (Testbed2JniCache::javaClassNestedStruct3Interface == nullptr)
		{
		...
		jmethodID MethodID = Testbed2JniCache::javaClassNestedStruct3InterfaceProp1SetterId;
		if (MethodID == nullptr)
		{
...
void UTestbed2NestedStruct3InterfaceJniClient::SetProp2(const FTestbed2NestedStruct2& InProp2)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed2JniCache::javaClassNestedStruct3InterfaceProp2SetterId;
		if (MethodID == nullptr)
		{
...
void UTestbed2NestedStruct3InterfaceJniClient::SetProp3(const FTestbed2NestedStruct3& InProp3)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = Testbed2JniCache::javaClassNestedStruct3InterfaceProp3SetterId;
		if (MethodID == nullptr)
		{
...
FTestbed2NestedStruct1 UTestbed2NestedStruct3InterfaceJniClient::Func1(const FTestbed2NestedStruct1& InParam1)
{
...
#if PLATFORM_ANDROID && USE_ANDROID_JNI
	if (Testbed2JniCache::clientClassNestedStruct3Interface == nullptr)
	{
	...
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
	jmethodID MethodID = Testbed2JniCache::clientClassNestedStruct3InterfaceFunc1AsyncMethodID;
	if (MethodID != nullptr)
	{
...
FTestbed2NestedStruct1 UTestbed2NestedStruct3InterfaceJniClient::Func2(const FTestbed2NestedStruct1& InParam1, const FTestbed2NestedStruct2& InParam2)
{
	...
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
	jmethodID MethodID = Testbed2JniCache::clientClassNestedStruct3InterfaceFunc2AsyncMethodID;
	if (MethodID != nullptr)
	{
		auto id = gUTestbed2NestedStruct3InterfaceJniClientmethodHelper.StorePromise(Promise);
		auto idString = FJavaHelper::ToJavaString(Env, id.ToString(EGuidFormats::Digits));
...
FTestbed2NestedStruct1 UTestbed2NestedStruct3InterfaceJniClient::Func3(const FTestbed2NestedStruct1& InParam1, const FTestbed2NestedStruct2& InParam2, const FTestbed2NestedStruct3& InParam3)
{
	...
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
	jmethodID MethodID = Testbed2JniCache::clientClassNestedStruct3InterfaceFunc3AsyncMethodID;
	if (MethodID != nullptr)
	{
		auto id = gUTestbed2NestedStruct3InterfaceJniClientmethodHelper.StorePromise(Promise);
		auto idString = FJavaHelper::ToJavaString(Env, id.ToString(EGuidFormats::Digits));
...
bool UTestbed2NestedStruct3InterfaceJniClient::_bindToService(FString servicePackage, FString connectionId)
{
	...
	jmethodID MethodID = Testbed2JniCache::clientClassNestedStruct3InterfaceBindMethodID;
	if (MethodID != nullptr)
	{
...
void UTestbed2NestedStruct3InterfaceJniClient::_unbind()
{
	...
	jmethodID MethodID = Testbed2JniCache::clientClassNestedStruct3InterfaceUnbindMethodID;
	if (MethodID != nullptr)
	{
