...
void UTestbed2NestedStruct2InterfaceJniClientCache::init()
{
	...
	if (NewData->clientClassNestedStruct2Interface == nullptr || Testbed2DataJavaConverter::CheckJniErrorOccurred(errorMsgCls))
	{
		return;
	}
	...
	if (NewData->clientClassNestedStruct2InterfaceCtor == nullptr || Testbed2DataJavaConverter::CheckJniErrorOccurred(errorMsgInit))
	{
		return;
	}
...
TFuture<FTestbed2NestedStruct1> UTestbed2NestedStruct2InterfaceJniClient::Func1Async(const FTestbed2NestedStruct1& InParam1)
{
	UE_LOG(LogTestbed2NestedStruct2InterfaceClient_JNI, Verbose, TEXT("testbed2/testbed2jniclient/NestedStruct2InterfaceJniClient:func1Async"));
...
TFuture<FTestbed2NestedStruct1> UTestbed2NestedStruct2InterfaceJniClient::Func2Async(const FTestbed2NestedStruct1& InParam1, const FTestbed2NestedStruct2& InParam2)
{
	UE_LOG(LogTestbed2NestedStruct2InterfaceClient_JNI, Verbose, TEXT("testbed2/testbed2jniclient/NestedStruct2InterfaceJniClient:func2Async"));
...
void UTestbed2NestedStruct2InterfaceJniClient::OnSig1Signal(const FTestbed2NestedStruct1& InParam1)
{
	...
	TWeakObjectPtr<UTestbed2NestedStruct2InterfaceJniClient> weakSelf(this);
	AsyncTask(
		ENamedThreads::GameThread,
		[updateAndBroadcastValueChanged = MoveTemp(updateAndBroadcastValueChanged), weakSelf]
		{
		UTestbed2NestedStruct2InterfaceJniClient* self = weakSelf.Get();
		if (self != nullptr)
		{
...
#if PLATFORM_ANDROID && USE_ANDROID_JNI
bool UTestbed2NestedStruct2InterfaceJniClient::tryCallAsyncJavaFunc1(FGuid Guid, jmethodID MethodID, const FTestbed2NestedStruct1& InParam1)
{
	UE_LOG(LogTestbed2NestedStruct2InterfaceClient_JNI, Verbose, TEXT("call async testbed2/testbed2jniclient/NestedStruct2InterfaceJniClient:func1"));
...
{
	UE_LOG(LogTestbed2NestedStruct2InterfaceClient_JNI, Verbose, TEXT("call async testbed2/testbed2jniclient/NestedStruct2InterfaceJniClient:func2"));
...
void UTestbed2NestedStruct2InterfaceJniClient::notifyIsReady(bool bInIsReady)
{
	b_isReady.store(bInIsReady, std::memory_order_release);

	auto broadcastConnectionStatusChanged = [](UTestbed2NestedStruct2InterfaceJniClient& self)
	{
