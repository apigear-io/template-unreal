...
class FTestbed2MethodHelper
{
public:
	explicit FTestbed2MethodHelper(const FString& InOwnerName)
...
template <typename ResultType>
bool FTestbed2MethodHelper::FulfillPromise(const FGuid& Id, const ResultType& Value)
{
	UE_LOG(
		LogTestbed2MethodHelper_JNI,
		Verbose,
