...
DECLARE_LOG_CATEGORY_EXTERN(LogTestbed2CommonJavaConverter_JNI, Log, All);

class FTestbed2CommonJavaConverter
{
public:
...
private:
	...
	FTestbed2CommonJavaConverter() = delete;
};

template<>
struct FTestbed2CommonJavaConverter::JniArrayTraits<bool>
{
...
template<>
struct FTestbed2CommonJavaConverter::JniArrayTraits<int32>
{
...
template<>
struct FTestbed2CommonJavaConverter::JniArrayTraits<int64>
{
...
template<>
struct FTestbed2CommonJavaConverter::JniArrayTraits<float>
{
...
template<>
struct FTestbed2CommonJavaConverter::JniArrayTraits<double>
{
...
FTestbed2CommonJavaConverter::TryFillArray(
    JNIEnv* Env, TArray<PrimitiveType>& OutPrimitiveArray, jarray InJniArray, const FString& InPropertyName)
{
