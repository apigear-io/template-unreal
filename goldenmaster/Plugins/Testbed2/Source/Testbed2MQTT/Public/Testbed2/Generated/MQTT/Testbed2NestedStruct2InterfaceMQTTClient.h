...
#include "Misc/Guid.h"
#include "Testbed2NestedStruct2InterfaceMQTTClient.generated.h"

class Testbed2NestedStruct2InterfacePropertiesData;
DECLARE_LOG_CATEGORY_EXTERN(LogTestbed2NestedStruct2InterfaceMQTTClient, Log, All);

UCLASS(NotBlueprintable, BlueprintType)
class TESTBED2MQTT_API UTestbed2NestedStruct2InterfaceMQTTClient : public UAbstractTestbed2NestedStruct2Interface
{
	GENERATED_BODY()
public:
	explicit UTestbed2NestedStruct2InterfaceMQTTClient();

	// only needed in 4.25 to use TUniquePtr<Testbed2NestedStruct2InterfacePropertiesData>
	UTestbed2NestedStruct2InterfaceMQTTClient(FVTableHelper& Helper);
	virtual ~UTestbed2NestedStruct2InterfaceMQTTClient();
