...
#include "Testbed2NestedStruct2InterfaceMQTTAdapter.generated.h"

class UApiGearMQTTHost;

DECLARE_LOG_CATEGORY_EXTERN(LogTestbed2NestedStruct2InterfaceMQTTAdapter, Log, All);
...
class TESTBED2MQTT_API UTestbed2NestedStruct2InterfaceMQTTAdapter : public UGameInstanceSubsystem, public ITestbed2NestedStruct2InterfaceSubscriberInterface
{
	GENERATED_BODY()
public:
	explicit UTestbed2NestedStruct2InterfaceMQTTAdapter();
	virtual ~UTestbed2NestedStruct2InterfaceMQTTAdapter() = default;
