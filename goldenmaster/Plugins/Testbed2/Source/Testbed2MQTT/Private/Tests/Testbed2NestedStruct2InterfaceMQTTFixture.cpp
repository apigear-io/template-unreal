...
namespace Tests
{
FTestbed2NestedStruct2InterfaceMQTTFixture::FTestbed2NestedStruct2InterfaceMQTTFixture()
{
	testImplementation = GetGameInstance()->GetSubsystem<UTestbed2NestedStruct2InterfaceMQTTClient>();
	...
	auto service = GetGameInstance()->GetSubsystem<UTestbed2NestedStruct2InterfaceImplementation>();
...
TScriptInterface<ITestbed2NestedStruct2InterfaceInterface> FTestbed2NestedStruct2InterfaceMQTTFixture::GetImplementation()
{
	return testImplementation;
}

UApiGearMQTTHost* FTestbed2NestedStruct2InterfaceMQTTFixture::GetHost()
{
	return Host.Get();
}

UTestbed2NestedStruct2InterfaceMQTTAdapter* FTestbed2NestedStruct2InterfaceMQTTFixture::GetAdapter()
{
	return GetGameInstance()->GetSubsystem<UTestbed2NestedStruct2InterfaceMQTTAdapter>();
}

UGameInstance* FTestbed2NestedStruct2InterfaceMQTTFixture::GetGameInstance()
{
...
void FTestbed2NestedStruct2InterfaceMQTTFixture::CleanUp()
{
	if (Host.IsValid())
	{
		Host->Stop();
