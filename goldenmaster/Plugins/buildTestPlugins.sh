...
# copy TbStructArray plugin to blank project for build and functional testing
mkdir -p "$ProjectTarget_path/Plugins/TbStructArray" && cp -rf "$script_path/TbStructArray" "$ProjectTarget_path/Plugins/" 1>&-
if [ $? -ne 0 ]; then exit 1; fi;
