...
DEFINE_LOG_CATEGORY(LogCustomTypesCommonJavaConverter_JNI);

bool FCustomTypesCommonJavaConverter::CheckJniErrorOccurred(const TCHAR* Msg)
{
	...
	if (env->ExceptionCheck())
	{
		...
		env->ExceptionClear();
		UE_LOG(LogCustomTypesCommonJavaConverter_JNI, Error, TEXT("%s"), Msg);
		return true;
	}
	return false;
}

bool FCustomTypesCommonJavaConverter::TryFillArray(
