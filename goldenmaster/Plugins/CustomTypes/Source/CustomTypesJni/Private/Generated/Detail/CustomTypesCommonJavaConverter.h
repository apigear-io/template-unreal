...
DECLARE_LOG_CATEGORY_EXTERN(LogCustomTypesCommonJavaConverter_JNI, Log, All);

class FCustomTypesCommonJavaConverter
{
public:
...
private:
	...
	FCustomTypesCommonJavaConverter() = delete;
};

template<>
struct FCustomTypesCommonJavaConverter::JniArrayTraits<bool>
{
...
template<>
struct FCustomTypesCommonJavaConverter::JniArrayTraits<int32>
{
...
template<>
struct FCustomTypesCommonJavaConverter::JniArrayTraits<int64>
{
...
template<>
struct FCustomTypesCommonJavaConverter::JniArrayTraits<float>
{
...
template<>
struct FCustomTypesCommonJavaConverter::JniArrayTraits<double>
{
...
FCustomTypesCommonJavaConverter::TryFillArray(
    JNIEnv* Env, TArray<PrimitiveType>& OutPrimitiveArray, jarray InJniArray, const FString& InPropertyName)
{
	...
	{
		UE_LOG(LogCustomTypesCommonJavaConverter_JNI, Warning, TEXT("%s is null"), *InPropertyName);
		return false;
	}
