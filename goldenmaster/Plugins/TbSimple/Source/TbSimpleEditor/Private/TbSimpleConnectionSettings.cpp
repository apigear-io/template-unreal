...
TSharedRef<IDetailCustomization> FTbSimpleConnectionSettingsDetails::MakeInstance()
{
	return MakeShareable(new FTbSimpleConnectionSettingsDetails);
}

TSharedRef<SWidget> FTbSimpleConnectionSettingsDetails::MakeDefaultBackendServiceSelectorWidget(const TSharedPtr<IPropertyHandle>& PropertyHandle)
{
...
TSharedRef<SWidget> FTbSimpleConnectionSettingsDetails::MakeDefaultMqttConnectionSelectorWidget(const TSharedPtr<IPropertyHandle>& PropertyHandle)
{
	UApiGearSettings* settings = GetMutableDefault<UApiGearSettings>();
	check(settings);
...
void FTbSimpleConnectionSettingsDetails::CustomizeMqttDetails(IDetailLayoutBuilder& DetailBuilder)
{
...
void FTbSimpleConnectionSettingsDetails::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
