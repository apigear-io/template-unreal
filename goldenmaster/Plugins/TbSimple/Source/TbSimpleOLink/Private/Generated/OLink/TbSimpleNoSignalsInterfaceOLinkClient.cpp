...
void UTbSimpleNoSignalsInterfaceOLinkClient::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	TWeakObjectPtr<UTbSimpleNoSignalsInterfaceOLinkClient> weak(this);
...
void UTbSimpleNoSignalsInterfaceOLinkClient::FuncVoid()
{
	...
	ApiGear::ObjectLink::InvokeReplyFunc GetNoSignalsInterfaceStateFunc = [](ApiGear::ObjectLink::InvokeReplyArg arg) {};
...
TFuture<bool> UTbSimpleNoSignalsInterfaceOLinkClient::FuncBoolAsync(bool bParamBool)
{
	...
	m_sink->GetNode()->invokeRemote(memberId, {bParamBool},
		...
		{
			UE_LOG(LogTbSimpleNoSignalsInterfaceOLinkClient, Error, TEXT("FuncBoolAsync: invalid return value type or null -> returning default"));
			Promise->SetValue(false);
		}
	});
