...
void UTbSimpleNoPropertiesInterfaceOLinkClient::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	TWeakObjectPtr<UTbSimpleNoPropertiesInterfaceOLinkClient> weak(this);
...
void UTbSimpleNoPropertiesInterfaceOLinkClient::FuncVoid()
{
	...
	ApiGear::ObjectLink::InvokeReplyFunc GetNoPropertiesInterfaceStateFunc = [](ApiGear::ObjectLink::InvokeReplyArg arg) {};
