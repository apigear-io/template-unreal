...
void UTbSimpleNoOperationsInterfaceMsgBusClient::OnConnectionInit(const FTbSimpleNoOperationsInterfaceInitMessage& InMessage, const TSharedRef<IMessageContext, ESPMode::ThreadSafe>& Context)
{
	...
	{
		UE_LOG(LogTbSimpleNoOperationsInterfaceMsgBusClient, Warning,
...
bool UTbSimpleNoOperationsInterfaceMsgBusClient::GetPropBool() const
{
	return bPropBool;
}
...
int32 UTbSimpleNoOperationsInterfaceMsgBusClient::GetPropInt() const
{
	return PropInt;
}
