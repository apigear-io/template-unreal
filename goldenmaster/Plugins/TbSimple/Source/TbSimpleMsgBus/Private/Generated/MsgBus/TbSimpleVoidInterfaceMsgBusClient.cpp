...
void UTbSimpleVoidInterfaceMsgBusClient::OnConnectionInit(const FTbSimpleVoidInterfaceInitMessage& InMessage, const TSharedRef<IMessageContext, ESPMode::ThreadSafe>& Context)
{
	...
	{
		UE_LOG(LogTbSimpleVoidInterfaceMsgBusClient, Warning,
...
TSharedPtr<TPromise<ResultType>> UTbSimpleVoidInterfaceMsgBusClient::StorePromise(const FGuid& Id)
{
...
void UTbSimpleVoidInterfaceMsgBusClient::CancelAllPromises()
{
