...
class TBSIMPLEIMPLEMENTATION_API UTbSimpleSimpleInterfaceImplementation : public UAbstractTbSimpleSimpleInterface
{
	GENERATED_BODY()
public:
	virtual ~UTbSimpleSimpleInterfaceImplementation();
