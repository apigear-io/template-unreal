...
void UTbSimpleVoidInterfaceJniAdapter::callJniServiceReady(bool isServiceReady)
{
	...
	{
		if (!TbSimpleJniCache::javaClassVoidInterface || !m_javaJniServiceInstance || !TbSimpleJniCache::serviceClassVoidInterfaceReadyMethodID)
		{
		...
		FJavaWrapper::CallVoidMethod(Env, m_javaJniServiceInstance, TbSimpleJniCache::serviceClassVoidInterfaceReadyMethodID, isServiceReady);
