...
void UTbSimpleNoPropertiesInterfaceJniAdapter::callJniServiceReady(bool isServiceReady)
{
	...
	{
		if (!TbSimpleJniCache::javaClassNoPropertiesInterface || !m_javaJniServiceInstance || !TbSimpleJniCache::serviceClassNoPropertiesInterfaceReadyMethodID)
		{
		...
		FJavaWrapper::CallVoidMethod(Env, m_javaJniServiceInstance, TbSimpleJniCache::serviceClassNoPropertiesInterfaceReadyMethodID, isServiceReady);
...
void UTbSimpleNoPropertiesInterfaceJniAdapter::OnSigVoidSignal()
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (TbSimpleJniCache::serviceClassNoPropertiesInterface == nullptr || m_javaJniServiceInstance == nullptr)
		{
		...
		jmethodID MethodID = TbSimpleJniCache::serviceClassNoPropertiesInterfaceSigVoidSignalMethodID;
		if (MethodID == nullptr)
		{
...
void UTbSimpleNoPropertiesInterfaceJniAdapter::OnSigBoolSignal(bool bParamBool)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = TbSimpleJniCache::serviceClassNoPropertiesInterfaceSigBoolSignalMethodID;
		if (MethodID == nullptr)
		{
