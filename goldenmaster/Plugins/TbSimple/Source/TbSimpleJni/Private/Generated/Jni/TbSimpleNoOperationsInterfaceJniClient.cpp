...
namespace {
    ...
    TFunction<void(bool)> gUTbSimpleNoOperationsInterfaceJniClientnotifyIsReady = [](bool value) { (void)value; UE_LOG(LogTbSimpleNoOperationsInterfaceClient_JNI, Warning, TEXT("notifyIsReady used but not set ")); };
    TFunction<void(bool)> gUTbSimpleNoOperationsInterfaceJniClientOnPropBoolChangedEmpty = [](bool value) { (void)value; UE_LOG(LogTbSimpleNoOperationsInterfaceClient_JNI, Warning, TEXT("onPropBoolChanged used but not set ")); };
    ...
    TFunction<void(int32)> gUTbSimpleNoOperationsInterfaceJniClientOnPropIntChangedEmpty = [](int32 value) { (void)value; UE_LOG(LogTbSimpleNoOperationsInterfaceClient_JNI, Warning, TEXT("onPropIntChanged used but not set ")); };
...
void UTbSimpleNoOperationsInterfaceJniClient::Initialize(FSubsystemCollectionBase& Collection)
{
    ...
    m_javaJniClientClass = FAndroidApplication::FindJavaClassGlobalRef("tbSimple/tbSimplejniclient/NoOperationsInterfaceJniClient");
...
void UTbSimpleNoOperationsInterfaceJniClient::Deinitialize()
{
    ...
    gUTbSimpleNoOperationsInterfaceJniClientnotifyIsReady = [](bool value){(void)value; UE_LOG(LogTbSimpleNoOperationsInterfaceClient_JNI, Warning, TEXT("notifyIsReady used but not set "));};
