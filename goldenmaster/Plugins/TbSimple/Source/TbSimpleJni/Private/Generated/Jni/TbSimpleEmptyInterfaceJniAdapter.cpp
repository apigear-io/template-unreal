...
void UTbSimpleEmptyInterfaceJniAdapter::callJniServiceReady(bool isServiceReady)
{
	...
	{
		if (!TbSimpleJniCache::javaClassEmptyInterface || !m_javaJniServiceInstance || !TbSimpleJniCache::serviceClassEmptyInterfaceReadyMethodID)
		{
		...
		FJavaWrapper::CallVoidMethod(Env, m_javaJniServiceInstance, TbSimpleJniCache::serviceClassEmptyInterfaceReadyMethodID, isServiceReady);
