...
void UTbSimpleNoSignalsInterfaceJniAdapter::callJniServiceReady(bool isServiceReady)
{
	...
	{
		if (!TbSimpleJniCache::javaClassNoSignalsInterface || !m_javaJniServiceInstance || !TbSimpleJniCache::serviceClassNoSignalsInterfaceReadyMethodID)
		{
		...
		FJavaWrapper::CallVoidMethod(Env, m_javaJniServiceInstance, TbSimpleJniCache::serviceClassNoSignalsInterfaceReadyMethodID, isServiceReady);
...
void UTbSimpleNoSignalsInterfaceJniAdapter::OnPropBoolChanged(bool bPropBool)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		if (TbSimpleJniCache::serviceClassNoSignalsInterface == nullptr)
		{
		...
		jmethodID MethodID = TbSimpleJniCache::serviceClassNoSignalsInterfacePropBoolChangedMethodID;
		if (MethodID == nullptr)
		{
...
void UTbSimpleNoSignalsInterfaceJniAdapter::OnPropIntChanged(int32 PropInt)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = TbSimpleJniCache::serviceClassNoSignalsInterfacePropIntChangedMethodID;
		if (MethodID == nullptr)
		{
