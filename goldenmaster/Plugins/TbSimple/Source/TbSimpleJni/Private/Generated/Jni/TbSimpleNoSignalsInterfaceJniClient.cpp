...
TFunction<void(bool)> gUTbSimpleNoSignalsInterfaceJniClientnotifyIsReady = [](bool value)
{
	(void)value;
	UE_LOG(LogTbSimpleNoSignalsInterfaceClient_JNI, Warning, TEXT("notifyIsReady used but not set "));
};
TFunction<void(bool)> gUTbSimpleNoSignalsInterfaceJniClientOnPropBoolChangedEmpty = [](bool value)
{
	(void)value;
	UE_LOG(LogTbSimpleNoSignalsInterfaceClient_JNI, Warning, TEXT("onPropBoolChanged used but not set "));
};
...
TFunction<void(int32)> gUTbSimpleNoSignalsInterfaceJniClientOnPropIntChangedEmpty = [](int32 value)
{
	(void)value;
	UE_LOG(LogTbSimpleNoSignalsInterfaceClient_JNI, Warning, TEXT("onPropIntChanged used but not set "));
};
...
void UTbSimpleNoSignalsInterfaceJniClient::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	if (TbSimpleJniCache::clientClassNoSignalsInterfaceCtor == nullptr)
	{
	...
	jobject localRef = Env->NewObject(TbSimpleJniCache::clientClassNoSignalsInterface, TbSimpleJniCache::clientClassNoSignalsInterfaceCtor);
...
void UTbSimpleNoSignalsInterfaceJniClient::Deinitialize()
{
	...
	gUTbSimpleNoSignalsInterfaceJniClientnotifyIsReady = [](bool value)
	{
		(void)value;
		UE_LOG(LogTbSimpleNoSignalsInterfaceClient_JNI, Warning, TEXT("notifyIsReady used but not set "));
	};
...
void UTbSimpleNoSignalsInterfaceJniClient::SetPropBool(bool bInPropBool)
{
	...
	{
		if (TbSimpleJniCache::javaClassNoSignalsInterface == nullptr)
		{
		...
		jmethodID MethodID = TbSimpleJniCache::javaClassNoSignalsInterfacePropBoolSetterId;
		if (MethodID == nullptr)
		{
...
void UTbSimpleNoSignalsInterfaceJniClient::SetPropInt(int32 InPropInt)
{
	...
	if (JNIEnv* Env = FAndroidApplication::GetJavaEnv())
	{
		...
		jmethodID MethodID = TbSimpleJniCache::javaClassNoSignalsInterfacePropIntSetterId;
		if (MethodID == nullptr)
		{
...
void UTbSimpleNoSignalsInterfaceJniClient::FuncVoid()
{
...
#if PLATFORM_ANDROID && USE_ANDROID_JNI
	if (TbSimpleJniCache::clientClassNoSignalsInterface == nullptr)
	{
	...
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
	jmethodID MethodID = TbSimpleJniCache::clientClassNoSignalsInterfaceFuncVoidAsyncMethodID;
	if (MethodID != nullptr)
	{
		FGuid id = FGuid::NewGuid();
		auto idString = FJavaHelper::ToJavaString(Env, id.ToString(EGuidFormats::Digits));
		static const TCHAR* errorMsgId = TEXT("failed to craete java string for id in call funcVoidAsync on tbSimple/tbSimplejniclient/NoSignalsInterfaceJniClient");
...
bool UTbSimpleNoSignalsInterfaceJniClient::FuncBool(bool bInParamBool)
{
	...
	JNIEnv* Env = FAndroidApplication::GetJavaEnv();
	jmethodID MethodID = TbSimpleJniCache::clientClassNoSignalsInterfaceFuncBoolAsyncMethodID;
	if (MethodID != nullptr)
	{
		auto id = gUTbSimpleNoSignalsInterfaceJniClientmethodHelper.StorePromise(Promise);
		auto idString = FJavaHelper::ToJavaString(Env, id.ToString(EGuidFormats::Digits));
		static const TCHAR* errorMsgId = TEXT("failed to craete java string for id in call funcBoolAsync on tbSimple/tbSimplejniclient/NoSignalsInterfaceJniClient");
		TbSimpleDataJavaConverter::checkJniError(errorMsgId);
...
bool UTbSimpleNoSignalsInterfaceJniClient::_bindToService(FString servicePackage, FString connectionId)
{
	...
	jmethodID MethodID = TbSimpleJniCache::clientClassNoSignalsInterfaceBindMethodID;
	if (MethodID != nullptr)
	{
		jobject Activity = FJavaWrapper::GameActivityThis;
		auto jPackage = FJavaHelper::ToJavaString(Env, servicePackage);
		static const TCHAR* errorMsgPackage = TEXT("failed to craete java string for package in call bind on tbSimple/tbSimplejniclient/NoSignalsInterfaceJniClient");
		TbSimpleDataJavaConverter::checkJniError(errorMsgPackage);
		auto jConnId = FJavaHelper::ToJavaString(Env, connectionId);
		static const TCHAR* errorMsgId = TEXT("failed to craete java string for connection id in call bind on tbSimple/tbSimplejniclient/NoSignalsInterfaceJniClient");
		TbSimpleDataJavaConverter::checkJniError(errorMsgId);
...
void UTbSimpleNoSignalsInterfaceJniClient::_unbind()
{
	...
	jmethodID MethodID = TbSimpleJniCache::clientClassNoSignalsInterfaceUnbindMethodID;
	if (MethodID != nullptr)
	{
...
JNI_METHOD void Java_tbSimple_tbSimplejniclient_NoSignalsInterfaceJniClient_nativeOnFuncVoidResult(JNIEnv* Env, jclass Clazz, jstring callId)
{
	...
	static const TCHAR* errorMsgId = TEXT("failed to craete java string for call id in call nativeOnFuncVoid for tbSimple/tbSimplejniclient/NoSignalsInterfaceJniClient");
	TbSimpleDataJavaConverter::checkJniError(errorMsgId);
	FGuid guid;
...
JNI_METHOD void Java_tbSimple_tbSimplejniclient_NoSignalsInterfaceJniClient_nativeOnFuncBoolResult(JNIEnv* Env, jclass Clazz, jboolean result, jstring callId)
{
	...
	FString callIdString = FJavaHelper::FStringFromParam(Env, callId);
	static const TCHAR* errorMsgId = TEXT("failed to craete java string for call id in call nativeOnFuncBool for tbSimple/tbSimplejniclient/NoSignalsInterfaceJniClient");
	TbSimpleDataJavaConverter::checkJniError(errorMsgId);
	FGuid guid;
