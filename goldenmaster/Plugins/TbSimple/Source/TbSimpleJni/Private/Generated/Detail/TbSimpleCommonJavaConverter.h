...
DECLARE_LOG_CATEGORY_EXTERN(LogTbSimpleCommonJavaConverter_JNI, Log, All);

class FTbSimpleCommonJavaConverter
{
public:
...
private:
	...
	FTbSimpleCommonJavaConverter() = delete;
};

template<>
struct FTbSimpleCommonJavaConverter::JniArrayTraits<bool>
{
...
template<>
struct FTbSimpleCommonJavaConverter::JniArrayTraits<int32>
{
...
template<>
struct FTbSimpleCommonJavaConverter::JniArrayTraits<int64>
{
...
template<>
struct FTbSimpleCommonJavaConverter::JniArrayTraits<float>
{
...
template<>
struct FTbSimpleCommonJavaConverter::JniArrayTraits<double>
{
    ...
    JNIEnv* Env, TArray<PrimitiveType>& OutPrimitiveArray, jarray InJniArray, const FString& InPropertyName)
{
	...
	{
		UE_LOG(LogTbSimpleCommonJavaConverter_JNI, Warning, TEXT("%s is null"), *InPropertyName);
		return false;
	}
