...
DEFINE_LOG_CATEGORY(LogTbSimpleCommonJavaConverter_JNI);

bool FTbSimpleCommonJavaConverter::CheckJniErrorOccurred(const TCHAR* Msg)
{
	...
	if (env->ExceptionCheck())
	{
		...
		env->ExceptionClear();
		UE_LOG(LogTbSimpleCommonJavaConverter_JNI, Error, TEXT("%s"), Msg);
		return true;
	}
	return false;
}

bool FTbSimpleCommonJavaConverter::TryFillArray(
