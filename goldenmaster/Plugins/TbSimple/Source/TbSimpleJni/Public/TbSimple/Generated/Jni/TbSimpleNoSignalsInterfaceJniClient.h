...
class TBSIMPLEJNI_API UTbSimpleNoSignalsInterfaceJniClient : public UAbstractTbSimpleNoSignalsInterface
{
	GENERATED_BODY()
public:
	...
	/**
	* @param package. This client will connect only to a NoSignalsInterface Service, that myb be exposed by the application that runs it.
