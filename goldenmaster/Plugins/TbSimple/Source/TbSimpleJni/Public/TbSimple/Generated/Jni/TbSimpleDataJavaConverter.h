...
private:
	...
	static TSharedPtr<FTbSimpleDataJavaConverterCacheData, ESPMode::ThreadSafe> CacheData;
	static TSharedPtr<FTbSimpleDataJavaConverterCacheData, ESPMode::ThreadSafe> ensureInitialized();
