...
public:
	...
	UPROPERTY(BlueprintAssignable, Category = "ApiGear|TbSimple|SimpleArrayInterface|Jni|Remote", DisplayName = "Jni Service Started")
	FTbSimpleJniServiceStartedDelegateBP _JniServiceStartedBP;
	FTbSimpleJniServiceStartedDelegate _JniServiceStarted;
	UPROPERTY(BlueprintAssignable, Category = "ApiGear|TbSimple|SimpleArrayInterface|Jni|Remote", DisplayName = "Jni Service Died")
