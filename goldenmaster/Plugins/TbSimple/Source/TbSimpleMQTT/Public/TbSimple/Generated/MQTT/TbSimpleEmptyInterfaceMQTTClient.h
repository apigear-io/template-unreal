...
#include "Misc/Guid.h"
#include "TbSimpleEmptyInterfaceMQTTClient.generated.h"
DECLARE_LOG_CATEGORY_EXTERN(LogTbSimpleEmptyInterfaceMQTTClient, Log, All);

UCLASS(NotBlueprintable, BlueprintType)
class TBSIMPLEMQTT_API UTbSimpleEmptyInterfaceMQTTClient : public UAbstractTbSimpleEmptyInterface
{
	GENERATED_BODY()
public:
	explicit UTbSimpleEmptyInterfaceMQTTClient();

	// only needed in 4.25 to use TUniquePtr<TbSimpleEmptyInterfacePropertiesData>
	UTbSimpleEmptyInterfaceMQTTClient(FVTableHelper& Helper);
	virtual ~UTbSimpleEmptyInterfaceMQTTClient();
