...
#include "Misc/Guid.h"
#include "TbSimpleNoOperationsInterfaceMQTTClient.generated.h"

class TbSimpleNoOperationsInterfacePropertiesData;
DECLARE_LOG_CATEGORY_EXTERN(LogTbSimpleNoOperationsInterfaceMQTTClient, Log, All);

UCLASS(NotBlueprintable, BlueprintType)
class TBSIMPLEMQTT_API UTbSimpleNoOperationsInterfaceMQTTClient : public UAbstractTbSimpleNoOperationsInterface
{
	GENERATED_BODY()
public:
	explicit UTbSimpleNoOperationsInterfaceMQTTClient();

	// only needed in 4.25 to use TUniquePtr<TbSimpleNoOperationsInterfacePropertiesData>
	UTbSimpleNoOperationsInterfaceMQTTClient(FVTableHelper& Helper);
	virtual ~UTbSimpleNoOperationsInterfaceMQTTClient();
...
private:
	...
	/// @param InMsg contains the param(s) of the type(s)
	void onSigVoid(const IApiGearMqttClient::FReceivedMessage& InMsg);
