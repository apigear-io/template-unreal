...
#include "Misc/Guid.h"
#include "TbSimpleVoidInterfaceMQTTClient.generated.h"
DECLARE_LOG_CATEGORY_EXTERN(LogTbSimpleVoidInterfaceMQTTClient, Log, All);

UCLASS(NotBlueprintable, BlueprintType)
class TBSIMPLEMQTT_API UTbSimpleVoidInterfaceMQTTClient : public UAbstractTbSimpleVoidInterface
{
	GENERATED_BODY()
public:
	explicit UTbSimpleVoidInterfaceMQTTClient();

	// only needed in 4.25 to use TUniquePtr<TbSimpleVoidInterfacePropertiesData>
	UTbSimpleVoidInterfaceMQTTClient(FVTableHelper& Helper);
	virtual ~UTbSimpleVoidInterfaceMQTTClient();
