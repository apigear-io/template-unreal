...
#include "Misc/Guid.h"
#include "TbSimpleNoPropertiesInterfaceMQTTClient.generated.h"
DECLARE_LOG_CATEGORY_EXTERN(LogTbSimpleNoPropertiesInterfaceMQTTClient, Log, All);

UCLASS(NotBlueprintable, BlueprintType)
class TBSIMPLEMQTT_API UTbSimpleNoPropertiesInterfaceMQTTClient : public UAbstractTbSimpleNoPropertiesInterface
{
	GENERATED_BODY()
public:
	explicit UTbSimpleNoPropertiesInterfaceMQTTClient();

	// only needed in 4.25 to use TUniquePtr<TbSimpleNoPropertiesInterfacePropertiesData>
	UTbSimpleNoPropertiesInterfaceMQTTClient(FVTableHelper& Helper);
	virtual ~UTbSimpleNoPropertiesInterfaceMQTTClient();
