...
namespace Tests
{
FTbSimpleNoSignalsInterfaceMQTTFixture::FTbSimpleNoSignalsInterfaceMQTTFixture()
{
	testImplementation = GetGameInstance()->GetSubsystem<UTbSimpleNoSignalsInterfaceMQTTClient>();
	...
	auto service = GetGameInstance()->GetSubsystem<UTbSimpleNoSignalsInterfaceImplementation>();
...
TScriptInterface<ITbSimpleNoSignalsInterfaceInterface> FTbSimpleNoSignalsInterfaceMQTTFixture::GetImplementation()
{
	return testImplementation;
}

UApiGearMQTTHost* FTbSimpleNoSignalsInterfaceMQTTFixture::GetHost()
{
	return Host.Get();
}

UTbSimpleNoSignalsInterfaceMQTTAdapter* FTbSimpleNoSignalsInterfaceMQTTFixture::GetAdapter()
{
	return GetGameInstance()->GetSubsystem<UTbSimpleNoSignalsInterfaceMQTTAdapter>();
}

UGameInstance* FTbSimpleNoSignalsInterfaceMQTTFixture::GetGameInstance()
{
...
void FTbSimpleNoSignalsInterfaceMQTTFixture::CleanUp()
{
	if (Host.IsValid())
	{
		Host->Stop();
