...
class UTbSimpleSimpleArrayInterfaceMQTTSpec;
class ITbSimpleSimpleArrayInterfaceInterface;
class UTbSimpleSimpleArrayInterfaceMQTTAdapter;
...
namespace Tests
{
class FTbSimpleSimpleArrayInterfaceMQTTFixture
{
public:
	FTbSimpleSimpleArrayInterfaceMQTTFixture();
	~FTbSimpleSimpleArrayInterfaceMQTTFixture();

	UGameInstance* GetGameInstance();
	TScriptInterface<ITbSimpleSimpleArrayInterfaceInterface> GetImplementation();
	UApiGearMQTTHost* GetHost();
	UTbSimpleSimpleArrayInterfaceMQTTAdapter* GetAdapter();
