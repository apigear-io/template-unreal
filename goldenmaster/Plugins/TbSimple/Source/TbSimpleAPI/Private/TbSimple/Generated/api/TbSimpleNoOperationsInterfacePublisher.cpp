...
void UTbSimpleNoOperationsInterfacePublisher::BroadcastSigVoidSignal()
{
	...
	auto BroadcastAll = [WeakPtr = TWeakObjectPtr<UTbSimpleNoOperationsInterfacePublisher>(this), SubscribersCopy, BPSubscribersCopy]()
	{
		if (!WeakPtr.IsValid())
		{
			return;
...
void UTbSimpleNoOperationsInterfacePublisher::BroadcastSigBoolSignal(bool bParamBool)
{
	...
	auto BroadcastAll = [WeakPtr = TWeakObjectPtr<UTbSimpleNoOperationsInterfacePublisher>(this), SubscribersCopy, BPSubscribersCopy, bParamBool]()
	{
		if (!WeakPtr.IsValid())
		{
			return;
...
void UTbSimpleNoOperationsInterfacePublisher::BroadcastPropBoolChanged(UPARAM(DisplayName = "bPropBool") bool bInPropBool)
{
	...
	auto BroadcastAll = [WeakPtr = TWeakObjectPtr<UTbSimpleNoOperationsInterfacePublisher>(this), SubscribersCopy, BPSubscribersCopy, bInPropBool]()
	{
		if (!WeakPtr.IsValid())
		{
			return;
...
void UTbSimpleNoOperationsInterfacePublisher::BroadcastPropIntChanged(UPARAM(DisplayName = "PropInt") int32 InPropInt)
{
	...
	auto BroadcastAll = [WeakPtr = TWeakObjectPtr<UTbSimpleNoOperationsInterfacePublisher>(this), SubscribersCopy, BPSubscribersCopy, InPropInt]()
	{
		if (!WeakPtr.IsValid())
		{
			return;
