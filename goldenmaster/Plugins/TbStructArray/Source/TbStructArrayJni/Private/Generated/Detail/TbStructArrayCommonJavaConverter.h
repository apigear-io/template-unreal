...
DECLARE_LOG_CATEGORY_EXTERN(LogTbStructArrayCommonJavaConverter_JNI, Log, All);

class FTbStructArrayCommonJavaConverter
{
public:
...
private:
	...
	FTbStructArrayCommonJavaConverter() = delete;
};

template <>
struct FTbStructArrayCommonJavaConverter::JniArrayTraits<bool>
{
...
template <>
struct FTbStructArrayCommonJavaConverter::JniArrayTraits<int32>
{
...
template <>
struct FTbStructArrayCommonJavaConverter::JniArrayTraits<int64>
{
...
template <>
struct FTbStructArrayCommonJavaConverter::JniArrayTraits<float>
{
...
template <>
struct FTbStructArrayCommonJavaConverter::JniArrayTraits<double>
{
	...
	JNIEnv* Env, TArray<PrimitiveType>& OutPrimitiveArray, jarray InJniArray, const FString& InPropertyName)
{
	...
	{
		UE_LOG(LogTbStructArrayCommonJavaConverter_JNI, Warning, TEXT("%s is null"), *InPropertyName);
		return false;
	}
