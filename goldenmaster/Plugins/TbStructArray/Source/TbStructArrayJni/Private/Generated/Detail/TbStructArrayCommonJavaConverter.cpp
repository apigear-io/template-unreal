...
DEFINE_LOG_CATEGORY(LogTbStructArrayCommonJavaConverter_JNI);

bool FTbStructArrayCommonJavaConverter::CheckJniErrorOccurred(const TCHAR* Msg)
{
	...
	if (env->ExceptionCheck())
	{
		...
		env->ExceptionClear();
		UE_LOG(LogTbStructArrayCommonJavaConverter_JNI, Error, TEXT("%s"), Msg);
		return true;
	}
	return false;
}

bool FTbStructArrayCommonJavaConverter::TryFillArray(
