...
TSharedRef<IDetailCustomization> FTbStructArrayConnectionSettingsDetails::MakeInstance()
{
	return MakeShareable(new FTbStructArrayConnectionSettingsDetails);
}

TSharedRef<SWidget> FTbStructArrayConnectionSettingsDetails::MakeDefaultBackendServiceSelectorWidget(const TSharedPtr<IPropertyHandle>& PropertyHandle)
{
	...
	TSharedPtr<FText> LocalServiceName = TSharedPtr<FText>(new FText(FText::FromString(TbStructArrayLocalBackendIdentifier)));
...
void FTbStructArrayConnectionSettingsDetails::CustomizeTracerDetails(IDetailLayoutBuilder& DetailBuilder)
{
...
TSharedRef<SWidget> FTbStructArrayConnectionSettingsDetails::MakeDefaultOLinkConnectionSelectorWidget(const TSharedPtr<IPropertyHandle>& PropertyHandle)
{
	UApiGearSettings* settings = GetMutableDefault<UApiGearSettings>();
	check(settings);
...
void FTbStructArrayConnectionSettingsDetails::CustomizeOLinkDetails(IDetailLayoutBuilder& DetailBuilder)
{
...
void FTbStructArrayConnectionSettingsDetails::CustomizeDetails(IDetailLayoutBuilder& DetailBuilder)
{
