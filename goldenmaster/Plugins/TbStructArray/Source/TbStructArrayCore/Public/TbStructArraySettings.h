...
#include "TbStructArraySettings.generated.h"

const FString TbStructArrayLocalBackendIdentifier = "Local";

class FSubsystemCollectionBase;
class ITbStructArrayStructArrayFieldInterfaceInterface;

/**
 * Implements the settings for the TbStructArray plugin.
 */
UCLASS(Config = Engine, DefaultConfig)
class TBSTRUCTARRAYCORE_API UTbStructArraySettings : public UObject
{
	GENERATED_BODY()

	UTbStructArraySettings(const FObjectInitializer& ObjectInitializer);
...
public:
	...
	static TScriptInterface<ITbStructArrayStructArrayFieldInterfaceInterface> GetITbStructArrayStructArrayFieldInterfaceInterfaceForLogging(FSubsystemCollectionBase& Collection);
