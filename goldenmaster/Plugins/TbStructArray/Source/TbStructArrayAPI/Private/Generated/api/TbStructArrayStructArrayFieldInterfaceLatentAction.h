...
class FTbStructArrayStructArrayFieldInterfaceLatentAction : public FPendingLatentAction
{
private:
...
public:
	FTbStructArrayStructArrayFieldInterfaceLatentAction(const FLatentActionInfo& LatentInfo,
