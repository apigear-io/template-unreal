---
sidebar_position: 6
sidebar_label: "Licensing & Author Info"
title: "Licensing and Author Metadata for Generated Unreal Engine Plugins"
description: "Generated plugins include MIT LICENSE files and SPDX headers. Customize author metadata in .uplugin descriptors and copyright notices via the meta field."
keywords: [license, mit, spdx, author metadata, uplugin, copyright, apigear, unreal engine]
---
...
```yaml title="helloworld.solution.yaml"
...
```yaml title="helloworld.module.yaml"
