...
class APIGEAR_API UUnrealSimulation : public UAbstractApiGearConnection,
									  public JSONRPC::IMessageWriter,
									  public JSONRPC::IRpcProtocolListener,
									  public JSONRPC::ILogger
{
	GENERATED_BODY()
  public:
