...
template<>
struct F{{Camel .Module.Name}}CommonJavaConverter::JniArrayTraits<bool>
{
...
template<>
struct F{{Camel .Module.Name}}CommonJavaConverter::JniArrayTraits<int32>
{
...
template<>
struct F{{Camel .Module.Name}}CommonJavaConverter::JniArrayTraits<int64>
{
...
template<>
struct F{{Camel .Module.Name}}CommonJavaConverter::JniArrayTraits<float>
{
...
template<>
struct F{{Camel .Module.Name}}CommonJavaConverter::JniArrayTraits<double>
{
