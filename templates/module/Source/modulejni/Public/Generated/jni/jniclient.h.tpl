...
#include "Poc/Generated/api/Abstract{{$Iface}}.h"
...
class POCJNI_API {{$Class}} : public UAbstract{{Camel .Module.Name}}{{Camel .Interface.Name }}
{
	GENERATED_BODY()
public:
	explicit {{$Class}}();
...
{{- end }}
	...
	UPROPERTY(BlueprintAssignable, Category = "ApiGear|{{Camel .Module.Name}}|{{$IfaceName}}|Remote", DisplayName = "Subscription Status Changed")
...
private:
	...
	jclass m_javaUnrealClientClass = nullptr;
	jobject m_javaUnrealClientInstance = nullptr;
#endif
};
